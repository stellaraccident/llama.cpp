...
static constexpr uint32_t GGML_HRX_RMS_NORM_WORKGROUP_SIZE = 512;
static constexpr int64_t GGML_HRX_MUL_MAT_VEC_MAX_COLS = 512;
static constexpr uint32_t GGML_HRX_TRACE_FALLBACK_LIMIT = 64;
static constexpr uint32_t GGML_HRX_TRACE_MUL_MAT_DETAIL_LIMIT = 32;

static constexpr std::initializer_list<std::array<int, 3>> GGML_HRX_ROPE_VIEW_SET_ROWS_EDGES {
    { 1, 0, 0 },
    { 2, 0, 1 },
};

static constexpr std::initializer_list<std::array<int, 3>> GGML_HRX_RMS_NORM_MUL_ROPE_EDGES {
    { 2, 0, 1 },
};

static constexpr std::initializer_list<std::array<int, 3>> GGML_HRX_RMS_NORM_MUL_ROPE_VIEW_SET_ROWS_EDGES {
    { 2, 0, 1 },
    { 3, 0, 2 },
    { 4, 0, 3 },
};

static bool ggml_backend_hrx_should_trace_buffer_transfer(size_t size) {
    const char * value = std::getenv("GGML_HRX_TRACE_BUFFER_COPIES");
    if (!value) {
        return false;
    }
    char * end = nullptr;
...
static bool ggml_backend_hrx_should_trace_lifetime() {
    const char * value = std::getenv("GGML_HRX_TRACE_LIFETIME");
    return value && value[0] != '\0' && std::strcmp(value, "0") != 0;
}

static void ggml_backend_hrx_trace_lifetime(const char * fmt, ...) {
    if (!ggml_backend_hrx_should_trace_lifetime()) {
        return;
    }

    static uint64_t seq = 0;
    std::fprintf(stderr, "ggml-hrx:lifetime:%" PRIu64 ": ", ++seq);
    va_list args;
    va_start(args, fmt);
...
enum class ggml_backend_hrx_kernel_provider_mode {
    pure_hip,
    iree,
    fallback,
};

enum class ggml_backend_hrx_q8_1_mmvq_policy {
    auto_select,
    all,
};
...
struct ggml_backend_hrx_provider_policy {
    ggml_backend_hrx_kernel_provider_mode kernel_provider = ggml_backend_hrx_kernel_provider_mode::pure_hip;
    ...
    bool disable_add_softplus_mul_fusion = false;
    bool enable_sigmoid_mul_add_add_fusion = false;
    bool enable_l2_norm_pair_fusion = false;
    bool disable_ssm_conv = false;
    bool disable_gated_delta_net = false;
    bool enable_gated_delta_net_beta_sigmoid_fusion = false;
    ...
    ggml_backend_hrx_topk_moe_variant topk_moe_variant =
        ggml_backend_hrx_topk_moe_variant::auto_select;
    ...
    ggml_backend_hrx_q8_1_mmvq_policy q8_1_mmvq_policy = ggml_backend_hrx_q8_1_mmvq_policy::auto_select;
    bool enable_packed_q4_k_dmmv = false;
    bool enable_packed_q4_k_swiglu = false;
    bool enable_q4_k_swiglu_rows2_x16_decode = false;
    bool enable_q4_k_swiglu_row2_decode = false;
    bool enable_q4_k_swiglu_row4_decode = false;
    bool enable_packed_q4_k_mul = false;
    bool enable_packed_q4_k_mul_rows2_x16 = false;
    bool enable_packed_q4_k_mul_rows2_x16_wg16 = false;
    ...
    bool enable_q4_k_id_q8_1_x4_mmq_prompt = false;
    ...
    bool enable_q4_k_swiglu_q8_1_x4_mmq_prompt = false;
    bool enable_q5_k_q8_1_mmq_prompt = true;
    bool enable_q5_k_q8_1_x4_mmq32_prompt = false;
    bool enable_q5_k_q8_1_x4_mmql128_prompt = false;
    bool enable_q5_k_q8_1_x4_mmq64_prompt = false;
    bool enable_q6_k_rows2_cols8_prompt = false;
    bool enable_q6_k_q8_1_x4_mmql128_prompt = false;
    bool enable_q6_k_q8_1_x4_mmq32_prompt = false;
    bool enable_f16_batched_cols4_prompt = false;
    bool enable_f16_batched_cols8_prompt = false;
    bool enable_f16_batched_cols16_prompt = false;
    bool enable_f32_batched_cols8_prompt = false;
    bool enable_f32_batched_cols16_prompt = false;
    bool enable_f32_batched_rows2_cols8_prompt = false;
    bool enable_bf16_cols4_prompt = false;
    bool enable_bf16_cols8_prompt = false;
    bool enable_bf16_cols16_prompt = false;
    bool enable_bf16_cols32_prompt = false;
...
struct ggml_backend_hrx_device_context {
    ...
    ggml_backend_hrx_provider_policy policy;
    ...
    ggml_backend_hrx_op_provider scale_get_rows_f32_nr1_provider;
    ...
    ggml_backend_hrx_op_provider flash_attn_ext_f32_f16_decode_provider;
    ggml_backend_hrx_op_provider flash_attn_ext_f32_f16_prefill_wmma_provider;
    ggml_backend_hrx_op_provider flash_attn_ext_f32_f16_prefill_gfx11_direct_provider;
    ggml_backend_hrx_op_provider flash_attn_ext_f32_f16_prefill_tile_provider;
    ggml_backend_hrx_op_provider flash_attn_ext_f32_bf16_decode_provider;
    ggml_backend_hrx_op_provider flash_attn_ext_f32_f32_decode_provider;
    ggml_backend_hrx_op_provider flash_attn_ext_f32_q4_0_decode_provider;
    ggml_backend_hrx_op_provider flash_attn_ext_f32_q8_0_decode_provider;
    ggml_backend_hrx_op_provider flash_attn_ext_f32_q8_0_q4_0_decode_provider;
    ...
    ggml_backend_hrx_op_provider mul_mat_id_q4_k_wg128_provider;
    ...
    ggml_backend_hrx_op_provider mul_mat_id_q4_k_grouped_row4_wg64_provider;
    ...
    ggml_backend_hrx_op_provider mul_mat_id_q4_k_mul_wg128_provider;
    ...
    ggml_backend_hrx_op_provider mul_mat_id_q4_k_mul_rows2_x16_wg16_provider;
    ggml_backend_hrx_op_provider mul_mat_id_q4_k_mul_packed_2row_wg64_provider;
    ggml_backend_hrx_op_provider mul_mat_id_q4_k_swiglu_provider;
    ggml_backend_hrx_op_provider mul_mat_id_q4_k_swiglu_wg128_provider;
    ...
    ggml_backend_hrx_op_provider mul_mat_id_q4_k_swiglu_grouped_row4_wg64_provider;
    ...
    ggml_backend_hrx_op_provider mul_mat_id_q4_k_swiglu_rows2_x16_wg32_provider;
    ggml_backend_hrx_op_provider mul_mat_id_q4_k_mul_q8_1_provider;
    ggml_backend_hrx_op_provider mul_mat_vec_q4_k_provider;
    ggml_backend_hrx_op_provider mul_mat_vec_q4_k_wg128_provider;
    ggml_backend_hrx_op_provider mul_mat_vec_q4_k_wg64_provider;
    ggml_backend_hrx_op_provider mul_mat_vec_q4_k_packed_wg64_provider;
...
static bool ggml_backend_hrx_should_sync_each_dispatch() {
    const char * value = std::getenv("GGML_HRX_SYNC_EACH_DISPATCH");
    return value && value[0] != '\0' && std::strcmp(value, "0") != 0;
}

static bool ggml_backend_hrx_should_flush_each_dispatch() {
    const char * value = std::getenv("GGML_HRX_FLUSH_EACH_DISPATCH");
    return value && value[0] != '\0' && std::strcmp(value, "0") != 0;
}

static bool ggml_backend_hrx_should_barrier_each_dispatch() {
    const char * value = std::getenv("GGML_HRX_BARRIER_EACH_DISPATCH");
    return value && value[0] != '\0' && std::strcmp(value, "0") != 0;
}
...
static bool ggml_backend_hrx_dispatch_index_in_range(uint64_t index, const char * begin_name, const char * end_name) {
    const uint64_t begin = ggml_backend_hrx_u64_from_env(begin_name, UINT64_MAX);
    const uint64_t end = ggml_backend_hrx_u64_from_env(end_name, begin);
    return begin != UINT64_MAX && index >= begin && index <= end;
}
...
static hrx_status_t ggml_backend_hrx_stream_dispatch(
        ...
        uint32_t flags) {
    static uint64_t dispatch_index = 0;
    const uint64_t index = ++dispatch_index;
    hrx_status_t status = hrx_stream_dispatch(
        ...
        binding_count,
        flags);
    if (!hrx_status_is_ok(status) || !ggml_backend_hrx_should_sync_each_dispatch()) {
        if (!hrx_status_is_ok(status)) {
            return status;
        }
    }
    ...
    const bool barrier =
        ggml_backend_hrx_should_barrier_each_dispatch() ||
        ggml_backend_hrx_dispatch_index_in_range(
            index, "GGML_HRX_BARRIER_DISPATCH_BEGIN", "GGML_HRX_BARRIER_DISPATCH_END");
    const bool flush =
        ggml_backend_hrx_should_flush_each_dispatch() ||
        ggml_backend_hrx_dispatch_index_in_range(
            index, "GGML_HRX_FLUSH_DISPATCH_BEGIN", "GGML_HRX_FLUSH_DISPATCH_END");
    const bool sync =
        ggml_backend_hrx_should_sync_each_dispatch() ||
        ggml_backend_hrx_dispatch_index_in_range(
            index, "GGML_HRX_SYNC_DISPATCH_BEGIN", "GGML_HRX_SYNC_DISPATCH_END");

    if (ggml_backend_hrx_should_trace_lifetime() &&
        (barrier || flush || sync || ggml_backend_hrx_u64_from_env("GGML_HRX_TRACE_DISPATCH_INDEX", 0) != 0)) {
        std::fprintf(
            stderr,
            "ggml-hrx: dispatch-index=%" PRIu64
            " wg_count=[%u,%u,%u] wg_size=[%u,%u,%u] bindings=%zu barrier=%d flush=%d sync=%d\n",
            index,
            config ? config->workgroup_count[0] : 0,
            config ? config->workgroup_count[1] : 0,
            config ? config->workgroup_count[2] : 0,
            config ? config->workgroup_size[0] : 0,
            config ? config->workgroup_size[1] : 0,
            config ? config->workgroup_size[2] : 0,
            binding_count,
            barrier ? 1 : 0,
            flush ? 1 : 0,
            sync ? 1 : 0);
    ...
    if (barrier) {
        status = hrx_stream_execution_barrier(stream);
        if (!hrx_status_is_ok(status)) {
            return status;
        }
    }
    ...
    if (sync) {
        return hrx_stream_synchronize(stream);
    }
...
static hrx_buffer_t ggml_backend_hrx_tensor_buffer(const ggml_tensor * tensor) {
...
static bool ggml_backend_hrx_sync_active_stream(ggml_backend_hrx_device_context * device_context, const char * reason) {
    ...
    std::lock_guard<std::mutex> lock(device_context->streams_mutex);
    if (device_context->live_streams.empty() && !device_context->active_stream) {
        return true;
    }

    bool ok = true;
    ggml_backend_hrx_trace_lifetime(
        "sync_active_stream begin reason=%s live_streams=%zu active=%p",
        reason,
        device_context->live_streams.size(),
        static_cast<void *>(device_context->active_stream));
    ...
    if (device_context->active_stream &&
        std::find(device_context->live_streams.begin(), device_context->live_streams.end(), device_context->active_stream) ==
                device_context->live_streams.end()) {
        ok = GGML_HRX_CHECK(hrx_stream_synchronize(device_context->active_stream)) && ok;
        if (auto * arena = ggml_backend_hrx_find_staging_arena_locked(device_context, device_context->active_stream)) {
            ggml_backend_hrx_reset_staging_arena_locked(*arena);
        }
    }
    ggml_backend_hrx_trace_lifetime("sync_active_stream %s reason=%s", ok ? "ok" : "failed", reason);
    return ok;
}
...
static bool ggml_backend_hrx_ensure_staging_buffer_locked(
    ...
    arena->offset = 0;
    ggml_backend_hrx_trace_lifetime("staging allocate stream=%p size=%zu", static_cast<void *>(arena->stream), capacity);
    return true;
}
...
static bool ggml_backend_hrx_stage_and_copy_tensor(
    ...
    const size_t arena_capacity = ggml_backend_hrx_staging_arena_capacity();
    if (!ggml_backend_hrx_ensure_staging_buffer_locked(context->device_context, arena, arena_capacity)) {
        hrx_stream_release(stream);
        return false;
    }
    ...
    hrx_stream_release(stream);
    ggml_backend_hrx_trace_lifetime(
        "set_tensor staged_copy %s tensor=%s size=%zu staging_offset=%zu",
        ok ? "ok" : "failed",
        tensor ? tensor->name : "<unknown>",
        size,
...
static bool ggml_backend_hrx_copy_tensor_to_staging(
    ...
    bool ok = true;
    {
        ...
        ggml_backend_hrx_trace_lifetime(
            "get_tensor staged_copy %s tensor=%s reason=%s size=%zu copied=%zu",
            ok ? "ok" : "failed",
            tensor ? tensor->name : "<unknown>",
            reason ? reason : "<none>",
            size,
...
static bool ggml_backend_hrx_validate_get_rows_indices(
    ...
    GGML_LOG_INFO(
        "%s: ok node=%s idx=%s src=%s n=%" PRId64 " row_limit=%" PRId64 " min=%d max=%d\n",
        __func__, ggml_get_name(dst), ggml_get_name(idx), ggml_get_name(src0),
        ggml_nelements(idx), row_limit, min_value, max_value);
    return true;
}

static bool ggml_backend_hrx_validate_argsort_result(
        ggml_backend_hrx_context * context,
        const ggml_tensor * dst) {
    if (!ggml_backend_hrx_should_validate_dynamic_index()) {
        return true;
    ...
    if (!ggml_backend_hrx_read_tensor_bytes(
            context->device_context, src0, &src_bytes, "validate_argsort_src") ||
        !ggml_backend_hrx_read_tensor_bytes(
            context->device_context, dst, &dst_bytes, "validate_argsort_dst")) {
        return false;
    }
    ...
    int32_t max_index = INT32_MIN;
    int64_t first_bad_row = -1;
    int64_t first_bad_col = -1;
    int32_t first_bad_value = 0;
    ...
    for (int64_t row = 0; row < nrows; ++row) {
        ...
        for (int64_t col = 0; col < ncols; ++col) {
            ...
            std::memcpy(
                &input,
                src_bytes.data() +
                    static_cast<size_t>(col) * src0->nb[0] +
            ...
            std::memcpy(
                &index,
                dst_bytes.data() +
                    static_cast<size_t>(col) * dst->nb[0] +
                    static_cast<size_t>(i1) * dst->nb[1] +
                    static_cast<size_t>(i2) * dst->nb[2] +
                    static_cast<size_t>(i3) * dst->nb[3],
                sizeof(index));
            min_index = std::min(min_index, index);
            max_index = std::max(max_index, index);
            const bool invalid = index < 0 || index >= ncols;
            const bool duplicate = !invalid && seen[index];
            if (!invalid) {
                seen[index] = true;
            }
            if (invalid || duplicate) {
                ...
                if (first_bad_row < 0) {
                    first_bad_row = row;
                    first_bad_col = col;
                    first_bad_value = index;
                }
            }
        }
    }

    if (invalid_count != 0 || duplicate_count != 0 || nonfinite_count != 0) {
        GGML_LOG_ERROR(
            "%s: bad ARGSORT node=%s src=%s ncols=%" PRId64 " nrows=%" PRId64
            " nonfinite=%" PRId64 " invalid=%" PRId64 " duplicate=%" PRId64
            " first=(%" PRId64 ",%" PRId64 ") value=%d min=%d max=%d\n",
            __func__, ggml_get_name(dst), ggml_get_name(src0), ncols, nrows,
            nonfinite_count, invalid_count, duplicate_count,
            first_bad_row, first_bad_col, first_bad_value, min_index, max_index);
        return false;
    }

    GGML_LOG_INFO(
        "%s: ok node=%s src=%s ncols=%" PRId64 " nrows=%" PRId64 " min=%d max=%d\n",
        __func__, ggml_get_name(dst), ggml_get_name(src0), ncols, nrows, min_index, max_index);
    return true;
}

static bool ggml_backend_hrx_validate_f32_tensor_finite(
        ggml_backend_hrx_context * context,
        const ggml_tensor * tensor,
        const char * label) {
    if (!ggml_backend_hrx_should_validate_dynamic_index() || tensor->type != GGML_TYPE_F32) {
        return true;
    }

    std::vector<uint8_t> bytes;
    if (!ggml_backend_hrx_read_tensor_bytes(
            context->device_context, tensor, &bytes, label)) {
        return false;
    }

    int64_t nonfinite_count = 0;
    int64_t first_nonfinite_linear = -1;
    ...
    for (int64_t i3 = 0; i3 < tensor->ne[3]; ++i3) {
        for (int64_t i2 = 0; i2 < tensor->ne[2]; ++i2) {
            for (int64_t i1 = 0; i1 < tensor->ne[1]; ++i1) {
                for (int64_t i0 = 0; i0 < tensor->ne[0]; ++i0, ++linear) {
                    const size_t byte_offset =
    ...
    if (nonfinite_count != 0) {
        GGML_LOG_ERROR(
            "%s: bad %s tensor=%s op=%s n=%" PRId64
            " nonfinite=%" PRId64 " first_linear=%" PRId64 " first_value=%g finite_min=%g finite_max=%g\n",
            __func__, label, ggml_get_name(tensor), ggml_op_name(tensor->op),
            ggml_nelements(tensor), nonfinite_count, first_nonfinite_linear, first_nonfinite_value,
            min_value, max_value);
        return false;
    }

    GGML_LOG_INFO(
        "%s: ok %s tensor=%s op=%s n=%" PRId64 " min=%g max=%g\n",
        __func__, label, ggml_get_name(tensor), ggml_op_name(tensor->op),
        ggml_nelements(tensor), min_value, max_value);
    return true;
}
...
static bool ggml_backend_hrx_tensor_buffer_ref(
    ...
    if (!buffer || buffer->iface.get_base != ggml_backend_hrx_buffer_get_base) {
        ggml_backend_hrx_trace_lifetime(
            "buffer_ref failed tensor=%s reason=no_hrx_buffer buffer=%p view_src=%p",
            tensor ? tensor->name : "<null>",
            static_cast<void *>(buffer),
            static_cast<void *>(tensor ? tensor->view_src : nullptr));
        return false;
    }
    ...
    if (!context->buffer) {
        ggml_backend_hrx_trace_lifetime(
            "buffer_ref failed tensor=%s reason=no_hrx_handle buffer=%p",
            tensor->name,
            static_cast<void *>(buffer));
        return false;
    }
    ...
    const bool in_bounds = offset <= buffer->size && length <= buffer->size - offset;
    ggml_backend_hrx_trace_lifetime(
        "buffer_ref tensor=%s type=%s buffer=%p hrx_buffer=%p base=%p data=%p off=%zu len=%zu buffer_size=%zu in_bounds=%d view_src=%s ne=[%" PRId64 ",%" PRId64 ",%" PRId64 ",%" PRId64 "] nb=[%zu,%zu,%zu,%zu]",
        tensor->name,
...
static ggml_backend_hrx_kernel_provider_mode ggml_backend_hrx_kernel_provider_mode_from_env() {
    const char * value = std::getenv("GGML_HRX_KERNEL_PROVIDER");
    if (!value || value[0] == '\0' || std::strcmp(value, "pure_hip") == 0) {
        return ggml_backend_hrx_kernel_provider_mode::pure_hip;
    }
    if (std::strcmp(value, "iree") == 0) {
        return ggml_backend_hrx_kernel_provider_mode::iree;
    }
    if (std::strcmp(value, "fallback") == 0) {
        return ggml_backend_hrx_kernel_provider_mode::fallback;
    }
    GGML_LOG_WARN("%s: unknown GGML_HRX_KERNEL_PROVIDER=%s, using pure_hip\n", __func__, value);
    return ggml_backend_hrx_kernel_provider_mode::pure_hip;
}

static const char * ggml_backend_hrx_kernel_provider_mode_name(ggml_backend_hrx_kernel_provider_mode mode) {
    switch (mode) {
        case ggml_backend_hrx_kernel_provider_mode::pure_hip: return "pure_hip";
        case ggml_backend_hrx_kernel_provider_mode::iree: return "iree";
        case ggml_backend_hrx_kernel_provider_mode::fallback: return "fallback";
    }
    return "unknown";
}

static int ggml_backend_hrx_mul_mat_vec_k_workgroup_size_from_env() {
    const char * value = std::getenv("GGML_HRX_MUL_MAT_VEC_K_WG");
    ...
    GGML_LOG_WARN("%s: unknown GGML_HRX_MUL_MAT_VEC_K_WG=%s, using auto\n", __func__, value);
    return 0;
}

static int ggml_backend_hrx_mul_mat_vec_q6_k_workgroup_size_from_env() {
    const char * value = std::getenv("GGML_HRX_MUL_MAT_VEC_Q6_K_WG");
    if (!value || value[0] == '\0' || std::strcmp(value, "auto") == 0) {
        return 0;
    }
    if (std::strcmp(value, "64") == 0) {
    ...
    GGML_LOG_WARN("%s: unknown GGML_HRX_MUL_MAT_VEC_Q6_K_WG=%s, using auto\n", __func__, value);
    return 0;
}

static int ggml_backend_hrx_mul_mat_vec_bf16_workgroup_size_from_env() {
    const char * value = std::getenv("GGML_HRX_MUL_MAT_VEC_BF16_WG");
    if (!value || value[0] == '\0' || std::strcmp(value, "auto") == 0) {
        return 0;
    }
    if (std::strcmp(value, "64") == 0) {
    ...
    GGML_LOG_WARN("%s: unknown GGML_HRX_MUL_MAT_VEC_BF16_WG=%s, using auto\n", __func__, value);
    return 0;
}

static int ggml_backend_hrx_mul_mat_id_q4_k_workgroup_size_from_env() {
    const char * value = std::getenv("GGML_HRX_MUL_MAT_ID_Q4_K_WG");
    if (!value || value[0] == '\0' || std::strcmp(value, "auto") == 0) {
        return 0;
    }
    if (std::strcmp(value, "64") == 0) {
    ...
    GGML_LOG_WARN("%s: unknown GGML_HRX_MUL_MAT_ID_Q4_K_WG=%s, using auto\n", __func__, value);
    return 0;
}

static ggml_backend_hrx_q8_1_mmvq_policy ggml_backend_hrx_q8_1_mmvq_policy_from_env() {
    const char * value = std::getenv("GGML_HRX_Q8_1_MMVQ_POLICY");
    if (!value || value[0] == '\0' || std::strcmp(value, "auto") == 0) {
        return ggml_backend_hrx_q8_1_mmvq_policy::auto_select;
    }
    if (std::strcmp(value, "all") == 0) {
        return ggml_backend_hrx_q8_1_mmvq_policy::all;
    }
    GGML_LOG_WARN("%s: unknown GGML_HRX_Q8_1_MMVQ_POLICY=%s, using auto\n", __func__, value);
    return ggml_backend_hrx_q8_1_mmvq_policy::auto_select;
}
...
static const char * ggml_backend_hrx_topk_moe_variant_name(
        ggml_backend_hrx_topk_moe_variant variant) {
    switch (variant) {
        case ggml_backend_hrx_topk_moe_variant::auto_select: return "auto";
        case ggml_backend_hrx_topk_moe_variant::baseline: return "baseline";
        case ggml_backend_hrx_topk_moe_variant::shared4: return "shared4";
        case ggml_backend_hrx_topk_moe_variant::wave32: return "wave32";
    }
    return "unknown";
}

static ggml_backend_hrx_provider_policy ggml_backend_hrx_provider_policy_from_env() {
    return {
        /* .kernel_provider     = */ ggml_backend_hrx_kernel_provider_mode_from_env(),
        /* .trace_providers    = */ ggml_backend_hrx_env_enabled("GGML_HRX_TRACE_PROVIDERS"),
        /* .disable_fusion     = */ ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_FUSION"),
        /* .disable_rms_norm   = */ ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_RMS_NORM"),
        /* .disable_mul_mat_vec = */ ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_MUL_MAT_VEC"),
        /* .disable_mul_mat_id = */ ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_MUL_MAT_ID"),
        ...
        /* .disable_mul_mat_id_swiglu_fusion = */ ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_MUL_MAT_ID_SWIGLU_FUSION"),
        /* .disable_mul_mat_set_rows_fusion = */ ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_MUL_MAT_SET_ROWS_FUSION"),
        /* .disable_rope_set_rows_fusion = */ ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_ROPE_SET_ROWS_FUSION"),
        /* .disable_rms_norm_mul_rope_fusion = */ ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_RMS_NORM_MUL_ROPE_FUSION"),
        /* .disable_topk_subgroup = */ ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_TOPK_SUBGROUP"),
        /* .topk_moe_variant = */ ggml_backend_hrx_topk_moe_variant_from_env(),
        /* .disable_fast_approx_prompt = */ ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_FAST_APPROX_PROMPT"),
        /* .disable_argsort = */ ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_ARGSORT"),
        /* .enable_prompt_argsort = */ ggml_backend_hrx_env_enabled("GGML_HRX_ENABLE_ARGSORT") ||
            ggml_backend_hrx_env_enabled("GGML_HRX_ENABLE_PROMPT_ARGSORT"),
        /* .disable_topk_moe = */ ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_TOPK_MOE"),
        /* .enable_q8_1_mmvq = */ ggml_backend_hrx_env_enabled("GGML_HRX_ENABLE_Q8_1_MMVQ"),
        /* .disable_q8_1_mmvq = */ ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_Q8_1_MMVQ"),
        /* .q8_1_mmvq_policy = */ ggml_backend_hrx_q8_1_mmvq_policy_from_env(),
        /* .enable_packed_q4_k_dmmv = */ ggml_backend_hrx_env_enabled("GGML_HRX_ENABLE_PACKED_Q4_K_DMMV"),
        /* .enable_packed_q4_k_swiglu = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_PACKED_Q4_K_SWIGLU"),
        /* .enable_q4_k_swiglu_rows2_x16_decode = */ ggml_backend_hrx_env_enabled(
            "GGML_HRX_ENABLE_Q4_K_SWIGLU_ROWS2_X16_DECODE"),
        /* .enable_q4_k_swiglu_row2_decode = */ ggml_backend_hrx_env_enabled(
            "GGML_HRX_ENABLE_Q4_K_SWIGLU_ROW2_DECODE"),
        /* .enable_q4_k_swiglu_row4_decode = */ ggml_backend_hrx_env_enabled(
            "GGML_HRX_ENABLE_Q4_K_SWIGLU_ROW4_DECODE"),
        /* .enable_packed_q4_k_mul = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_PACKED_Q4_K_MUL"),
        /* .enable_packed_q4_k_mul_rows2_x16 = */ !ggml_backend_hrx_env_enabled(
            "GGML_HRX_DISABLE_PACKED_Q4_K_MUL_ROWS2_X16"),
        /* .enable_packed_q4_k_mul_rows2_x16_wg16 = */ ggml_backend_hrx_env_enabled(
            "GGML_HRX_ENABLE_PACKED_Q4_K_MUL_ROWS2_X16_WG16"),
        /* .enable_packed_q4_k_mul_2row = */ ggml_backend_hrx_env_enabled("GGML_HRX_ENABLE_PACKED_Q4_K_MUL_2ROW"),
        /* .enable_q4_k_id_row4_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_Q4_K_ID_ROW4_PROMPT"),
        /* .enable_q4_k_id_row8_prompt = */ ggml_backend_hrx_env_enabled("GGML_HRX_ENABLE_Q4_K_ID_ROW8_PROMPT"),
        /* .enable_q4_k_id_grouped_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_Q4_K_ID_GROUPED_PROMPT"),
        /* .enable_q4_k_id_q8_1_x4_mmq_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_FAST_APPROX_PROMPT") &&
            !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_Q4_K_ID_Q8_1_X4_MMQ_PROMPT"),
        /* .enable_q4_k_swiglu_row2_prompt = */ ggml_backend_hrx_env_enabled("GGML_HRX_ENABLE_Q4_K_SWIGLU_ROW2_PROMPT"),
        /* .enable_q4_k_swiglu_row4_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_Q4_K_SWIGLU_ROW4_PROMPT"),
        /* .enable_q4_k_swiglu_grouped_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_Q4_K_SWIGLU_GROUPED_PROMPT"),
        /* .enable_q4_k_swiglu_grouped_row2_route8_prompt = */ !ggml_backend_hrx_env_enabled(
            "GGML_HRX_DISABLE_Q4_K_SWIGLU_GROUPED_ROW2_ROUTE8_PROMPT"),
        /* .enable_q4_k_swiglu_q8_1_x4_mmq_prompt = */ !ggml_backend_hrx_env_enabled(
            "GGML_HRX_DISABLE_FAST_APPROX_PROMPT") &&
            !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_Q4_K_SWIGLU_Q8_1_X4_MMQ_PROMPT"),
        /* .enable_q5_k_q8_1_mmq_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_Q5_K_Q8_1_MMQ_PROMPT"),
        /* .enable_q5_k_q8_1_x4_mmq32_prompt = */ ggml_backend_hrx_env_enabled(
            "GGML_HRX_ENABLE_Q5_K_Q8_1_X4_MMQ32_PROMPT"),
        /* .enable_q5_k_q8_1_x4_mmql128_prompt = */ !ggml_backend_hrx_env_enabled(
            "GGML_HRX_DISABLE_FAST_APPROX_PROMPT") &&
            !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_Q5_K_Q8_1_X4_MMQL128_PROMPT"),
        /* .enable_q5_k_q8_1_x4_mmq64_prompt = */ ggml_backend_hrx_env_enabled(
            "GGML_HRX_ENABLE_Q5_K_Q8_1_X4_MMQ64_PROMPT"),
        /* .enable_q6_k_rows2_cols8_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_Q6_K_ROWS2_COLS8_PROMPT") &&
            !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_Q6_K_COLS16_PROMPT"),
        /* .enable_q6_k_q8_1_x4_mmql128_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_FAST_APPROX_PROMPT") &&
            !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_Q6_K_Q8_1_X4_MMQL128_PROMPT"),
        /* .enable_q6_k_q8_1_x4_mmq32_prompt = */ ggml_backend_hrx_env_enabled(
            "GGML_HRX_ENABLE_Q6_K_Q8_1_X4_MMQ32_PROMPT"),
        /* .enable_f16_batched_cols4_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_F16_BATCHED_COLS4_PROMPT"),
        /* .enable_f16_batched_cols8_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_F16_BATCHED_COLS8_PROMPT"),
        /* .enable_f16_batched_cols16_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_F16_BATCHED_COLS16_PROMPT"),
        /* .enable_f32_batched_cols8_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_F32_BATCHED_COLS8_PROMPT"),
        /* .enable_f32_batched_cols16_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_F32_BATCHED_COLS16_PROMPT"),
        /* .enable_f32_batched_rows2_cols8_prompt = */ !ggml_backend_hrx_env_enabled(
            "GGML_HRX_DISABLE_F32_BATCHED_ROWS2_COLS8_PROMPT"),
        /* .enable_bf16_cols4_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_BF16_COLS4_PROMPT"),
        /* .enable_bf16_cols8_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_BF16_COLS8_PROMPT"),
        /* .enable_bf16_cols16_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_BF16_COLS16_PROMPT"),
        /* .enable_bf16_cols32_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_BF16_COLS32_PROMPT"),
        /* .enable_bf16_rows2_cols1_decode = */ !ggml_backend_hrx_env_enabled(
            "GGML_HRX_DISABLE_BF16_ROWS2_COLS1_DECODE"),
        /* .enable_bf16_rows2_cols1_wg32_decode = */ ggml_backend_hrx_env_enabled(
            "GGML_HRX_ENABLE_BF16_ROWS2_COLS1_WG32_DECODE"),
        /* .enable_bf16_rows4_k512_cols1_decode = */ !ggml_backend_hrx_env_enabled(
            "GGML_HRX_DISABLE_BF16_ROWS4_K512_COLS1_DECODE"),
        /* .enable_bf16_rows4_k2048_cols1_decode = */ !ggml_backend_hrx_env_enabled(
            "GGML_HRX_DISABLE_BF16_ROWS4_K2048_COLS1_DECODE"),
        /* .enable_bf16_rows2_cols16_prompt = */ !ggml_backend_hrx_env_enabled(
            "GGML_HRX_DISABLE_BF16_ROWS2_COLS16_PROMPT"),
        /* .enable_bf16_wmma16_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_FAST_APPROX_PROMPT") &&
            !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_BF16_WMMA16_PROMPT"),
        /* .enable_bf16_swiglu_cols4_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_BF16_SWIGLU_COLS4_PROMPT"),
        /* .enable_bf16_swiglu_cols8_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_BF16_SWIGLU_COLS8_PROMPT"),
        /* .enable_bf16_swiglu_cols16_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_BF16_SWIGLU_COLS16_PROMPT"),
        /* .enable_bf16_swiglu_rows2_cols1_decode = */ ggml_backend_hrx_env_enabled(
            "GGML_HRX_ENABLE_BF16_SWIGLU_ROWS2_COLS1_DECODE"),
        /* .enable_bf16_swiglu_rows4_k2048_cols1_decode = */ !ggml_backend_hrx_env_enabled(
            "GGML_HRX_DISABLE_BF16_SWIGLU_ROWS4_K2048_COLS1_DECODE"),
        /* .enable_bf16_swiglu_rows2_cols8_prompt = */ !ggml_backend_hrx_env_enabled(
            "GGML_HRX_DISABLE_BF16_SWIGLU_ROWS2_COLS8_PROMPT"),
        /* .enable_bf16_swiglu_wmma16_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_FAST_APPROX_PROMPT") &&
            !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_BF16_SWIGLU_WMMA16_PROMPT"),
        /* .enable_q8_0_cols8_prompt = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_Q8_0_COLS8_PROMPT"),
        /* .enable_q8_0_q8_1_x4_mmq128x32_prompt = */ !ggml_backend_hrx_env_enabled(
            "GGML_HRX_DISABLE_FAST_APPROX_PROMPT") &&
            !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_Q8_0_Q8_1_X4_MMQ128X32_PROMPT"),
        /* .enable_q8_0_add_rows4_cols4_prompt = */ !ggml_backend_hrx_env_enabled(
            "GGML_HRX_DISABLE_Q8_0_ADD_ROWS4_COLS4_PROMPT"),
        /* .enable_q8_0_add_q8_1_x4_mmq128x32_prompt = */ !ggml_backend_hrx_env_enabled(
            "GGML_HRX_DISABLE_FAST_APPROX_PROMPT") &&
            !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_Q8_0_ADD_Q8_1_X4_MMQ128X32_PROMPT"),
        /* .enable_f16_prefill_fa_wmma = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_F16_PREFILL_FA_WMMA"),
        /* .enable_f16_prefill_fa_gfx11_direct = */ !ggml_backend_hrx_env_enabled(
            "GGML_HRX_DISABLE_F16_PREFILL_FA_GFX11_DIRECT"),
        /* .enable_f16_prefill_fa_tile = */ !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_F16_PREFILL_FA_TILE"),
        /* .mul_mat_vec_bf16_workgroup_size = */ ggml_backend_hrx_mul_mat_vec_bf16_workgroup_size_from_env(),
        /* .mul_mat_vec_k_workgroup_size = */ ggml_backend_hrx_mul_mat_vec_k_workgroup_size_from_env(),
        /* .mul_mat_vec_q6_k_workgroup_size = */ ggml_backend_hrx_mul_mat_vec_q6_k_workgroup_size_from_env(),
        /* .mul_mat_id_q4_k_workgroup_size = */ ggml_backend_hrx_mul_mat_id_q4_k_workgroup_size_from_env(),
    };
}

static void ggml_backend_hrx_trace_provider(
    ...
    std::fprintf(stderr, "ggml-hrx[%s]: ", device_context->name.c_str());
    va_list args;
...
static void ggml_backend_hrx_trace_tensor(
        const ggml_backend_hrx_device_context * device_context,
        const char * label,
        const ggml_tensor * tensor) {
    if (!device_context->policy.trace_providers) {
    ...
    if (!tensor) {
        ggml_backend_hrx_trace_provider(device_context, "%s=null\n", label);
        return;
    }
...
static void ggml_backend_hrx_trace_copy_like(
        const ggml_backend_hrx_device_context * device_context,
        const char * op_label,
        const char * provider,
...
static bool ggml_backend_hrx_load_catalog_provider(
    ...
    uint32_t export_ordinal = 0;
    hrx_executable_export_info_t export_info = {};
    bool ok = GGML_HRX_CHECK(hrx_executable_lookup_export_by_name(
    ...
    provider->kind = ggml_backend_hrx_provider_kind::direct_executable;
...
static bool ggml_backend_hrx_load_rms_norm_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_rms_norm_f32"),
        &device_context->rms_norm_provider);
}

static bool ggml_backend_hrx_load_rms_norm_mul_provider(
        ggml_backend_hrx_device_context * device_context) {
    bool ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_rms_norm_mul_f32"),
        &device_context->rms_norm_mul_provider);
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_rms_norm_mul_wg128_f32"),
        &device_context->rms_norm_mul_wg128_provider) || ok;
    return ok;
}
...
static bool ggml_backend_hrx_load_add_rms_norm_mul_broadcast_provider(
    ...
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_add_rms_norm_mul_f32_broadcast"),
        &device_context->add_rms_norm_mul_broadcast_provider);
}

static bool ggml_backend_hrx_load_add_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_add_f32"),
        &device_context->add_provider);
}

static bool ggml_backend_hrx_load_add_broadcast_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_add_f32_broadcast"),
        &device_context->add_broadcast_provider);
}

static bool ggml_backend_hrx_load_add_add_broadcast_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_add_add_f32_broadcast"),
        &device_context->add_add_broadcast_provider);
}

static bool ggml_backend_hrx_load_add8_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_add8_f32"),
        &device_context->add8_provider);
}

static bool ggml_backend_hrx_load_mul_sum8_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_sum8_f32"),
        &device_context->mul_sum8_provider);
}

static bool ggml_backend_hrx_load_mul_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_f32"),
        &device_context->mul_provider);
}

static bool ggml_backend_hrx_load_mul_broadcast_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_f32_broadcast"),
        &device_context->mul_broadcast_provider);
}

static bool ggml_backend_hrx_load_mul_add_add_broadcast_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_add_add_f32_broadcast"),
        &device_context->mul_add_add_broadcast_provider);
}
...
static bool ggml_backend_hrx_load_sigmoid_mul_add_add_broadcast_provider(
    ...
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_sigmoid_mul_add_add_f32_broadcast"),
...
static bool ggml_backend_hrx_load_add_softplus_mul_broadcast_provider(
    ...
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_add_softplus_mul_f32_broadcast"),
        &device_context->add_softplus_mul_broadcast_provider);
}

static bool ggml_backend_hrx_load_div_broadcast_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_div_f32_broadcast"),
        &device_context->div_broadcast_provider);
}

static bool ggml_backend_hrx_load_scale_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_scale_f32"),
        &device_context->scale_provider);
}

static bool ggml_backend_hrx_load_set_rows_f32_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_set_rows_f32_f32"),
        &device_context->set_rows_f32_provider);
}

static bool ggml_backend_hrx_load_set_rows_f16_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_set_rows_f32_f16"),
        &device_context->set_rows_f16_provider);
}

static bool ggml_backend_hrx_load_set_rows_q8_0_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_set_rows_f32_q8_0"),
        &device_context->set_rows_q8_0_provider);
}

static bool ggml_backend_hrx_load_set_rows_q4_0_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_set_rows_f32_q4_0"),
        &device_context->set_rows_q4_0_provider);
}

static bool ggml_backend_hrx_load_silu_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_silu_f32"),
        &device_context->silu_provider);
}

static bool ggml_backend_hrx_load_sigmoid_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_sigmoid_f32"),
        &device_context->sigmoid_provider);
}

static bool ggml_backend_hrx_load_sigmoid_mul_strided_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_sigmoid_mul_f32_strided"),
        &device_context->sigmoid_mul_strided_provider);
}

static bool ggml_backend_hrx_load_softplus_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_softplus_f32"),
        &device_context->softplus_provider);
}

static bool ggml_backend_hrx_load_swiglu_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_swiglu_f32"),
        &device_context->swiglu_provider);
}

static bool ggml_backend_hrx_load_sum_rows_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_sum_rows_f32"),
        &device_context->sum_rows_provider);
}

static bool ggml_backend_hrx_load_l2_norm_provider(
        ggml_backend_hrx_device_context * device_context) {
    bool ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_l2_norm_f32"),
        &device_context->l2_norm_provider);
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_l2_norm_wg128_f32"),
        &device_context->l2_norm_wg128_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_l2_norm_pair_wg128_f32"),
        &device_context->l2_norm_pair_wg128_provider) || ok;
    return ok;
}

static bool ggml_backend_hrx_load_clamp_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_clamp_f32"),
        &device_context->clamp_provider);
}

static bool ggml_backend_hrx_load_get_rows_f32_provider(
        ggml_backend_hrx_device_context * device_context) {
    bool ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_get_rows_f32"),
        &device_context->get_rows_f32_provider);
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_get_rows_f32_nr1"),
        &device_context->get_rows_f32_nr1_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_scale_get_rows_f32_nr1"),
        &device_context->scale_get_rows_f32_nr1_provider) || ok;
    return ok;
}

static bool ggml_backend_hrx_load_get_rows_q5_k_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_get_rows_q5_k_f32"),
        &device_context->get_rows_q5_k_provider);
}

static bool ggml_backend_hrx_load_concat_f32_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_concat_f32"),
        &device_context->concat_f32_provider);
}

static bool ggml_backend_hrx_load_copy_strided_f32_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_copy_strided_f32"),
        &device_context->copy_strided_f32_provider);
}

static bool ggml_backend_hrx_load_copy_f32_f16_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_copy_f32_f16"),
        &device_context->copy_f32_f16_provider);
}

static bool ggml_backend_hrx_load_soft_max_f32_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_soft_max_f32"),
        &device_context->soft_max_f32_provider);
}

static bool ggml_backend_hrx_load_soft_max_f32_mask_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_soft_max_f32_mask"),
        &device_context->soft_max_f32_mask_provider);
}

static bool ggml_backend_hrx_load_flash_attn_ext_f32_f16_decode_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_flash_attn_ext_f32_f16_decode"),
        &device_context->flash_attn_ext_f32_f16_decode_provider);
}

static bool ggml_backend_hrx_load_flash_attn_ext_f32_f16_prefill_wmma_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_flash_attn_ext_f32_f16_prefill_wmma16"),
        &device_context->flash_attn_ext_f32_f16_prefill_wmma_provider);
}

static bool ggml_backend_hrx_load_flash_attn_ext_f32_f16_prefill_gfx11_direct_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_flash_attn_ext_f32_f16_prefill_gfx11_direct"),
        &device_context->flash_attn_ext_f32_f16_prefill_gfx11_direct_provider);
}

static bool ggml_backend_hrx_load_flash_attn_ext_f32_f16_prefill_tile_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_flash_attn_ext_f32_f16_prefill_tile8"),
        &device_context->flash_attn_ext_f32_f16_prefill_tile_provider);
}

static bool ggml_backend_hrx_load_flash_attn_ext_f32_bf16_decode_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_flash_attn_ext_f32_bf16_decode"),
        &device_context->flash_attn_ext_f32_bf16_decode_provider);
}

static bool ggml_backend_hrx_load_flash_attn_ext_f32_f32_decode_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_flash_attn_ext_f32_f32_decode"),
        &device_context->flash_attn_ext_f32_f32_decode_provider);
}

static bool ggml_backend_hrx_load_flash_attn_ext_f32_q8_0_decode_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_flash_attn_ext_f32_q8_0_decode"),
        &device_context->flash_attn_ext_f32_q8_0_decode_provider);
}

static bool ggml_backend_hrx_load_flash_attn_ext_f32_q4_0_decode_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_flash_attn_ext_f32_q4_0_decode"),
        &device_context->flash_attn_ext_f32_q4_0_decode_provider);
}

static bool ggml_backend_hrx_load_flash_attn_ext_f32_q8_0_q4_0_decode_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_flash_attn_ext_f32_q8_0_q4_0_decode"),
        &device_context->flash_attn_ext_f32_q8_0_q4_0_decode_provider);
}

static bool ggml_backend_hrx_load_argsort_f32_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_argsort_f32_i32"),
        &device_context->argsort_f32_provider);
}

static bool ggml_backend_hrx_load_rope_f32_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_rope_f32"),
...
static bool ggml_backend_hrx_load_rope_set_rows_f32_f16_provider(
    ...
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_rope_set_rows_f32_f16"),
        &device_context->rope_set_rows_f32_f16_provider);
}

static bool ggml_backend_hrx_load_rms_norm_mul_rope_f32_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_rms_norm_mul_rope_f32"),
        &device_context->rms_norm_mul_rope_f32_provider);
}

static bool ggml_backend_hrx_load_rms_norm_mul_rope_set_rows_f32_f16_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_rms_norm_mul_rope_set_rows_f32_f16"),
        &device_context->rms_norm_mul_rope_set_rows_f32_f16_provider);
}

static bool ggml_backend_hrx_load_topk_moe_f32_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_topk_moe_f32"),
        &device_context->topk_moe_f32_provider);
}

static bool ggml_backend_hrx_load_topk_moe_f32_shared4_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_topk_moe_f32_shared4"),
        &device_context->topk_moe_f32_shared4_provider);
}

static bool ggml_backend_hrx_load_topk_moe_f32_wave32_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_topk_moe_f32_wave32"),
        &device_context->topk_moe_f32_wave32_provider);
}

static bool ggml_backend_hrx_load_ssm_conv_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_ssm_conv_f32"),
...
static bool ggml_backend_hrx_load_gated_delta_net_provider(
    ...
    bool ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_gated_delta_net_f32"),
        &device_context->gated_delta_net_provider);
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_gated_delta_net_s128_cluster8_f32"),
        &device_context->gated_delta_net_s128_cluster8_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_gated_delta_net_s128_cluster8_nokda_f32"),
        &device_context->gated_delta_net_s128_cluster8_nokda_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_gated_delta_net_s128_cluster8_nokda_nomod_f32"),
        &device_context->gated_delta_net_s128_cluster8_nokda_nomod_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_gated_delta_net_s128_h32_qk16_tok1_nokda_f32"),
        &device_context->gated_delta_net_s128_h32_qk16_tok1_nokda_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_gated_delta_net_s128_h32_qk16_tok1_nokda_beta_sigmoid_f32"),
        &device_context->gated_delta_net_s128_h32_qk16_tok1_nokda_beta_sigmoid_provider) || ok;
    return ok;
}

static bool ggml_backend_hrx_load_mul_mat_vec_f16_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_f16_f32"),
        &device_context->mul_mat_vec_f16_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_f16_batched_provider(
        ggml_backend_hrx_device_context * device_context) {
    bool ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_f16_batched_f32"),
        &device_context->mul_mat_vec_f16_batched_provider);
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_f16_batched_cols1_f32"),
        &device_context->mul_mat_vec_f16_batched_cols1_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_f16_batched_cols4_f32"),
        &device_context->mul_mat_vec_f16_batched_cols4_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_f16_batched_cols8_f32"),
        &device_context->mul_mat_vec_f16_batched_cols8_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_f16_batched_cols16_f32"),
        &device_context->mul_mat_vec_f16_batched_cols16_provider) || ok;
    return ok;
}

static bool ggml_backend_hrx_load_mul_mat_vec_bf16_provider(
        ggml_backend_hrx_device_context * device_context) {
    bool ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_f32"),
        &device_context->mul_mat_vec_bf16_provider);
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_wg128_f32"),
        &device_context->mul_mat_vec_bf16_wg128_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_wg64_f32"),
        &device_context->mul_mat_vec_bf16_wg64_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_cols1_f32"),
        &device_context->mul_mat_vec_bf16_cols1_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_rows2_cols1_f32"),
        &device_context->mul_mat_vec_bf16_rows2_cols1_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_rows2_cols1_wg32_f32"),
        &device_context->mul_mat_vec_bf16_rows2_cols1_wg32_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_rows4_k512_cols1_lds_wg256_f32"),
        &device_context->mul_mat_vec_bf16_rows4_k512_cols1_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_rows4_k2048_cols1_lds_wg256_f32"),
        &device_context->mul_mat_vec_bf16_rows4_k2048_cols1_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_cols4_f32"),
        &device_context->mul_mat_vec_bf16_cols4_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_cols8_f32"),
        &device_context->mul_mat_vec_bf16_cols8_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_cols16_f32"),
        &device_context->mul_mat_vec_bf16_cols16_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_cols32_f32"),
        &device_context->mul_mat_vec_bf16_cols32_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_rows2_cols16_f32"),
        &device_context->mul_mat_vec_bf16_rows2_cols16_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_wmma16x16_f32"),
        &device_context->mul_mat_vec_bf16_wmma16_provider) || ok;
    return ok;
}

static bool ggml_backend_hrx_load_mul_mat_vec_bf16_swiglu_provider(
        ggml_backend_hrx_device_context * device_context) {
    bool ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_swiglu_f32"),
        &device_context->mul_mat_vec_bf16_swiglu_provider);
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_swiglu_wg128_f32"),
        &device_context->mul_mat_vec_bf16_swiglu_wg128_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_swiglu_wg64_f32"),
        &device_context->mul_mat_vec_bf16_swiglu_wg64_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_swiglu_cols1_f32"),
        &device_context->mul_mat_vec_bf16_swiglu_cols1_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_swiglu_rows2_cols1_f32"),
        &device_context->mul_mat_vec_bf16_swiglu_rows2_cols1_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_swiglu_rows4_k2048_cols1_lds_wg256_f32"),
        &device_context->mul_mat_vec_bf16_swiglu_rows4_k2048_cols1_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_swiglu_cols4_f32"),
        &device_context->mul_mat_vec_bf16_swiglu_cols4_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_swiglu_cols8_f32"),
        &device_context->mul_mat_vec_bf16_swiglu_cols8_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_swiglu_cols16_f32"),
        &device_context->mul_mat_vec_bf16_swiglu_cols16_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_swiglu_rows2_cols8_f32"),
        &device_context->mul_mat_vec_bf16_swiglu_rows2_cols8_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_swiglu_wmma16x16_f32"),
        &device_context->mul_mat_vec_bf16_swiglu_wmma16_provider) || ok;
    return ok;
}

static bool ggml_backend_hrx_load_mul_mat_vec_bf16_set_rows_f16_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_bf16_set_rows_f16"),
        &device_context->mul_mat_vec_bf16_set_rows_f16_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_f32_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_f32_f32"),
        &device_context->mul_mat_vec_f32_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_f32_batched_provider(
        ggml_backend_hrx_device_context * device_context) {
    bool ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_f32_batched_f32"),
        &device_context->mul_mat_vec_f32_batched_provider);
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_f32_batched_cols1_ne2_1_f32"),
        &device_context->mul_mat_vec_f32_batched_cols1_ne2_1_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_f32_batched_cols1_ne2_1_k2048_wg32_f32"),
        &device_context->mul_mat_vec_f32_batched_cols1_ne2_1_k2048_wg32_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_f32_batched_cols8_f32"),
        &device_context->mul_mat_vec_f32_batched_cols8_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_f32_batched_cols16_f32"),
        &device_context->mul_mat_vec_f32_batched_cols16_provider) || ok;
    ok = ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_f32_batched_rows2_cols8_f32"),
        &device_context->mul_mat_vec_f32_batched_rows2_cols8_provider) || ok;
    return ok;
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_f32"),
        &device_context->mul_mat_id_q4_k_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_wg128_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_wg128_f32"),
        &device_context->mul_mat_id_q4_k_wg128_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_wg64_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_wg64_f32"),
        &device_context->mul_mat_id_q4_k_wg64_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_row4_wg64_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_row4_wg64_f32"),
        &device_context->mul_mat_id_q4_k_row4_wg64_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_row8_wg64_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_row8_wg64_f32"),
        &device_context->mul_mat_id_q4_k_row8_wg64_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_grouped_row4_wg64_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_grouped_row4_wg64_f32"),
        &device_context->mul_mat_id_q4_k_grouped_row4_wg64_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_grouped_row2_route8_wg64_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_grouped_row2_route8_wg64_f32"),
        &device_context->mul_mat_id_q4_k_grouped_row2_route8_wg64_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_grouped_q8_1_x4_mmq64x64_wg64_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_grouped_q8_1_x4_mmq64x64_wg64_f32"),
        &device_context->mul_mat_id_q4_k_grouped_q8_1_x4_mmq64x64_wg64_provider);
}

static bool ggml_backend_hrx_load_clear_u32_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_clear_u32"),
        &device_context->clear_u32_provider);
}

static bool ggml_backend_hrx_load_compact_moe_routes_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_compact_moe_routes_i32"),
        &device_context->compact_moe_routes_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_q8_1_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_q8_1_f32"),
        &device_context->mul_mat_id_q4_k_q8_1_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_mul_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_mul_f32"),
        &device_context->mul_mat_id_q4_k_mul_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_mul_wg128_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_mul_wg128_f32"),
        &device_context->mul_mat_id_q4_k_mul_wg128_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_mul_wg64_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_mul_wg64_f32"),
        &device_context->mul_mat_id_q4_k_mul_wg64_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_mul_packed_wg64_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_mul_packed_wg64_f32"),
        &device_context->mul_mat_id_q4_k_mul_packed_wg64_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_mul_rows2_x16_wg32_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_mul_rows2_x16_wg32_f32"),
        &device_context->mul_mat_id_q4_k_mul_rows2_x16_wg32_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_mul_rows2_x16_wg16_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_mul_rows2_x16_wg16_f32"),
        &device_context->mul_mat_id_q4_k_mul_rows2_x16_wg16_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_mul_packed_2row_wg64_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_mul_packed_2row_wg64_f32"),
        &device_context->mul_mat_id_q4_k_mul_packed_2row_wg64_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_swiglu_f32"),
        &device_context->mul_mat_id_q4_k_swiglu_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_wg128_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_swiglu_wg128_f32"),
        &device_context->mul_mat_id_q4_k_swiglu_wg128_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_wg64_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_swiglu_wg64_f32"),
        &device_context->mul_mat_id_q4_k_swiglu_wg64_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_row2_wg64_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_swiglu_row2_wg64_f32"),
        &device_context->mul_mat_id_q4_k_swiglu_row2_wg64_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_row4_wg64_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_swiglu_row4_wg64_f32"),
        &device_context->mul_mat_id_q4_k_swiglu_row4_wg64_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_grouped_row4_wg64_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_swiglu_grouped_row4_wg64_f32"),
        &device_context->mul_mat_id_q4_k_swiglu_grouped_row4_wg64_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_grouped_row2_route4_wg64_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_swiglu_grouped_row2_route4_wg64_f32"),
        &device_context->mul_mat_id_q4_k_swiglu_grouped_row2_route4_wg64_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_grouped_row2_route8_wg64_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_swiglu_grouped_row2_route8_wg64_f32"),
        &device_context->mul_mat_id_q4_k_swiglu_grouped_row2_route8_wg64_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_grouped_q8_1_x4_mmq32x64_wg64_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_swiglu_grouped_q8_1_x4_mmq32x64_wg64_f32"),
        &device_context->mul_mat_id_q4_k_swiglu_grouped_q8_1_x4_mmq32x64_wg64_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_packed_wg64_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_swiglu_packed_wg64_f32"),
        &device_context->mul_mat_id_q4_k_swiglu_packed_wg64_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_rows2_x16_wg32_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_swiglu_rows2_x16_wg32_f32"),
        &device_context->mul_mat_id_q4_k_swiglu_rows2_x16_wg32_provider);
}

static bool ggml_backend_hrx_load_mul_mat_id_q4_k_mul_q8_1_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_id_q4_k_mul_q8_1_f32"),
        &device_context->mul_mat_id_q4_k_mul_q8_1_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q4_k_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q4_k_f32"),
        &device_context->mul_mat_vec_q4_k_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q4_k_wg128_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q4_k_wg128_f32"),
        &device_context->mul_mat_vec_q4_k_wg128_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q4_k_wg64_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q4_k_wg64_f32"),
        &device_context->mul_mat_vec_q4_k_wg64_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q4_k_packed_wg64_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q4_k_packed_wg64_f32"),
        &device_context->mul_mat_vec_q4_k_packed_wg64_provider);
}

static bool ggml_backend_hrx_load_quantize_q8_1_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_quantize_q8_1_f32"),
        &device_context->quantize_q8_1_provider);
}

static bool ggml_backend_hrx_load_quantize_q8_1_x4_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_quantize_q8_1_x4_f32"),
        &device_context->quantize_q8_1_x4_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q4_k_q8_1_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q4_k_q8_1_f32"),
        &device_context->mul_mat_vec_q4_k_q8_1_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q5_k_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q5_k_f32"),
        &device_context->mul_mat_vec_q5_k_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q5_k_wg128_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q5_k_wg128_f32"),
        &device_context->mul_mat_vec_q5_k_wg128_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q5_k_wg64_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q5_k_wg64_f32"),
        &device_context->mul_mat_vec_q5_k_wg64_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q5_k_q8_1_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q5_k_q8_1_f32"),
        &device_context->mul_mat_vec_q5_k_q8_1_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q5_k_q8_1_mmq32x32_wg128_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q5_k_q8_1_mmq32x32_wg128_f32"),
        &device_context->mul_mat_vec_q5_k_q8_1_mmq32x32_wg128_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q5_k_q8_1_x4_mmq32x32_wg128_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q5_k_q8_1_x4_mmq32x32_wg128_f32"),
        &device_context->mul_mat_vec_q5_k_q8_1_x4_mmq32x32_wg128_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q5_k_q8_1_x4_mmql128x128_wg256_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q5_k_q8_1_x4_mmql128x128_wg256_f32"),
        &device_context->mul_mat_vec_q5_k_q8_1_x4_mmql128x128_wg256_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q5_k_q8_1_x4_mmq64x64_wg256_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q5_k_q8_1_x4_mmq64x64_wg256_f32"),
        &device_context->mul_mat_vec_q5_k_q8_1_x4_mmq64x64_wg256_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q6_k_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q6_k_f32"),
        &device_context->mul_mat_vec_q6_k_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q6_k_wg128_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q6_k_wg128_f32"),
        &device_context->mul_mat_vec_q6_k_wg128_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q6_k_wg64_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q6_k_wg64_f32"),
        &device_context->mul_mat_vec_q6_k_wg64_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q6_k_rows2_cols8_wg128_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q6_k_rows2_cols8_wg128_f32"),
        &device_context->mul_mat_vec_q6_k_rows2_cols8_wg128_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q6_k_rows2_cols1_wg32_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q6_k_rows2_cols1_wg32_f32"),
        &device_context->mul_mat_vec_q6_k_rows2_cols1_wg32_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q6_k_q8_1_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q6_k_q8_1_f32"),
        &device_context->mul_mat_vec_q6_k_q8_1_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q6_k_q8_1_x4_mmql128x64_wg256_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q6_k_q8_1_x4_mmql128x64_wg256_f32"),
        &device_context->mul_mat_vec_q6_k_q8_1_x4_mmql128x64_wg256_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q6_k_q8_1_x4_mmq32x32_wg128_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q6_k_q8_1_x4_mmq32x32_wg128_f32"),
        &device_context->mul_mat_vec_q6_k_q8_1_x4_mmq32x32_wg128_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q8_0_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q8_0_f32"),
        &device_context->mul_mat_vec_q8_0_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q8_0_cols8_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q8_0_cols8_f32"),
        &device_context->mul_mat_vec_q8_0_cols8_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q8_0_q8_1_x4_mmq128x32_wg256_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q8_0_q8_1_x4_mmq128x32_wg256_f32"),
        &device_context->mul_mat_vec_q8_0_q8_1_x4_mmq128x32_wg256_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q8_0_add_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q8_0_add_f32"),
        &device_context->mul_mat_vec_q8_0_add_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q8_0_add_cols8_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q8_0_add_cols8_f32"),
        &device_context->mul_mat_vec_q8_0_add_cols8_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q8_0_add_rows4_cols4_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q8_0_add_rows4_cols4_f32"),
        &device_context->mul_mat_vec_q8_0_add_rows4_cols4_provider);
}

static bool ggml_backend_hrx_load_mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_wg256_provider(
        ggml_backend_hrx_device_context * device_context) {
    return ggml_backend_hrx_load_catalog_provider(
        device_context,
        ggml_backend_hrx_find_catalog_entry("hrx_mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_wg256_f32"),
...
static bool ggml_backend_hrx_supports_binary_elementwise_f32(
        const ggml_backend_hrx_op_provider & provider,
        const ggml_tensor * op) {
    const ggml_tensor * src0 = op->src[0];
    const ggml_tensor * src1 = op->src[1];
    return provider.kind == ggml_backend_hrx_provider_kind::direct_executable &&
           src0 && src1 &&
...
static bool ggml_backend_hrx_supports_mul_broadcast(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * src0 = op->src[0];
    const ggml_tensor * src1 = op->src[1];
...
static bool ggml_backend_hrx_supports_add_broadcast(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * src0 = op->src[0];
    const ggml_tensor * src1 = op->src[1];
...
static bool ggml_backend_hrx_supports_add_add_broadcast(
    ...
    if (device_context->add_add_broadcast_provider.kind != ggml_backend_hrx_provider_kind::direct_executable ||
        !ggml_backend_hrx_supports_add_broadcast(device_context, first) ||
        !second ||
...
static bool ggml_backend_hrx_supports_mul_add_add_broadcast(
    ...
    if (device_context->mul_add_add_broadcast_provider.kind !=
                ggml_backend_hrx_provider_kind::direct_executable ||
        !ggml_backend_hrx_supports_mul_broadcast(device_context, mul) ||
        !first_add ||
...
static bool ggml_backend_hrx_supports_sigmoid_mul_add_add_broadcast(
        ...
        const ggml_tensor ** add_src0,
        const ggml_tensor ** add_src1) {
    if (device_context->sigmoid_mul_add_add_broadcast_provider.kind !=
                ggml_backend_hrx_provider_kind::direct_executable ||
        !sigmoid ||
...
static bool ggml_backend_hrx_supports_add_softplus_mul_broadcast(
        ...
        const ggml_tensor * mul,
        const ggml_tensor ** mul_src) {
    if (device_context->add_softplus_mul_broadcast_provider.kind !=
                ggml_backend_hrx_provider_kind::direct_executable ||
        !ggml_backend_hrx_supports_add_broadcast(device_context, add) ||
        !softplus ||
...
static bool ggml_backend_hrx_try_collect_add8_chain(
    ...
    if (!device_context->policy.enable_multi_add_fusion ||
        device_context->add8_provider.kind != ggml_backend_hrx_provider_kind::direct_executable ||
...
static bool ggml_backend_hrx_supports_mul_sum8(
        ...
        const ggml_tensor * dst) {
    if (device_context->mul_sum8_provider.kind != ggml_backend_hrx_provider_kind::direct_executable ||
        !mul ||
        mul->op != GGML_OP_MUL ||
        mul->type != GGML_TYPE_F32 ||
        !mul->src[0] ||
...
static bool ggml_backend_hrx_supports_div_broadcast(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * src0 = op->src[0];
    const ggml_tensor * src1 = op->src[1];
...
static bool ggml_backend_hrx_supports_add(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    return ggml_backend_hrx_supports_binary_elementwise_f32(
        device_context->add_provider, op) ||
        ggml_backend_hrx_supports_add_broadcast(device_context, op);
}
...
static bool ggml_backend_hrx_supports_mul(
    ...
    return ggml_backend_hrx_supports_binary_elementwise_f32(
           ...
           ggml_backend_hrx_supports_mul_broadcast(device_context, op);
}
...
static bool ggml_backend_hrx_supports_unary_f32(
    ...
    const ggml_tensor * src0 = op->src[0];
    const ggml_backend_hrx_op_provider * provider =
        ggml_backend_hrx_unary_provider(device_context, op);
    return provider &&
           provider->kind == ggml_backend_hrx_provider_kind::direct_executable &&
           src0 &&
           src0->type == GGML_TYPE_F32 &&
...
static bool ggml_backend_hrx_supports_silu_mul_f32(
        ...
        const ggml_tensor * mul) {
    if (device_context->swiglu_provider.kind != ggml_backend_hrx_provider_kind::direct_executable ||
        !silu || !mul ||
...
static bool ggml_backend_hrx_supports_cont(
        const ggml_tensor * op) {
    const ggml_tensor * src0 = op->src[0];
    return src0 &&
           src0->type == op->type &&
...
static bool ggml_backend_hrx_supports_l2_norm(
    ...
    const bool has_provider =
        device_context->l2_norm_provider.kind == ggml_backend_hrx_provider_kind::direct_executable ||
        device_context->l2_norm_wg128_provider.kind == ggml_backend_hrx_provider_kind::direct_executable;
    return has_provider &&
           src0 &&
           src0->type == GGML_TYPE_F32 &&
           op->type == GGML_TYPE_F32 &&
...
static bool ggml_backend_hrx_supports_l2_norm_pair_wg128(
        ...
        const ggml_tensor * first,
        const ggml_tensor * second) {
    return device_context->l2_norm_pair_wg128_provider.kind ==
               ggml_backend_hrx_provider_kind::direct_executable &&
           ggml_backend_hrx_supports_l2_norm(device_context, first) &&
           ggml_backend_hrx_supports_l2_norm(device_context, second) &&
...
static bool ggml_backend_hrx_supports_get_rows_f32(
    ...
    const bool has_provider =
        (src0 && src0->type == GGML_TYPE_F32 &&
         device_context->get_rows_f32_provider.kind == ggml_backend_hrx_provider_kind::direct_executable) ||
        (src0 && src0->type == GGML_TYPE_Q5_K &&
         device_context->get_rows_q5_k_provider.kind == ggml_backend_hrx_provider_kind::direct_executable);
    return has_provider &&
           src0 && src1 &&
...
static bool ggml_backend_hrx_supports_scale_get_rows_f32_nr1(
    ...
    if (context->device_context->scale_get_rows_f32_nr1_provider.kind !=
                ggml_backend_hrx_provider_kind::direct_executable ||
...
static bool ggml_backend_hrx_supports_flash_attn_ext_f32_f16_prefill_tile(
    ...
    const ggml_tensor * mask = op->src[3];
    const ggml_tensor * sinks = op->src[4];
    return device_context->policy.enable_f16_prefill_fa_tile &&
           device_context->flash_attn_ext_f32_f16_prefill_tile_provider.kind ==
               ggml_backend_hrx_provider_kind::direct_executable &&
           q && k && v && mask &&
           !sinks &&
           q->type == GGML_TYPE_F32 &&
...
static bool ggml_backend_hrx_supports_flash_attn_ext_f32_f16_prefill_gfx11_direct(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * q = op->src[0];
    const ggml_tensor * k = op->src[1];
...
static bool ggml_backend_hrx_supports_topk_moe_f32(
    ...
    if (device_context->policy.disable_topk_moe ||
        ...
        n_logit_rows <= 0 ||
        (n_logit_rows != 1 &&
            !ggml_backend_hrx_env_enabled("GGML_HRX_ENABLE_PROMPT_TOPK_MOE")) ||
...
static bool ggml_backend_hrx_supports_ssm_conv_silu(
        ...
        const ggml_tensor * silu) {
    return ggml_backend_hrx_supports_ssm_conv(device_context, ssm) &&
           silu &&
           silu->op == GGML_OP_UNARY &&
           ggml_get_unary_op(silu) == GGML_UNARY_OP_SILU &&
           silu->src[0] == ssm &&
...
static bool ggml_backend_hrx_supports_gated_delta_net(
    ...
    if (device_context->policy.disable_gated_delta_net ||
        device_context->gated_delta_net_provider.kind != ggml_backend_hrx_provider_kind::direct_executable ||
        !q || !k || !v || !g || !beta || !state) {
        return false;
    }
...
static bool ggml_backend_hrx_supports_gated_delta_net_state_update(
    ...
    if (!ggml_backend_hrx_supports_gated_delta_net(device_context, gdn) ||
        !cpy ||
        cpy->op != GGML_OP_CPY ||
...
static bool ggml_backend_hrx_supports_gated_delta_net_beta_sigmoid(
    ...
    if (!sigmoid ||
        ...
        gdn->src[4] != sigmoid ||
        !ggml_backend_hrx_supports_gated_delta_net(device_context, gdn) ||
    ...
    hrx_dispatch_config_t config = {
        ...
        /* .workgroup_size = */ {
            provider.export_info.workgroup_size[0] ?
                provider.export_info.workgroup_size[0] :
                GGML_HRX_RMS_NORM_WORKGROUP_SIZE,
            1,
            1,
        },
        /* .subgroup_size = */ 0,
...
static ggml_status ggml_backend_hrx_dispatch_rms_norm_mul(
    ...
    const auto & provider =
        constants.ncols <= 128 &&
                context->device_context->rms_norm_mul_wg128_provider.kind ==
                    ggml_backend_hrx_provider_kind::direct_executable ?
...
static ggml_status ggml_backend_hrx_dispatch_rms_norm_mul_rope_f32(
    ...
    hrx_dispatch_config_t config = {
        ...
        /* .workgroup_size = */ {
            provider.export_info.workgroup_size[0] ? provider.export_info.workgroup_size[0] : GGML_HRX_RMS_NORM_WORKGROUP_SIZE,
            1,
            1,
        },
        /* .subgroup_size = */ 0,
...
struct ggml_backend_hrx_mul_broadcast_constants {
    int64_t ne0;
    int64_t nrows;
    int64_t ne1;
    int64_t ne2;
...
struct ggml_backend_hrx_flash_attn_ext_f32_f16_decode_constants {
    int64_t D;
    int64_t KV;
    int64_t N;
    int64_t H;
...
static const ggml_backend_hrx_op_provider & ggml_backend_hrx_select_topk_moe_f32_provider(
    ...
    auto provider_available = [](const ggml_backend_hrx_op_provider & provider) {
        return provider.kind == ggml_backend_hrx_provider_kind::direct_executable;
    };
    auto select_if_available = [&](const ggml_backend_hrx_op_provider & provider, const char * label)
            -> const ggml_backend_hrx_op_provider * {
    ...
    *provider_label = "pure_hip_f32_shared1";
    const auto & baseline = device_context->topk_moe_f32_provider;
    if (device_context->policy.disable_topk_subgroup) {
        return baseline;
    }

    switch (device_context->policy.topk_moe_variant) {
        case ggml_backend_hrx_topk_moe_variant::baseline:
            return baseline;
        case ggml_backend_hrx_topk_moe_variant::shared4:
            if (const auto * provider = select_if_available(
                    device_context->topk_moe_f32_shared4_provider, "pure_hip_f32_shared4")) {
                return *provider;
            }
            break;
        case ggml_backend_hrx_topk_moe_variant::wave32:
            if (const auto * provider = select_if_available(
                    device_context->topk_moe_f32_wave32_provider, "pure_hip_f32_wave32")) {
                return *provider;
            }
            break;
...
static ggml_status ggml_backend_hrx_dispatch_binary_elementwise_f32(
        ggml_backend_hrx_context * context,
        const ggml_tensor * dst,
        const ggml_backend_hrx_op_provider & provider,
        const char * op_name) {
...
static ggml_status ggml_backend_hrx_dispatch_mul_broadcast_f32(
        ggml_backend_hrx_context * context,
        const ggml_tensor * dst) {
    const ggml_tensor * src0 = dst->src[0];
    const ggml_tensor * src1 = dst->src[1];
    ...
    if (!ggml_backend_hrx_tensor_buffer_ref(src0, &bindings[0]) ||
        !ggml_backend_hrx_tensor_buffer_ref(src1, &bindings[1]) ||
        !ggml_backend_hrx_tensor_buffer_ref(dst, &bindings[2])) {
        GGML_LOG_ERROR("%s: broadcast MUL tensor is not backed by a HRX buffer\n", __func__);
        return GGML_STATUS_FAILED;
    }

    ggml_backend_hrx_mul_broadcast_constants constants = {
        /* .ne0      = */ dst->ne[0],
...
static ggml_status ggml_backend_hrx_dispatch_add_broadcast_f32(
        ggml_backend_hrx_context * context,
        const ggml_tensor * dst) {
    const ggml_tensor * src0 = dst->src[0];
    const ggml_tensor * src1 = dst->src[1];
    ...
    if (!ggml_backend_hrx_tensor_buffer_ref(src0, &bindings[0]) ||
        !ggml_backend_hrx_tensor_buffer_ref(src1, &bindings[1]) ||
        !ggml_backend_hrx_tensor_buffer_ref(dst, &bindings[2])) {
        GGML_LOG_ERROR("%s: broadcast ADD tensor is not backed by a HRX buffer\n", __func__);
        return GGML_STATUS_FAILED;
    }
...
static ggml_status ggml_backend_hrx_dispatch_add_add_broadcast_f32(
    ...
    if (!ggml_backend_hrx_tensor_buffer_ref(src0, &bindings[0]) ||
        ...
        GGML_LOG_ERROR("%s: fused broadcast ADD tensor is not backed by a HRX buffer\n", __func__);
        return GGML_STATUS_FAILED;
    }
...
static ggml_status ggml_backend_hrx_dispatch_div_broadcast_f32(
        ggml_backend_hrx_context * context,
        const ggml_tensor * dst) {
    const ggml_tensor * src0 = dst->src[0];
    const ggml_tensor * src1 = dst->src[1];
    ...
    if (!ggml_backend_hrx_tensor_buffer_ref(src0, &bindings[0]) ||
        !ggml_backend_hrx_tensor_buffer_ref(src1, &bindings[1]) ||
        !ggml_backend_hrx_tensor_buffer_ref(dst, &bindings[2])) {
        GGML_LOG_ERROR("%s: broadcast DIV tensor is not backed by a HRX buffer\n", __func__);
        return GGML_STATUS_FAILED;
    }
...
static ggml_status ggml_backend_hrx_dispatch_scale_f32(
        ggml_backend_hrx_context * context,
        const ggml_tensor * dst) {
    const ggml_tensor * src0 = dst->src[0];
    hrx_buffer_ref_t bindings[2] = {};
...
static ggml_status ggml_backend_hrx_dispatch_cpy(
        ggml_backend_hrx_context * context,
        const ggml_tensor * dst) {
    const ggml_tensor * src0 = dst->src[0];
    ...
    if (src0->type == GGML_TYPE_F32 &&
        ...
        if (provider.kind != ggml_backend_hrx_provider_kind::direct_executable) {
...
static ggml_status ggml_backend_hrx_dispatch_l2_norm(
    ...
    const bool use_wg128 =
        !ggml_backend_hrx_env_enabled("GGML_HRX_DISABLE_L2_NORM_WG128") &&
        constants.ncols <= 128 &&
...
static ggml_backend_hrx_row_reduce_constants ggml_backend_hrx_l2_norm_constants(
        const ggml_tensor * dst) {
    const ggml_tensor * src0 = dst->src[0];
    float eps = 0.0f;
    std::memcpy(&eps, dst->op_params, sizeof(eps));
...
static ggml_status ggml_backend_hrx_dispatch_l2_norm_pair_wg128(
    ...
    ggml_backend_hrx_l2_norm_pair_constants constants = {
        /* .a = */ ggml_backend_hrx_l2_norm_constants(first),
        /* .b = */ ggml_backend_hrx_l2_norm_constants(second),
    };
    ...
    context->dispatch_count++;
    context->reduction_count += 2;

    return GGML_STATUS_SUCCESS;
}

static ggml_status ggml_backend_hrx_dispatch_clamp(
        ggml_backend_hrx_context * context,
        const ggml_tensor * dst) {
    const ggml_tensor * src0 = dst->src[0];
    hrx_buffer_ref_t bindings[2] = {};
...
static ggml_status ggml_backend_hrx_dispatch_scale_get_rows_f32_nr1(
    ...
    const auto & provider = context->device_context->scale_get_rows_f32_nr1_provider;
    const uint32_t workgroup_size = provider.export_info.workgroup_size[0] ?
        provider.export_info.workgroup_size[0] : 256;
    hrx_dispatch_config_t config = {
        /* .workgroup_count = */ {
...
static ggml_status ggml_backend_hrx_dispatch_soft_max_f32(
    ...
    if (!ggml_backend_hrx_validate_f32_tensor_finite(context, src0, "soft_max_input")) {
        return GGML_STATUS_FAILED;
    }
    ...
    if (!ggml_backend_hrx_validate_f32_tensor_finite(context, dst, "soft_max_output")) {
        return GGML_STATUS_FAILED;
    }
...
static ggml_status ggml_backend_hrx_dispatch_flash_attn_ext_f32_f16_decode(
        ggml_backend_hrx_context * context,
        const ggml_tensor * dst) {
    ...
    ggml_backend_hrx_flash_attn_ext_f32_f16_decode_constants constants = {
        /* .D        = */ q->ne[0],
        /* .KV       = */ k->ne[1],
        /* .N        = */ q->ne[1],
        /* .H        = */ q->ne[2],
    ...
    const bool use_prefill_gfx11_direct =
        ggml_backend_hrx_supports_flash_attn_ext_f32_f16_prefill_gfx11_direct(context->device_context, dst);
    ...
    const ggml_backend_hrx_op_provider * selected_provider = use_prefill_gfx11_direct ?
...
static ggml_status ggml_backend_hrx_dispatch_argsort_f32(
    ...
    if (!ggml_backend_hrx_validate_argsort_result(context, dst)) {
        return GGML_STATUS_FAILED;
    }
...
static ggml_status ggml_backend_hrx_dispatch_topk_moe_f32(
    ...
    ggml_backend_hrx_topk_moe_f32_constants constants = {
        ...
        /* .weights_nb1   = */ ggml_backend_hrx_topk_moe_row_stride(
            weights, ggml_nelements(weights) / ggml_nrows(logits)),
        /* .weights_nb_k  = */ ggml_backend_hrx_topk_moe_k_stride(
            weights, ggml_nelements(weights) / ggml_nrows(logits)),
        /* .ids_nb1       = */ ggml_backend_hrx_topk_moe_row_stride(
            ids, ggml_nelements(ids) / ggml_nrows(logits)),
        /* .ids_nb_k      = */ ggml_backend_hrx_topk_moe_k_stride(
            ids, ggml_nelements(ids) / ggml_nrows(logits)),
        /* .scale         = */ scale,
        /* .clamp_min     = */ clamp_min,
        /* .clamp_max     = */ clamp_max,
    ...
    const auto & provider = ggml_backend_hrx_select_topk_moe_f32_provider(
        context->device_context, constants.n_rows, &provider_label);
    (void) provider_label;
...
static ggml_status ggml_backend_hrx_dispatch_rope_set_rows_f32_f16(
    ...
    if (!ggml_backend_hrx_tensor_buffer_ref(src0, &bindings[0]) ||
        ...
        GGML_LOG_ERROR("%s: fused ROPE_SET_ROWS tensor is not backed by a HRX buffer\n", __func__);
        return GGML_STATUS_FAILED;
    }
...
static ggml_status ggml_backend_hrx_dispatch_ssm_conv(
    ...
    if (!ggml_backend_hrx_tensor_buffer_ref(src0, &bindings[0]) ||
        !ggml_backend_hrx_tensor_buffer_ref(src1, &bindings[1]) ||
        !ggml_backend_hrx_tensor_buffer_ref(out, &bindings[2])) {
...
static ggml_status ggml_backend_hrx_dispatch_gated_delta_net(
    ...
    const bool use_s128_h32_qk16_tok1_nokda_beta_sigmoid =
        ...
        context->device_context->gated_delta_net_s128_h32_qk16_tok1_nokda_beta_sigmoid_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable;
    const auto * provider = use_s128_h32_qk16_tok1_nokda_beta_sigmoid ?
...
static bool ggml_backend_hrx_supports_mul_mat_vec_f16(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * src0 = op->src[0];
    const ggml_tensor * src1 = op->src[1];
    return device_context->mul_mat_vec_f16_provider.kind ==
           ...
           op->ne[0] == src0->ne[1] &&
           op->ne[1] == src1->ne[1] &&
           src1->ne[1] >= 1 && src1->ne[1] <= GGML_HRX_MUL_MAT_VEC_MAX_COLS &&
           ggml_is_contiguous(src0) &&
           ggml_is_contiguous(src1) &&
           ggml_is_contiguous(op);
}

static bool ggml_backend_hrx_supports_mul_mat_vec_f16_batched(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * src0 = op->src[0];
    const ggml_tensor * src1 = op->src[1];
...
static bool ggml_backend_hrx_supports_mul_mat_vec_f32_batched(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * src0 = op->src[0];
    const ggml_tensor * src1 = op->src[1];
...
static bool ggml_backend_hrx_supports_mul_mat_vec_bf16(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * src0 = op->src[0];
    const ggml_tensor * src1 = op->src[1];
...
static bool ggml_backend_hrx_supports_mul_mat_vec_bf16_set_rows_f16(
    ...
    return device_context->mul_mat_vec_bf16_set_rows_f16_provider.kind ==
           ...
           set_rows->src[2] &&
           set_rows->src[2]->type == GGML_TYPE_F16 &&
           ggml_backend_hrx_supports_mul_mat_vec_bf16(device_context, mul_mat) &&
           ggml_backend_hrx_supports_set_rows(device_context, set_rows) &&
...
static bool ggml_backend_hrx_supports_mul_mat_vec_bf16_swiglu(
    ...
    return device_context->mul_mat_vec_bf16_swiglu_provider.kind ==
           ...
           swiglu->src[0] == gate &&
           swiglu->src[1] == up &&
           ggml_backend_hrx_supports_mul_mat_vec_bf16(device_context, gate) &&
           ggml_backend_hrx_supports_mul_mat_vec_bf16(device_context, up) &&
           gate->src[1] == up->src[1] &&
...
static bool ggml_backend_hrx_supports_mul_mat_vec_f32(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * src0 = op->src[0];
    const ggml_tensor * src1 = op->src[1];
...
static bool ggml_backend_hrx_supports_mul_mat_vec_k_quant(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op,
        ggml_type type,
        const ggml_backend_hrx_op_provider & provider,
...
static bool ggml_backend_hrx_q8_1_mmvq_force_all(
        const ggml_backend_hrx_device_context * device_context) {
    return device_context->policy.q8_1_mmvq_policy == ggml_backend_hrx_q8_1_mmvq_policy::all;
}

static bool ggml_backend_hrx_q8_1_mmvq_auto_shape(
        const ggml_tensor * op,
        ggml_type type) {
    const ggml_tensor * src0 = op->src[0];
    if (!src0) {
...
static bool ggml_backend_hrx_supports_mul_mat_vec_q4_k(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    return ggml_backend_hrx_supports_mul_mat_vec_k_quant(
...
static bool ggml_backend_hrx_supports_mul_mat_vec_q4_k_q8_1(
    ...
    return device_context->policy.enable_q8_1_mmvq &&
           ...
           (ggml_backend_hrx_q8_1_mmvq_force_all(device_context) ||
            ggml_backend_hrx_q8_1_mmvq_auto_shape(op, GGML_TYPE_Q4_K)) &&
           device_context->quantize_q8_1_provider.kind ==
               ggml_backend_hrx_provider_kind::direct_executable &&
           ggml_backend_hrx_supports_mul_mat_vec_k_quant(
               device_context, op, GGML_TYPE_Q4_K,
               device_context->mul_mat_vec_q4_k_q8_1_provider, 256);
}

static bool ggml_backend_hrx_supports_mul_mat_vec_q5_k(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    return ggml_backend_hrx_supports_mul_mat_vec_k_quant(
...
static bool ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    return device_context->policy.enable_q8_1_mmvq &&
           !device_context->policy.disable_q8_1_mmvq &&
...
static bool ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1_mmq_prompt(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * src1 = op->src[1];
    return device_context->policy.enable_q5_k_q8_1_mmq_prompt &&
           src1 &&
           src1->ne[1] == 512 &&
           (src1->ne[1] % 16) == 0 &&
           ggml_backend_hrx_q8_1_mmvq_auto_shape(op, GGML_TYPE_Q5_K) &&
           device_context->quantize_q8_1_provider.kind ==
               ggml_backend_hrx_provider_kind::direct_executable &&
           ggml_backend_hrx_supports_mul_mat_vec_k_quant(
               device_context, op, GGML_TYPE_Q5_K,
               device_context->mul_mat_vec_q5_k_q8_1_mmq32x32_wg128_provider, 256);
}

static bool ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1_x4_mmq32_prompt(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * src1 = op->src[1];
    return device_context->policy.enable_q5_k_q8_1_x4_mmq32_prompt &&
           src1 &&
           src1->ne[1] == 512 &&
           (src1->ne[1] % 32) == 0 &&
           ggml_backend_hrx_q8_1_mmvq_auto_shape(op, GGML_TYPE_Q5_K) &&
           ...
           ggml_backend_hrx_supports_mul_mat_vec_k_quant(
               device_context, op, GGML_TYPE_Q5_K,
               device_context->mul_mat_vec_q5_k_q8_1_x4_mmq32x32_wg128_provider, 256);
}

static bool ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1_x4_mmql128_prompt(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * src1 = op->src[1];
    return device_context->policy.enable_q5_k_q8_1_x4_mmql128_prompt &&
           ...
           ggml_backend_hrx_supports_mul_mat_vec_k_quant(
               device_context, op, GGML_TYPE_Q5_K,
               device_context->mul_mat_vec_q5_k_q8_1_x4_mmql128x128_wg256_provider, 256);
}

static bool ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1_x4_mmq64_prompt(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * src1 = op->src[1];
    return device_context->policy.enable_q5_k_q8_1_x4_mmq64_prompt &&
           src1 &&
           src1->ne[1] == 512 &&
           (src1->ne[1] % 64) == 0 &&
           ggml_backend_hrx_q8_1_mmvq_auto_shape(op, GGML_TYPE_Q5_K) &&
           ...
           ggml_backend_hrx_supports_mul_mat_vec_k_quant(
               device_context, op, GGML_TYPE_Q5_K,
               device_context->mul_mat_vec_q5_k_q8_1_x4_mmq64x64_wg256_provider, 256);
}

static bool ggml_backend_hrx_supports_mul_mat_vec_q6_k(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    return ggml_backend_hrx_supports_mul_mat_vec_k_quant(
...
static bool ggml_backend_hrx_supports_mul_mat_vec_q6_k_q8_1(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    return device_context->policy.enable_q8_1_mmvq &&
           !device_context->policy.disable_q8_1_mmvq &&
           (ggml_backend_hrx_q8_1_mmvq_force_all(device_context) ||
            ggml_backend_hrx_q8_1_mmvq_auto_shape(op, GGML_TYPE_Q6_K)) &&
           device_context->quantize_q8_1_provider.kind ==
               ggml_backend_hrx_provider_kind::direct_executable &&
           ggml_backend_hrx_supports_mul_mat_vec_k_quant(
...
static bool ggml_backend_hrx_supports_mul_mat_vec_q6_k_q8_1_x4_mmql128_prompt(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * src1 = op->src[1];
    return device_context->policy.enable_q6_k_q8_1_x4_mmql128_prompt &&
           ...
           ggml_backend_hrx_supports_mul_mat_vec_k_quant(
               device_context, op, GGML_TYPE_Q6_K,
               device_context->mul_mat_vec_q6_k_q8_1_x4_mmql128x64_wg256_provider, 256);
}

static bool ggml_backend_hrx_supports_mul_mat_vec_q6_k_q8_1_x4_mmq32_prompt(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * src1 = op->src[1];
    return device_context->policy.enable_q6_k_q8_1_x4_mmq32_prompt &&
           ...
           ggml_backend_hrx_supports_mul_mat_vec_k_quant(
               device_context, op, GGML_TYPE_Q6_K,
               device_context->mul_mat_vec_q6_k_q8_1_x4_mmq32x32_wg128_provider, 256);
}

static bool ggml_backend_hrx_supports_mul_mat_vec_q8_0(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    return ggml_backend_hrx_supports_mul_mat_vec_k_quant(
...
static bool ggml_backend_hrx_supports_mul_mat_vec_q8_0_cols8_prompt(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * src1 = op ? op->src[1] : nullptr;
    return device_context->policy.enable_q8_0_cols8_prompt &&
           src1 &&
           src1->ne[1] == 512 &&
           (src1->ne[1] % 8) == 0 &&
           ggml_backend_hrx_supports_mul_mat_vec_k_quant(
...
static bool ggml_backend_hrx_supports_mul_mat_vec_q8_0_q8_1_x4_mmq128x32_prompt(
    ...
    return device_context->policy.enable_q8_0_q8_1_x4_mmq128x32_prompt &&
           ...
           src1->ne[1] == 512 &&
           (src1->ne[1] % 32) == 0 &&
           ggml_backend_hrx_q8_1_mmvq_auto_shape(op, GGML_TYPE_Q8_0) &&
           device_context->quantize_q8_1_x4_provider.kind ==
               ggml_backend_hrx_provider_kind::direct_executable &&
           ggml_backend_hrx_supports_mul_mat_vec_k_quant(
               device_context, op, GGML_TYPE_Q8_0,
...
static bool ggml_backend_hrx_supports_mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_prompt(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * mm) {
    const ggml_tensor * src0 = mm ? mm->src[0] : nullptr;
    const ggml_tensor * src1 = mm ? mm->src[1] : nullptr;
    return device_context->policy.enable_q8_0_add_q8_1_x4_mmq128x32_prompt &&
           !device_context->policy.disable_fast_approx_prompt &&
           src0 &&
           src1 &&
           src0->type == GGML_TYPE_Q8_0 &&
           ...
           src1->ne[1] == 512 &&
           (src1->ne[1] % 32) == 0 &&
           ggml_backend_hrx_q8_1_mmvq_auto_shape(mm, GGML_TYPE_Q8_0) &&
           device_context->quantize_q8_1_x4_provider.kind ==
               ggml_backend_hrx_provider_kind::direct_executable &&
           ggml_backend_hrx_supports_mul_mat_vec_k_quant(
               device_context, mm, GGML_TYPE_Q8_0,
               device_context->mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_wg256_provider, 256);
}
...
static bool ggml_backend_hrx_supports_mul_mat_vec_q8_0_add(
    ...
    const bool has_scalar_provider =
        device_context->mul_mat_vec_q8_0_add_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable;
    const bool has_cols8_provider =
        device_context->policy.enable_q8_0_cols8_prompt &&
        device_context->mul_mat_vec_q8_0_add_cols8_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable &&
        mm && mm->src[1] && mm->src[1]->ne[1] == 512 && (mm->src[1]->ne[1] % 8) == 0;
    const bool has_rows4_cols4_provider =
        device_context->policy.enable_q8_0_add_rows4_cols4_prompt &&
        device_context->mul_mat_vec_q8_0_add_rows4_cols4_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable &&
        mm && mm->src[0] && mm->src[1] &&
        mm->src[0]->ne[1] % 4 == 0 &&
        mm->src[1]->ne[1] == 512 && (mm->src[1]->ne[1] % 4) == 0;
    const bool has_q8_1_x4_mmq128x32_provider =
        ggml_backend_hrx_supports_mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_prompt(device_context, mm);
    if ((!has_scalar_provider && !has_cols8_provider && !has_rows4_cols4_provider &&
         !has_q8_1_x4_mmq128x32_provider) ||
        !ggml_backend_hrx_supports_mul_mat_vec_q8_0(device_context, mm) ||
        !add ||
        add->op != GGML_OP_ADD ||
...
static const char * ggml_backend_hrx_mul_mat_vec_unsupported_reason(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    if (device_context->policy.disable_mul_mat_vec) {
        return "disabled by GGML_HRX_DISABLE_MUL_MAT_VEC";
    }
    if (!op) {
        return "op is null";
    }
    ...
    if (src0->type != GGML_TYPE_F16 &&
        ...
        src0->type != GGML_TYPE_Q8_0) {
        return "src0 type has no HRX matvec provider";
    }
    if (src0->type == GGML_TYPE_F16 &&
        device_context->mul_mat_vec_f16_provider.kind != ggml_backend_hrx_provider_kind::direct_executable &&
        device_context->mul_mat_vec_f16_batched_provider.kind != ggml_backend_hrx_provider_kind::direct_executable) {
        return "F16 provider unavailable";
    }
    if (src0->type == GGML_TYPE_BF16 &&
        device_context->mul_mat_vec_bf16_provider.kind != ggml_backend_hrx_provider_kind::direct_executable) {
        return "BF16 provider unavailable";
    }
    if (src0->type == GGML_TYPE_F32 &&
        device_context->mul_mat_vec_f32_provider.kind != ggml_backend_hrx_provider_kind::direct_executable &&
        device_context->mul_mat_vec_f32_batched_provider.kind != ggml_backend_hrx_provider_kind::direct_executable) {
        return "F32 provider unavailable";
    }
    if (src0->type == GGML_TYPE_Q4_K &&
        device_context->mul_mat_vec_q4_k_provider.kind != ggml_backend_hrx_provider_kind::direct_executable) {
        return "Q4_K provider unavailable";
    }
    if (src0->type == GGML_TYPE_Q5_K &&
        device_context->mul_mat_vec_q5_k_provider.kind != ggml_backend_hrx_provider_kind::direct_executable) {
        return "Q5_K provider unavailable";
    }
    if (src0->type == GGML_TYPE_Q6_K &&
        device_context->mul_mat_vec_q6_k_provider.kind != ggml_backend_hrx_provider_kind::direct_executable) {
        return "Q6_K provider unavailable";
    }
    if (src0->type == GGML_TYPE_Q8_0 &&
        device_context->mul_mat_vec_q8_0_provider.kind != ggml_backend_hrx_provider_kind::direct_executable) {
    ...
    if (src1->ne[1] < 1 || src1->ne[1] > GGML_HRX_MUL_MAT_VEC_MAX_COLS) {
...
static bool ggml_backend_hrx_supports_mul_mat_vec(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    return ggml_backend_hrx_supports_mul_mat_vec_f16(device_context, op) ||
           ggml_backend_hrx_supports_mul_mat_vec_f16_batched(device_context, op) ||
           ggml_backend_hrx_supports_mul_mat_vec_bf16(device_context, op) ||
           ggml_backend_hrx_supports_mul_mat_vec_f32(device_context, op) ||
           ggml_backend_hrx_supports_mul_mat_vec_f32_batched(device_context, op) ||
           ggml_backend_hrx_supports_mul_mat_vec_q4_k(device_context, op) ||
           ggml_backend_hrx_supports_mul_mat_vec_q4_k_q8_1(device_context, op) ||
           ggml_backend_hrx_supports_mul_mat_vec_q5_k(device_context, op) ||
           ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1(device_context, op) ||
           ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1_x4_mmq64_prompt(device_context, op) ||
           ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1_x4_mmql128_prompt(device_context, op) ||
           ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1_x4_mmq32_prompt(device_context, op) ||
           ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1_mmq_prompt(device_context, op) ||
           ggml_backend_hrx_supports_mul_mat_vec_q6_k(device_context, op) ||
           ggml_backend_hrx_supports_mul_mat_vec_q6_k_q8_1(device_context, op) ||
           ggml_backend_hrx_supports_mul_mat_vec_q6_k_q8_1_x4_mmql128_prompt(device_context, op) ||
           ggml_backend_hrx_supports_mul_mat_vec_q6_k_q8_1_x4_mmq32_prompt(device_context, op) ||
           ggml_backend_hrx_supports_mul_mat_vec_q8_0(device_context, op);
}
...
struct ggml_backend_hrx_mul_mat_vec_f16_batched_constants {
    int64_t k;
    int64_t rows;
    int64_t cols;
    int64_t dst_ne2;
...
static int ggml_backend_hrx_select_mul_mat_vec_bf16_workgroup_size(
        const ggml_backend_hrx_device_context * device_context,
        int64_t k,
        int64_t rows) {
...
static const ggml_backend_hrx_op_provider * ggml_backend_hrx_select_mul_mat_vec_bf16_provider(
    ...
    if (device_context->policy.enable_bf16_rows2_cols1_decode &&
        ...
        k == 512 &&
        rows == 2048 &&
        device_context->mul_mat_vec_bf16_rows4_k512_cols1_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return &device_context->mul_mat_vec_bf16_rows4_k512_cols1_provider;
    }
    if (device_context->policy.enable_bf16_rows2_cols1_decode &&
        device_context->policy.enable_bf16_rows2_cols1_wg32_decode &&
        cols == 1 &&
        k == 512 &&
        rows == 2048 &&
        device_context->mul_mat_vec_bf16_rows2_cols1_wg32_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
    ...
    if (device_context->policy.enable_bf16_rows2_cols1_decode &&
        cols == 1 &&
        rows >= 2 &&
        device_context->mul_mat_vec_bf16_rows2_cols1_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
    ...
    if (device_context->policy.enable_bf16_wmma16_prompt &&
        (k % 16) == 0 &&
        cols == 512 &&
        (rows % 16) == 0 &&
        (cols % 16) == 0 &&
        device_context->mul_mat_vec_bf16_wmma16_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return &device_context->mul_mat_vec_bf16_wmma16_provider;
    }
    if (device_context->policy.enable_bf16_rows2_cols16_prompt &&
        cols == 512 &&
        (cols % 16) == 0 &&
        (rows % 2) == 0 &&
        device_context->mul_mat_vec_bf16_rows2_cols16_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return &device_context->mul_mat_vec_bf16_rows2_cols16_provider;
    }
    if (device_context->policy.enable_bf16_cols32_prompt &&
        cols == 512 &&
        (cols % 32) == 0 &&
        device_context->mul_mat_vec_bf16_cols32_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return &device_context->mul_mat_vec_bf16_cols32_provider;
    }
    if (device_context->policy.enable_bf16_cols16_prompt &&
        cols == 512 &&
        (cols % 16) == 0 &&
        device_context->mul_mat_vec_bf16_cols16_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return &device_context->mul_mat_vec_bf16_cols16_provider;
    }
    if (device_context->policy.enable_bf16_cols8_prompt &&
        cols == 512 &&
        (cols % 8) == 0 &&
        device_context->mul_mat_vec_bf16_cols8_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
    ...
    const int workgroup_size = ggml_backend_hrx_select_mul_mat_vec_bf16_workgroup_size(
...
static const ggml_backend_hrx_op_provider * ggml_backend_hrx_select_mul_mat_vec_bf16_swiglu_provider(
    ...
    if (device_context->policy.enable_bf16_swiglu_rows2_cols1_decode &&
        cols == 1 &&
        rows >= 2 &&
        device_context->mul_mat_vec_bf16_swiglu_rows2_cols1_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
    ...
    if (device_context->policy.enable_bf16_swiglu_wmma16_prompt &&
        (k % 16) == 0 &&
        cols == 512 &&
        (rows % 16) == 0 &&
        device_context->mul_mat_vec_bf16_swiglu_wmma16_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return &device_context->mul_mat_vec_bf16_swiglu_wmma16_provider;
    }
    if (device_context->policy.enable_bf16_swiglu_rows2_cols8_prompt &&
        cols == 512 &&
        (cols % 8) == 0 &&
        (rows % 2) == 0 &&
        device_context->mul_mat_vec_bf16_swiglu_rows2_cols8_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return &device_context->mul_mat_vec_bf16_swiglu_rows2_cols8_provider;
    }
    if (device_context->policy.enable_bf16_swiglu_cols16_prompt &&
        cols == 512 &&
        (cols % 16) == 0 &&
        device_context->mul_mat_vec_bf16_swiglu_cols16_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return &device_context->mul_mat_vec_bf16_swiglu_cols16_provider;
    }
    if (device_context->policy.enable_bf16_swiglu_cols8_prompt &&
        cols == 512 &&
        (cols % 8) == 0 &&
        device_context->mul_mat_vec_bf16_swiglu_cols8_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
...
static const ggml_backend_hrx_op_provider * ggml_backend_hrx_select_mul_mat_vec_k_provider(
    ...
    const int workgroup_size = ggml_backend_hrx_select_mul_mat_vec_k_workgroup_size(
    ...
    switch (type) {
        ...
        case GGML_TYPE_Q6_K:
            if (cols == 1 &&
                rows >= 2 &&
                device_context->mul_mat_vec_q6_k_rows2_cols1_wg32_provider.kind ==
                    ggml_backend_hrx_provider_kind::direct_executable) {
                return &device_context->mul_mat_vec_q6_k_rows2_cols1_wg32_provider;
            }
            if (device_context->policy.enable_q6_k_rows2_cols8_prompt &&
                cols == 512 &&
                (rows % 2) == 0 &&
                (cols % 8) == 0 &&
                device_context->mul_mat_vec_q6_k_rows2_cols8_wg128_provider.kind ==
                    ggml_backend_hrx_provider_kind::direct_executable) {
...
static const char * ggml_backend_hrx_mul_mat_vec_trace_suffix(
        const ggml_backend_hrx_device_context * device_context,
        const ggml_tensor * op) {
    if (ggml_backend_hrx_supports_mul_mat_vec_q6_k_q8_1_x4_mmql128_prompt(device_context, op)) {
        return "_q8_1_x4_mmql128x64_wg256";
    }
    if (ggml_backend_hrx_supports_mul_mat_vec_q6_k_q8_1_x4_mmq32_prompt(device_context, op)) {
        return "_q8_1_x4_mmq32x32_wg128";
    }
    if (ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1_x4_mmq64_prompt(device_context, op)) {
        return "_q8_1_x4_mmq64x64_wg256";
    }
    if (ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1_x4_mmql128_prompt(device_context, op)) {
        return "_q8_1_x4_mmql128x128_wg256";
    }
    if (ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1_x4_mmq32_prompt(device_context, op)) {
        return "_q8_1_x4_mmq32x32_wg128";
    }
    if (ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1_mmq_prompt(device_context, op)) {
        return "_q8_1_mmq32x32_wg128";
    }
    if (ggml_backend_hrx_supports_mul_mat_vec_q4_k_q8_1(device_context, op) ||
        ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1(device_context, op) ||
        ggml_backend_hrx_supports_mul_mat_vec_q6_k_q8_1(device_context, op)) {
        return "_q8_1";
    }
    if (op->src[0]->type == GGML_TYPE_Q8_0 &&
        ggml_backend_hrx_supports_mul_mat_vec_q8_0_q8_1_x4_mmq128x32_prompt(device_context, op)) {
    ...
    if (op->src[0]->type == GGML_TYPE_Q6_K &&
        ...
        device_context->mul_mat_vec_q6_k_rows2_cols1_wg32_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return "_rows2_cols1_wg32";
    }
    if (op->src[0]->type == GGML_TYPE_Q6_K &&
        device_context->policy.enable_q6_k_rows2_cols8_prompt &&
         device_context->mul_mat_vec_q6_k_rows2_cols8_wg128_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        if (op->src[1]->ne[1] == 512) {
            return "_rows2_cols8_wg128";
        }
    }
    if (op->src[0]->type == GGML_TYPE_Q8_0 &&
        ggml_backend_hrx_supports_mul_mat_vec_q8_0_cols8_prompt(device_context, op)) {
        return "_cols8";
    }
    if ((op->src[0]->type == GGML_TYPE_Q4_K ||
         op->src[0]->type == GGML_TYPE_Q5_K ||
         op->src[0]->type == GGML_TYPE_Q6_K) &&
        ggml_backend_hrx_select_mul_mat_vec_k_workgroup_size(
    ...
    if (op->src[0]->type == GGML_TYPE_BF16 &&
        ...
        device_context->mul_mat_vec_bf16_rows4_k512_cols1_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return "_rows4_k512_cols1_lds_wg256";
    }
    if (op->src[0]->type == GGML_TYPE_BF16 &&
        op->src[1]->ne[1] == 1 &&
        op->src[0]->ne[0] == 512 &&
    ...
    if (op->src[0]->type == GGML_TYPE_BF16 &&
        ...
        op->src[1]->ne[1] == 512 &&
        (op->src[0]->ne[1] % 16) == 0 &&
        device_context->policy.enable_bf16_wmma16_prompt &&
        device_context->mul_mat_vec_bf16_wmma16_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return "_wmma16x16";
    }
    if (op->src[0]->type == GGML_TYPE_BF16 &&
        op->src[1]->ne[1] == 512 &&
        (op->src[0]->ne[1] % 2) == 0 &&
        device_context->policy.enable_bf16_rows2_cols16_prompt &&
        device_context->mul_mat_vec_bf16_rows2_cols16_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return "_rows2_cols16";
    }
    if (op->src[0]->type == GGML_TYPE_BF16 &&
        op->src[1]->ne[1] == 512 &&
        device_context->policy.enable_bf16_cols32_prompt &&
        device_context->mul_mat_vec_bf16_cols32_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return "_cols32";
    }
    if (op->src[0]->type == GGML_TYPE_BF16 &&
        op->src[1]->ne[1] == 512 &&
        device_context->policy.enable_bf16_cols16_prompt &&
        device_context->mul_mat_vec_bf16_cols16_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return "_cols16";
    }
    if (op->src[0]->type == GGML_TYPE_BF16 &&
        op->src[1]->ne[1] == 512 &&
        device_context->policy.enable_bf16_cols8_prompt &&
        device_context->mul_mat_vec_bf16_cols8_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return "_cols8";
    }
    ...
    if (op->src[0]->type == GGML_TYPE_BF16 &&
        ggml_backend_hrx_select_mul_mat_vec_bf16_workgroup_size(
    ...
    if (op->src[0]->type == GGML_TYPE_F32 &&
        op->src[1]->ne[1] == 512 &&
        (op->src[0]->ne[1] % 2) == 0 &&
        device_context->policy.enable_f32_batched_rows2_cols8_prompt &&
        device_context->mul_mat_vec_f32_batched_rows2_cols8_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return "_batched_rows2_cols8";
    }
    if (op->src[0]->type == GGML_TYPE_F32 &&
        op->src[1]->ne[1] == 512 &&
        device_context->policy.enable_f32_batched_cols16_prompt &&
        device_context->mul_mat_vec_f32_batched_cols16_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return "_batched_cols16";
    }
    if (op->src[0]->type == GGML_TYPE_F32 &&
        op->src[1]->ne[1] == 512 &&
        device_context->policy.enable_f32_batched_cols8_prompt &&
        device_context->mul_mat_vec_f32_batched_cols8_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
    ...
    if (op->src[0]->type == GGML_TYPE_F16 &&
        op->src[1]->ne[1] == 512 &&
        device_context->policy.enable_f16_batched_cols16_prompt &&
        device_context->mul_mat_vec_f16_batched_cols16_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return "_batched_cols16";
    }
    if (op->src[0]->type == GGML_TYPE_F16 &&
    ...
    if (ggml_backend_hrx_supports_mul_mat_vec_f16_batched(device_context, op) ||
        ggml_backend_hrx_supports_mul_mat_vec_f32_batched(device_context, op)) {
        return "_batched";
    }
    return "";
...
static int ggml_backend_hrx_select_mul_mat_id_q4_k_workgroup_size(
        const ggml_backend_hrx_device_context * device_context,
        int64_t k,
        int64_t rows) {
    (void) rows;
...
static const ggml_backend_hrx_op_provider * ggml_backend_hrx_select_mul_mat_id_q4_k_provider(
        ...
        int64_t n_ids,
        int64_t n_tokens) {
    if (device_context->policy.enable_q4_k_id_q8_1_x4_mmq_prompt &&
        k == 512 &&
        (rows % 64) == 0 &&
        n_ids == 8 &&
        n_tokens == 512 &&
        ...
        device_context->quantize_q8_1_x4_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable &&
        device_context->mul_mat_id_q4_k_grouped_q8_1_x4_mmq64x64_wg64_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
    ...
    const int workgroup_size = ggml_backend_hrx_select_mul_mat_id_q4_k_workgroup_size(device_context, k, rows);
    const ggml_backend_hrx_op_provider * provider = workgroup_size == 64 ?
        &device_context->mul_mat_id_q4_k_wg64_provider :
        (workgroup_size == 128 ?
            &device_context->mul_mat_id_q4_k_wg128_provider :
...
static const ggml_backend_hrx_op_provider * ggml_backend_hrx_select_mul_mat_id_q4_k_mul_provider(
    ...
    if (device_context->policy.enable_packed_q4_k_mul &&
        ...
        n_ids == 8 &&
        n_tokens == 1 &&
        device_context->policy.enable_packed_q4_k_mul_rows2_x16 &&
        device_context->policy.enable_packed_q4_k_mul_rows2_x16_wg16 &&
        device_context->mul_mat_id_q4_k_mul_rows2_x16_wg16_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return &device_context->mul_mat_id_q4_k_mul_rows2_x16_wg16_provider;
    }
    if (device_context->policy.enable_packed_q4_k_mul &&
        k == 512 &&
        rows == 2048 &&
        ...
        n_tokens == 1 &&
        device_context->policy.enable_packed_q4_k_mul_rows2_x16 &&
        device_context->mul_mat_id_q4_k_mul_rows2_x16_wg32_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
...
static const char * ggml_backend_hrx_mul_mat_id_q4_k_mul_trace_suffix(
        const ggml_backend_hrx_device_context * device_context,
        int64_t k,
        int64_t rows,
        int64_t n_ids,
...
static const ggml_backend_hrx_op_provider * ggml_backend_hrx_select_mul_mat_id_q4_k_swiglu_provider(
        ...
        int64_t n_ids,
        int64_t n_tokens) {
    if (device_context->policy.enable_q4_k_swiglu_q8_1_x4_mmq_prompt &&
        k == 2048 &&
        (rows % 32) == 0 &&
        n_ids == 8 &&
        n_tokens == 512 &&
        ...
        device_context->quantize_q8_1_x4_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable &&
        device_context->mul_mat_id_q4_k_swiglu_grouped_q8_1_x4_mmq32x64_wg64_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return &device_context->mul_mat_id_q4_k_swiglu_grouped_q8_1_x4_mmq32x64_wg64_provider;
    }
    if (device_context->policy.enable_q4_k_swiglu_rows2_x16_decode &&
        k == 2048 &&
        rows == 512 &&
        n_ids == 8 &&
        n_tokens == 1 &&
        device_context->mul_mat_id_q4_k_swiglu_rows2_x16_wg32_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return &device_context->mul_mat_id_q4_k_swiglu_rows2_x16_wg32_provider;
    }
    if (device_context->policy.enable_q4_k_swiglu_row4_decode &&
        k == 2048 &&
        rows == 512 &&
        n_ids == 8 &&
        n_tokens == 1 &&
    ...
    if (device_context->policy.enable_q4_k_swiglu_row2_decode &&
        k == 2048 &&
        rows == 512 &&
        n_ids == 8 &&
        n_tokens == 1 &&
...
static const char * ggml_backend_hrx_mul_mat_id_q4_k_swiglu_trace_suffix(
        const ggml_backend_hrx_device_context * device_context,
        int64_t k,
        int64_t rows,
        int64_t n_ids,
    ...
    if (device_context->policy.enable_q4_k_swiglu_q8_1_x4_mmq_prompt &&
        ...
        device_context->mul_mat_id_q4_k_swiglu_grouped_q8_1_x4_mmq32x64_wg64_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return "_grouped_q8_1_x4_mmq32x64_wg64";
    }
    if (device_context->policy.enable_q4_k_swiglu_rows2_x16_decode &&
        k == 2048 &&
        rows == 512 &&
...
static const char * ggml_backend_hrx_mul_mat_id_q4_k_trace_suffix(
        const ggml_backend_hrx_device_context * device_context,
        int64_t k,
        int64_t rows,
        int64_t n_ids,
    ...
    if (device_context->policy.enable_q4_k_id_q8_1_x4_mmq_prompt &&
        ...
        device_context->mul_mat_id_q4_k_grouped_q8_1_x4_mmq64x64_wg64_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable) {
        return "_grouped_q8_1_x4_mmq64x64_wg64";
    }
    if (device_context->policy.enable_q4_k_id_grouped_prompt &&
        k == 512 &&
        (rows % 2) == 0 &&
...
static bool ggml_backend_hrx_dispatch_quantize_q8_1(
    ...
    if (!ggml_backend_hrx_ensure_q8_1_scratch(context, q8_1_size, q8_1_ref)) {
        return false;
    }

    hrx_buffer_ref_t quant_bindings[2] = { src_ref, *q8_1_ref };
...
static ggml_status ggml_backend_hrx_dispatch_mul_mat_vec_k_q8_1(
    ...
    const bool use_q5_x4_mmq64 = src0->type == GGML_TYPE_Q5_K &&
        ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1_x4_mmq64_prompt(context->device_context, dst);
    const bool use_q5_x4_mmql128 = src0->type == GGML_TYPE_Q5_K &&
        ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1_x4_mmql128_prompt(context->device_context, dst);
    const bool use_q5_x4_mmq32 = src0->type == GGML_TYPE_Q5_K &&
        ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1_x4_mmq32_prompt(context->device_context, dst);
    const bool use_q6_x4_mmql128 = src0->type == GGML_TYPE_Q6_K &&
        ggml_backend_hrx_supports_mul_mat_vec_q6_k_q8_1_x4_mmql128_prompt(context->device_context, dst);
    const bool use_q6_x4_mmq32 = src0->type == GGML_TYPE_Q6_K &&
        ggml_backend_hrx_supports_mul_mat_vec_q6_k_q8_1_x4_mmq32_prompt(context->device_context, dst);
    const bool use_q8_x4_mmq128x32 = src0->type == GGML_TYPE_Q8_0 &&
        ggml_backend_hrx_supports_mul_mat_vec_q8_0_q8_1_x4_mmq128x32_prompt(context->device_context, dst);
    ...
    const auto & quant_provider = use_x4_mmq ?
        context->device_context->quantize_q8_1_x4_provider :
        context->device_context->quantize_q8_1_provider;
    hrx_dispatch_config_t quant_config = {
        /* .workgroup_count = */ {
            static_cast<uint32_t>(use_x4_mmq ?
                (quant_constants.ne0 + 127) / 128 :
                quant_constants.ne0 / 32),
            static_cast<uint32_t>(quant_constants.ne1),
    ...
    switch (src0->type) {
        ...
        case GGML_TYPE_Q5_K:
            if (use_q5_x4_mmq64) {
                provider = &context->device_context->mul_mat_vec_q5_k_q8_1_x4_mmq64x64_wg256_provider;
            } else if (use_q5_x4_mmql128) {
                provider = &context->device_context->mul_mat_vec_q5_k_q8_1_x4_mmql128x128_wg256_provider;
            } else if (use_q5_x4_mmq32) {
                provider = &context->device_context->mul_mat_vec_q5_k_q8_1_x4_mmq32x32_wg128_provider;
            } else if (ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1_mmq_prompt(
                    context->device_context, dst)) {
                provider = &context->device_context->mul_mat_vec_q5_k_q8_1_mmq32x32_wg128_provider;
            } else {
                provider = &context->device_context->mul_mat_vec_q5_k_q8_1_provider;
            }
            break;
        case GGML_TYPE_Q6_K:
            if (use_q6_x4_mmql128) {
                provider = &context->device_context->mul_mat_vec_q6_k_q8_1_x4_mmql128x64_wg256_provider;
            } else if (use_q6_x4_mmq32) {
                provider = &context->device_context->mul_mat_vec_q6_k_q8_1_x4_mmq32x32_wg128_provider;
            } else {
...
static ggml_status ggml_backend_hrx_dispatch_mul_mat_vec_f16(
        ggml_backend_hrx_context * context,
        const ggml_tensor * dst) {
    if (ggml_backend_hrx_supports_mul_mat_vec_f16_batched(context->device_context, dst) ||
        ggml_backend_hrx_supports_mul_mat_vec_f32_batched(context->device_context, dst)) {
        const ggml_tensor * src0 = dst->src[0];
        const ggml_tensor * src1 = dst->src[1];
        hrx_buffer_ref_t bindings[3] = {};
        if (!ggml_backend_hrx_tensor_buffer_ref(src0, &bindings[0]) ||
            !ggml_backend_hrx_tensor_buffer_ref(src1, &bindings[1]) ||
            !ggml_backend_hrx_tensor_buffer_ref(dst, &bindings[2])) {
            GGML_LOG_ERROR("%s: batched MUL_MAT tensor is not backed by a HRX buffer\n", __func__);
            return GGML_STATUS_FAILED;
        }

        ggml_backend_hrx_mul_mat_vec_f16_batched_constants constants = {
            /* .k         = */ src0->ne[0],
            /* .rows      = */ src0->ne[1],
            /* .cols      = */ src1->ne[1],
            /* .dst_ne2   = */ dst->ne[2],
        ...
        const bool use_f32_cols8 =
            ...
            constants.cols == 512 &&
            (constants.cols % 8) == 0 &&
            context->device_context->policy.enable_f32_batched_cols8_prompt &&
            context->device_context->mul_mat_vec_f32_batched_cols8_provider.kind ==
                ggml_backend_hrx_provider_kind::direct_executable;
        const bool use_f32_cols16 =
            src0->type == GGML_TYPE_F32 &&
            constants.cols == 512 &&
            (constants.cols % 16) == 0 &&
            context->device_context->policy.enable_f32_batched_cols16_prompt &&
            context->device_context->mul_mat_vec_f32_batched_cols16_provider.kind ==
                ggml_backend_hrx_provider_kind::direct_executable;
        const bool use_f32_rows2_cols8 =
            src0->type == GGML_TYPE_F32 &&
            constants.cols == 512 &&
            (constants.rows % 2) == 0 &&
            (constants.cols % 8) == 0 &&
            context->device_context->policy.enable_f32_batched_rows2_cols8_prompt &&
            context->device_context->mul_mat_vec_f32_batched_rows2_cols8_provider.kind ==
                ggml_backend_hrx_provider_kind::direct_executable;
        ...
        const bool use_f16_cols8 =
            ...
            context->device_context->mul_mat_vec_f16_batched_cols8_provider.kind ==
                ggml_backend_hrx_provider_kind::direct_executable;
        const bool use_f16_cols16 =
            src0->type == GGML_TYPE_F16 &&
            constants.cols == 512 &&
            (constants.cols % 16) == 0 &&
            context->device_context->policy.enable_f16_batched_cols16_prompt &&
            context->device_context->mul_mat_vec_f16_batched_cols16_provider.kind ==
                ggml_backend_hrx_provider_kind::direct_executable;
        const auto & provider = src0->type == GGML_TYPE_F16 ?
            (use_f16_cols1 ?
                context->device_context->mul_mat_vec_f16_batched_cols1_provider :
                (use_f16_cols16 ?
                    context->device_context->mul_mat_vec_f16_batched_cols16_provider :
                    (use_f16_cols8 ?
    ...
    if (ggml_backend_hrx_supports_mul_mat_vec_q4_k_q8_1(context->device_context, dst) ||
        ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1(context->device_context, dst) ||
        ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1_x4_mmq64_prompt(context->device_context, dst) ||
        ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1_x4_mmql128_prompt(context->device_context, dst) ||
        ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1_x4_mmq32_prompt(context->device_context, dst) ||
        ggml_backend_hrx_supports_mul_mat_vec_q5_k_q8_1_mmq_prompt(context->device_context, dst) ||
        ggml_backend_hrx_supports_mul_mat_vec_q6_k_q8_1(context->device_context, dst) ||
        ggml_backend_hrx_supports_mul_mat_vec_q6_k_q8_1_x4_mmql128_prompt(context->device_context, dst) ||
        ggml_backend_hrx_supports_mul_mat_vec_q6_k_q8_1_x4_mmq32_prompt(context->device_context, dst) ||
        ggml_backend_hrx_supports_mul_mat_vec_q8_0_q8_1_x4_mmq128x32_prompt(context->device_context, dst)) {
    ...
    switch (src0->type) {
        case GGML_TYPE_F16:
            ...
            break;
        case GGML_TYPE_BF16:
            provider = ggml_backend_hrx_select_mul_mat_vec_bf16_provider(
        ...
        case GGML_TYPE_Q5_K:
        case GGML_TYPE_Q6_K:
            provider = ggml_backend_hrx_select_mul_mat_vec_k_provider(
                context->device_context, src0->type, constants.k, constants.rows, constants.cols);
            break;
        case GGML_TYPE_Q8_0:
            provider = ggml_backend_hrx_supports_mul_mat_vec_q8_0_cols8_prompt(
                context->device_context, dst) ?
                &context->device_context->mul_mat_vec_q8_0_cols8_provider :
                &context->device_context->mul_mat_vec_q8_0_provider;
            break;
        default:
            return GGML_STATUS_FAILED;
    }
    ...
    const uint32_t provider_cols_per_workgroup =
        (provider == &context->device_context->mul_mat_vec_q6_k_rows2_cols1_wg32_provider) ? 1 :
        (provider == &context->device_context->mul_mat_vec_q6_k_rows2_cols8_wg128_provider) ? 8 :
        (provider == &context->device_context->mul_mat_vec_q8_0_cols8_provider) ? 8 :
...
static ggml_status ggml_backend_hrx_dispatch_mul_mat_vec_q8_0_add(
    ...
    const bool use_q8_1_x4_mmq128x32 =
        ggml_backend_hrx_supports_mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_prompt(
            context->device_context, mm);
    const bool use_rows4_cols4 =
        !use_q8_1_x4_mmq128x32 &&
        context->device_context->policy.enable_q8_0_add_rows4_cols4_prompt &&
        constants.cols == 512 &&
        (constants.rows % 4) == 0 &&
        (constants.cols % 4) == 0 &&
        context->device_context->mul_mat_vec_q8_0_add_rows4_cols4_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable;
    const bool use_cols8 =
        !use_q8_1_x4_mmq128x32 &&
        !use_rows4_cols4 &&
        context->device_context->policy.enable_q8_0_cols8_prompt &&
        constants.cols == 512 &&
        (constants.cols % 8) == 0 &&
        context->device_context->mul_mat_vec_q8_0_add_cols8_provider.kind ==
            ggml_backend_hrx_provider_kind::direct_executable;
    ...
    if (use_q8_1_x4_mmq128x32) {
        const int64_t q8_1_blocks =
            src1->ne[3] * src1->ne[2] * src1->ne[1] * (src1->ne[0] / 32);
        ...
        hrx_dispatch_config_t quant_config = {
            ...
            /* .workgroup_size = */ {
                quant_provider.export_info.workgroup_size[0] ? quant_provider.export_info.workgroup_size[0] : 128,
                1,
                1,
            },
            /* .subgroup_size = */ 0,
...
static ggml_status ggml_backend_hrx_dispatch_mul_mat_vec_bf16_swiglu(
    ...
    const auto & provider = *ggml_backend_hrx_select_mul_mat_vec_bf16_swiglu_provider(
        context->device_context, constants.k, constants.rows, constants.cols);
    const uint32_t provider_rows_per_workgroup =
...
static ggml_status ggml_backend_hrx_dispatch_mul_mat_id_q4_k(
    ...
    if (provider == &context->device_context->mul_mat_id_q4_k_grouped_row4_wg64_provider ||
        ...
        hrx_buffer_ref_t counts_ref = {
            /* .buffer = */ scratch_ref.buffer,
            /* .offset = */ scratch_ref.offset,
            /* .length = */ counts_size,
        };
        hrx_buffer_ref_t routes_ref = {
            /* .buffer = */ scratch_ref.buffer,
            /* .offset = */ scratch_ref.offset + counts_size,
            /* .length = */ routes_size,
        };

        ggml_backend_hrx_clear_u32_constants clear_constants = {
        ...
        if (use_q8_1_x4_mmq) {
            ...
            ggml_backend_hrx_quantize_q8_1_constants quant_constants = {
                /* .ne00 = */ src1->ne[0],
                /* .s01  = */ src1->ne[1] == 1 ? 0 : static_cast<int64_t>(src1->nb[1] / sizeof(float)),
                /* .s02  = */ static_cast<int64_t>(src1->nb[2] / sizeof(float)),
                /* .s03  = */ static_cast<int64_t>(src1->nb[3] / sizeof(float)),
                /* .ne0  = */ constants.k,
                /* .ne1  = */ constants.n_ids,
                /* .ne2  = */ constants.n_tokens,
            };
            const auto & quant_provider = context->device_context->quantize_q8_1_x4_provider;
...
static ggml_status ggml_backend_hrx_dispatch_mul_mat_id_q4_k_mul(
    ...
    const bool use_two_rows_per_workgroup =
        ...
        provider == &context->device_context->mul_mat_id_q4_k_mul_rows2_x16_wg16_provider ||
            ...
            static_cast<uint32_t>(
                provider == &context->device_context->mul_mat_id_q4_k_swiglu_row4_wg64_provider ?
                    ...
                    (provider == &context->device_context->mul_mat_id_q4_k_swiglu_row2_wg64_provider ||
                     provider == &context->device_context->mul_mat_id_q4_k_swiglu_rows2_x16_wg32_provider ?
...
static void ggml_backend_hrx_buffer_free_buffer(ggml_backend_buffer_t buffer) {
    auto * context = ggml_backend_hrx_get_buffer_context(buffer);
    ggml_backend_hrx_trace_lifetime(
        "free_buffer ggml_buffer=%p hrx_buffer=%p size=%zu",
        static_cast<void *>(buffer),
        static_cast<void *>(context->buffer),
...
static enum ggml_status ggml_backend_hrx_buffer_init_tensor(
...
static void ggml_backend_hrx_buffer_memset_tensor(
    ...
    ggml_backend_hrx_trace_lifetime(
        "memset_tensor begin buffer=%p hrx_buffer=%p tensor=%s type=%s buffer_off=%zu offset=%zu size=%zu value=%u",
        static_cast<void *>(buffer),
        static_cast<void *>(context->buffer),
        tensor->name,
        ggml_type_name(tensor->type),
...
static void ggml_backend_hrx_buffer_set_tensor(
    ...
    const size_t buffer_offset = ggml_backend_hrx_tensor_offset(context, tensor) + offset;
    ggml_backend_hrx_trace_lifetime(
        "set_tensor begin buffer=%p hrx_buffer=%p tensor=%s type=%s buffer_off=%zu offset=%zu size=%zu data=%p",
        static_cast<void *>(buffer),
        static_cast<void *>(context->buffer),
        tensor->name,
        ggml_type_name(tensor->type),
        ...
        size,
        data);
    if (ggml_backend_hrx_should_trace_buffer_transfer(size)) {
        std::fprintf(
            stderr,
            "ggml-hrx: buffer set size=%zu tensor=%s offset=%zu buffer_off=%zu type=%s ne=[%" PRId64 ",%" PRId64 ",%" PRId64 ",%" PRId64 "]\n",
            size,
            tensor->name,
            offset,
            buffer_offset,
    ...
    (void) ggml_backend_hrx_stage_and_copy_tensor(context, tensor, data, buffer_offset, buffer->size, size);
}
...
static void ggml_backend_hrx_buffer_get_tensor(
    ...
    const size_t buffer_offset = ggml_backend_hrx_tensor_offset(context, tensor) + offset;
    ggml_backend_hrx_trace_lifetime(
        "get_tensor begin buffer=%p hrx_buffer=%p tensor=%s type=%s buffer_off=%zu offset=%zu size=%zu data=%p",
        static_cast<void *>(buffer),
        static_cast<void *>(context->buffer),
        tensor->name,
        ggml_type_name(tensor->type),
    ...
    if (ggml_backend_hrx_should_trace_buffer_transfer(size)) {
        std::fprintf(
            stderr,
            "ggml-hrx: buffer get size=%zu tensor=%s offset=%zu buffer_off=%zu type=%s ne=[%" PRId64 ",%" PRId64 ",%" PRId64 ",%" PRId64 "]\n",
            size,
            tensor->name,
            offset,
            buffer_offset,
    ...
    (void) ggml_backend_hrx_copy_tensor_to_staging(
...
static bool ggml_backend_hrx_buffer_cpy_tensor(
    ...
    ggml_backend_hrx_trace_lifetime(
        "copy_tensor begin src_buffer=%p dst_buffer=%p src_hrx=%p dst_hrx=%p src=%s dst=%s type=%s src_off=%zu dst_off=%zu size=%zu",
        static_cast<void *>(src_buffer),
        static_cast<void *>(buffer),
        static_cast<void *>(src_context->buffer),
        static_cast<void *>(dst_context->buffer),
        src->name,
        dst->name,
    ...
    if (ggml_backend_hrx_should_trace_buffer_transfer(size)) {
        std::fprintf(
            stderr,
            "ggml-hrx: buffer copy size=%zu src=%s dst=%s src_off=%zu dst_off=%zu type=%s ne=[%" PRId64 ",%" PRId64 ",%" PRId64 ",%" PRId64 "]\n",
            size,
            src->name,
            dst->name,
            src_offset,
...
static const ggml_backend_buffer_i ggml_backend_hrx_buffer_i = {
    ...
    /* .init_tensor   = */ ggml_backend_hrx_buffer_init_tensor,
...
static ggml_backend_buffer_t ggml_backend_hrx_buffer_type_alloc_buffer(
    ...
    ggml_backend_hrx_trace_lifetime(
        "alloc_buffer begin buft=%s size=%zu memory_type=%d access=%d usage=%d",
        ggml_backend_hrx_buffer_type_get_name(buft),
        size,
        static_cast<int>(buft_context->params.type),
        static_cast<int>(buft_context->params.access),
        static_cast<int>(buft_context->params.usage));
    if (size > 0 &&
        ...
        ggml_backend_hrx_trace_lifetime("alloc_buffer failed size=%zu", size);
        return nullptr;
    }
    ggml_backend_hrx_trace_lifetime("alloc_buffer hrx ok size=%zu hrx_buffer=%p", size, static_cast<void *>(hrx_buffer));
    ...
    if (!buffer) {
        ...
        delete context;
        ggml_backend_hrx_trace_lifetime("alloc_buffer ggml init failed size=%zu", size);
    } else {
        ggml_backend_hrx_trace_lifetime(
            "alloc_buffer done ggml_buffer=%p hrx_buffer=%p size=%zu base=%p",
            static_cast<void *>(buffer),
            static_cast<void *>(hrx_buffer),
            size,
            static_cast<void *>(context->base));
    }
    return buffer;
}
...
static bool ggml_backend_hrx_try_defer_mul_mat_set_rows_fusion(
        const ggml_cgraph * cgraph,
        int mul_mat_idx,
        const ggml_backend_hrx_device_context * device_context,
    ...
    for (int set_rows_idx = mul_mat_idx + 1; set_rows_idx < cgraph->n_nodes; ++set_rows_idx) {
        ...
        if (set_rows->op != GGML_OP_SET_ROWS ||
            ggml_backend_hrx_unwrap_reshape_view_src0(set_rows->src[0]) != mul_mat ||
        ...
        for (const ggml_tensor * current = set_rows->src[0]; current != mul_mat; current = current->src[0]) {
            if (!ggml_backend_hrx_is_reshape_view(current)) {
                return false;
            }
        ...
        for (int m = static_cast<int>(metadata_nodes.size()) - 1; m >= 0; --m) {
            const int metadata_idx = ggml_backend_hrx_find_node_index(
...
static const ggml_tensor * ggml_backend_hrx_find_gated_delta_net_state_update(
    ...
    for (int cpy_idx = gdn_idx + 1; cpy_idx < cgraph->n_nodes; ++cpy_idx) {
        ...
        if (ggml_backend_hrx_supports_gated_delta_net_state_update(device_context, gdn, cpy)) {
            return cpy;
        }
    }
    return nullptr;
...
struct ggml_backend_hrx_active_stream_guard {
    ggml_backend_hrx_device_context * device_context = nullptr;
    hrx_stream_t previous = nullptr;

    ggml_backend_hrx_active_stream_guard(ggml_backend_hrx_device_context * device_context, hrx_stream_t stream)
        : device_context(device_context),
          previous(device_context ? device_context->active_stream : nullptr) {
        if (device_context) {
            device_context->active_stream = stream;
        }
    }

    ~ggml_backend_hrx_active_stream_guard() {
        if (device_context) {
            device_context->active_stream = previous;
        }
    }
};
...
static ggml_status ggml_backend_hrx_graph_compute(ggml_backend_t backend, ggml_cgraph * cgraph) {
    ...
    for (int i = 0; i < cgraph->n_nodes; ++i) {
        ...
        if (!context->device_context->policy.disable_fusion &&
            ggml_backend_hrx_try_topk_moe_fusion(cgraph, i, context->device_context, &fusion)) {
            const char * provider_label = nullptr;
            (void) ggml_backend_hrx_select_topk_moe_f32_provider(
                context->device_context, ggml_nrows(fusion.soft_max->src[0]), &provider_label);
            ggml_backend_hrx_trace_provider(
                context->device_context,
                "claim TOPK_MOE_%s provider=%s variant=%s experts=%" PRId64 " k=%" PRId64 " nrows=%" PRId64 "\n",
                fusion.clamp ? "EARLY_SOFTMAX_NORM" : "EARLY_SOFTMAX",
                provider_label,
                ggml_backend_hrx_topk_moe_variant_name(context->device_context->policy.topk_moe_variant),
        ...
        if (node->op == GGML_OP_RMS_NORM &&
            ...
            ggml_check_edges(cgraph, i, GGML_HRX_RMS_NORM_MUL_ROPE_VIEW_SET_ROWS_EDGES) &&
        ...
        if (node->op == GGML_OP_RMS_NORM &&
            ...
            cgraph->nodes[i + 1]->op == GGML_OP_MUL &&
            cgraph->nodes[i + 2]->op == GGML_OP_ROPE &&
            ggml_check_edges(cgraph, i, GGML_HRX_RMS_NORM_MUL_ROPE_EDGES) &&
        ...
        if (node->op == GGML_OP_RMS_NORM &&
            ...
            if (ggml_backend_hrx_dispatch_rms_norm_mul(context, node, mul) != GGML_STATUS_SUCCESS) {
                return GGML_STATUS_FAILED;
            }
            i++;
            continue;
                ...
                ggml_backend_hrx_trace_provider(
                    ...
                    up->src[1]->ne[1] == 1 &&
                        ...
                        context->device_context->mul_mat_vec_bf16_swiglu_rows4_k2048_cols1_provider.kind ==
                            ggml_backend_hrx_provider_kind::direct_executable ? "_rows4_k2048_cols1_lds_wg256" :
                    (up->src[1]->ne[1] == 1 &&
                        up->src[0]->ne[1] >= 2 &&
                        ...
                        context->device_context->mul_mat_vec_bf16_swiglu_rows2_cols1_provider.kind ==
                            ggml_backend_hrx_provider_kind::direct_executable ? "_rows2_cols1" :
                    (up->src[1]->ne[1] == 1 &&
                        context->device_context->mul_mat_vec_bf16_swiglu_cols1_provider.kind ==
                            ggml_backend_hrx_provider_kind::direct_executable ? "_cols1" :
                        (up->src[1]->ne[1] == 512 &&
                         (up->src[0]->ne[0] % 16) == 0 &&
                         (up->src[0]->ne[1] % 16) == 0 &&
                         context->device_context->policy.enable_bf16_swiglu_wmma16_prompt &&
                         context->device_context->mul_mat_vec_bf16_swiglu_wmma16_provider.kind ==
                            ggml_backend_hrx_provider_kind::direct_executable ? "_wmma16x16" :
                        (up->src[1]->ne[1] == 512 &&
                         (up->src[0]->ne[1] % 2) == 0 &&
                         context->device_context->policy.enable_bf16_swiglu_rows2_cols8_prompt &&
                         context->device_context->mul_mat_vec_bf16_swiglu_rows2_cols8_provider.kind ==
                            ggml_backend_hrx_provider_kind::direct_executable ? "_rows2_cols8" :
                        (up->src[1]->ne[1] == 512 &&
                         context->device_context->policy.enable_bf16_swiglu_cols16_prompt &&
                         context->device_context->mul_mat_vec_bf16_swiglu_cols16_provider.kind ==
                            ggml_backend_hrx_provider_kind::direct_executable ? "_cols16" :
                        (up->src[1]->ne[1] == 512 &&
                         context->device_context->policy.enable_bf16_swiglu_cols8_prompt &&
                         context->device_context->mul_mat_vec_bf16_swiglu_cols8_provider.kind ==
                            ggml_backend_hrx_provider_kind::direct_executable ? "_cols8" :
                        (up->src[1]->ne[1] == 512 &&
                         ...
                         context->device_context->mul_mat_vec_bf16_swiglu_cols4_provider.kind ==
                            ggml_backend_hrx_provider_kind::direct_executable ? "_cols4" :
                        (ggml_backend_hrx_select_mul_mat_vec_bf16_workgroup_size(
        ...
        if (node->op == GGML_OP_MUL_MAT &&
            ...
            if (ggml_backend_hrx_try_defer_mul_mat_set_rows_fusion(
        ...
        if (node->op == GGML_OP_MUL_MAT &&
            ...
            const bool use_q8_0_q8_1_x4_mmq128x32 =
                ggml_backend_hrx_supports_mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_prompt(
                    context->device_context, node);
            const bool use_q8_0_rows4_cols4 =
                !use_q8_0_q8_1_x4_mmq128x32 &&
                context->device_context->policy.enable_q8_0_add_rows4_cols4_prompt &&
                node->src[0]->ne[1] % 4 == 0 &&
                node->src[1]->ne[1] == 512 &&
                (node->src[1]->ne[1] % 4) == 0 &&
                context->device_context->mul_mat_vec_q8_0_add_rows4_cols4_provider.kind ==
                    ggml_backend_hrx_provider_kind::direct_executable;
            const bool use_q8_0_cols8 =
                !use_q8_0_q8_1_x4_mmq128x32 &&
                !use_q8_0_rows4_cols4 &&
                context->device_context->policy.enable_q8_0_cols8_prompt &&
                node->src[1]->ne[1] == 512 &&
                (node->src[1]->ne[1] % 8) == 0 &&
                context->device_context->mul_mat_vec_q8_0_add_cols8_provider.kind ==
            ...
            ggml_backend_hrx_trace_provider(
                context->device_context,
                "claim MUL_MAT_ADD provider=pure_hip_q8_0%s k=%" PRId64
                " rows=%" PRId64 " cols=%" PRId64 "\n",
                use_q8_0_q8_1_x4_mmq128x32 ? "_q8_1_x4_mmq128x32_wg256" :
                    (use_q8_0_rows4_cols4 ? "_rows4_cols4" : (use_q8_0_cols8 ? "_cols8" : "")),
                node->src[0]->ne[0], node->src[0]->ne[1], node->src[1]->ne[1]);
            if (ggml_backend_hrx_dispatch_mul_mat_vec_q8_0_add(context, node, add) != GGML_STATUS_SUCCESS) {
                return GGML_STATUS_FAILED;
            }
            i++;
            continue;
        ...
        if (node->op == GGML_OP_MUL_MAT_ID &&
            ...
            if (((gate == first && up == second) || (gate == second && up == first)) &&
                ...
                ggml_backend_hrx_trace_provider(
                    ...
                    ggml_backend_hrx_mul_mat_id_q4_k_swiglu_trace_suffix(
                        context->device_context,
        ...
        if (node->op == GGML_OP_MUL_MAT_ID &&
            ...
            ggml_backend_hrx_trace_provider(
                ...
                " rows=%" PRId64 " ids=%" PRId64 " tokens=%" PRId64 "\n",
                use_q8_1 ? "_q8_1" :
                    ggml_backend_hrx_mul_mat_id_q4_k_mul_trace_suffix(
                        context->device_context,
        ...
        if (node->op == GGML_OP_SSM_CONV &&
            ...
            if (ggml_backend_hrx_dispatch_ssm_conv(context, node, silu, true) != GGML_STATUS_SUCCESS) {
                return GGML_STATUS_FAILED;
            }
            i++;
            continue;
        ...
        if (node->op == GGML_OP_UNARY &&
            ...
            ggml_backend_hrx_trace_provider(
                ...
                ggml_nelements(mul));
            if (ggml_backend_hrx_dispatch_silu_mul_f32(context, node, mul) != GGML_STATUS_SUCCESS) {
                return GGML_STATUS_FAILED;
            }
            i++;
            continue;
        ...
        if (node->op == GGML_OP_ADD &&
            ...
            if (ggml_backend_hrx_dispatch_add_rms_norm_mul_broadcast(context, node, rms_norm, mul) !=
                    GGML_STATUS_SUCCESS) {
                return GGML_STATUS_FAILED;
            }
            i += 2;
        ...
        if (node->op == GGML_OP_ADD &&
            !context->device_context->policy.disable_fusion &&
            !context->device_context->policy.disable_add_softplus_mul_fusion &&
            i + 2 < cgraph->n_nodes &&
            cgraph->nodes[i + 1]->op == GGML_OP_UNARY &&
            cgraph->nodes[i + 2]->op == GGML_OP_MUL) {
            const ggml_tensor * softplus = cgraph->nodes[i + 1];
            const ggml_tensor * mul = cgraph->nodes[i + 2];
            const ggml_tensor * mul_src = nullptr;
            if (ggml_backend_hrx_supports_add_softplus_mul_broadcast(
                    context->device_context, node, softplus, mul, &mul_src) &&
                ggml_can_fuse_subgraph(cgraph, i, { GGML_OP_ADD, GGML_OP_UNARY, GGML_OP_MUL }, { i + 2 })) {
                ggml_backend_hrx_trace_provider(
                    context->device_context,
                    "claim ADD_SOFTPLUS_MUL provider=pure_hip_f32_broadcast n=%" PRId64 "\n",
                    ggml_nelements(mul));
                if (ggml_backend_hrx_dispatch_add_softplus_mul_broadcast_f32(
                        context, node, mul, mul_src) != GGML_STATUS_SUCCESS) {
                    return GGML_STATUS_FAILED;
                }
                i += 2;
                continue;
        ...
        if (node->op == GGML_OP_UNARY &&
            !context->device_context->policy.disable_fusion &&
            context->device_context->policy.enable_sigmoid_mul_add_add_fusion &&
            i + 3 < cgraph->n_nodes &&
            cgraph->nodes[i + 1]->op == GGML_OP_MUL &&
            ...
            if (ggml_backend_hrx_supports_sigmoid_mul_add_add_broadcast(
                    context->device_context, node, mul, first_add, second_add,
                    &mul_src, &add_src0, &add_src1) &&
                ggml_can_fuse_subgraph(
                    cgraph, i, { GGML_OP_UNARY, GGML_OP_MUL, GGML_OP_ADD, GGML_OP_ADD }, { i + 3 })) {
                ggml_backend_hrx_trace_provider(
                    context->device_context,
                    "claim SIGMOID_MUL_ADD_ADD provider=pure_hip_f32_broadcast n=%" PRId64 "\n",
                    ggml_nelements(second_add));
        ...
        if (node->op == GGML_OP_MUL &&
            ...
            if (ggml_backend_hrx_supports_mul_add_add_broadcast(
                ...
                ggml_backend_hrx_trace_provider(
                    context->device_context,
                    "claim MUL_ADD_ADD provider=pure_hip_f32_broadcast n=%" PRId64 "\n",
                    ggml_nelements(second_add));
        ...
        if (node->op == GGML_OP_ADD &&
            ...
            if (ggml_backend_hrx_dispatch_add_add_broadcast_f32(context, node, second) != GGML_STATUS_SUCCESS) {
                return GGML_STATUS_FAILED;
            }
            i++;
            continue;
        ...
        if (node->op == GGML_OP_ROPE &&
            ...
            ggml_check_edges(cgraph, i, GGML_HRX_ROPE_VIEW_SET_ROWS_EDGES) &&
            ...
            if (ggml_backend_hrx_dispatch_rope_set_rows_f32_f16(context, node, set_rows) != GGML_STATUS_SUCCESS) {
                return GGML_STATUS_FAILED;
            }
            i += 2;
            continue;
        ...
        if (node->op == GGML_OP_CONT &&
            ...
            for (int gate_idx = i + 1; gate_idx < cgraph->n_nodes && gate_idx <= i + 8; ++gate_idx) {
                ...
                for (int sigmoid_idx = gate_idx + 1; sigmoid_idx < cgraph->n_nodes && sigmoid_idx <= gate_idx + 8; ++sigmoid_idx) {
                    ...
                    for (int mul_idx = sigmoid_idx + 1; mul_idx < cgraph->n_nodes && mul_idx <= sigmoid_idx + 8; ++mul_idx) {
                        const ggml_tensor * mul = cgraph->nodes[mul_idx];
                        if (!ggml_backend_hrx_supports_sigmoid_mul_strided(
            ...
            if (fused_mul != nullptr) {
                ...
                if (ggml_backend_hrx_dispatch_sigmoid_mul_strided(context, node, fused_gate_cont, fused_mul) !=
                        GGML_STATUS_SUCCESS) {
                    return GGML_STATUS_FAILED;
                }
        ...
        switch (node->op) {
            ...
            case GGML_OP_ADD: {
                ...
                ggml_backend_hrx_trace_provider(
                    ...
                    ggml_backend_hrx_supports_add_broadcast(context->device_context, node) ? "_broadcast" : "",
                    ggml_nelements(node));
                ggml_status status = GGML_STATUS_FAILED;
                if (ggml_backend_hrx_supports_add_broadcast(context->device_context, node)) {
                    status = ggml_backend_hrx_dispatch_add_broadcast_f32(context, node);
                } else {
                    status = ggml_backend_hrx_dispatch_binary_elementwise_f32(
            ...
            case GGML_OP_MUL: {
                ...
                ggml_backend_hrx_trace_provider(
                    ...
                    ggml_backend_hrx_supports_mul_broadcast(context->device_context, node) ? "_broadcast" : "",
                    ggml_nelements(node));
                ggml_status status = GGML_STATUS_FAILED;
                if (ggml_backend_hrx_supports_mul_broadcast(context->device_context, node)) {
                    status = ggml_backend_hrx_dispatch_mul_broadcast_f32(context, node);
                } else {
                    status = ggml_backend_hrx_dispatch_binary_elementwise_f32(
            ...
            case GGML_OP_DIV:
                if (!ggml_backend_hrx_supports_div_broadcast(context->device_context, node)) {
                ...
                ggml_backend_hrx_trace_provider(
                    ...
                    ggml_nelements(node));
                if (ggml_backend_hrx_dispatch_div_broadcast_f32(context, node) != GGML_STATUS_SUCCESS) {
                    return GGML_STATUS_FAILED;
                }
                break;
            case GGML_OP_SCALE:
                ...
                if (!context->device_context->policy.disable_fusion &&
                    ...
                    const ggml_tensor * get_rows = cgraph->nodes[i + 1];
                    ggml_backend_hrx_trace_provider(
                        context->device_context,
                        "claim SCALE_GET_ROWS provider=pure_hip_f32_nr1 node=%s src=%s idx=%s nc=%" PRId64 "\n",
                        ggml_get_name(get_rows),
                        get_rows->src[0] ? ggml_get_name(get_rows->src[0]) : "null",
                        get_rows->src[1] ? ggml_get_name(get_rows->src[1]) : "null",
                        get_rows->src[0]->ne[0]);
                    if (ggml_backend_hrx_dispatch_scale_get_rows_f32_nr1(
                            context, node, get_rows) != GGML_STATUS_SUCCESS) {
                        return GGML_STATUS_FAILED;
                    }
                    i++;
                    break;
                ...
                ggml_backend_hrx_trace_provider(
                    context->device_context,
                    "claim SCALE provider=pure_hip_f32 node=%s src=%s src_op=%s n=%" PRId64 "\n",
                    ggml_get_name(node),
            ...
            case GGML_OP_CPY: {
                ...
                const bool use_f32_f16_copy_provider =
                    ...
                    context->device_context->copy_f32_f16_provider.kind ==
                        ggml_backend_hrx_provider_kind::direct_executable;
                ggml_backend_hrx_trace_copy_like(
                    context->device_context,
                    "CPY",
            ...
            case GGML_OP_SET_ROWS: {
                ...
                for (const ggml_tensor * deferred : deferred_mul_mat_set_rows) {
                    if (ggml_backend_hrx_unwrap_reshape_view_src0(node->src[0]) == deferred &&
                        ggml_backend_hrx_supports_mul_mat_vec_bf16_set_rows_f16(
                        ...
                        if (ggml_backend_hrx_dispatch_mul_mat_vec_bf16_set_rows_f16(context, deferred, node) !=
                                GGML_STATUS_SUCCESS) {
                            return GGML_STATUS_FAILED;
                        }
                        fused = true;
                ...
                ggml_backend_hrx_trace_provider(
                    ...
                    node->src[0]->type == GGML_TYPE_Q5_K ? "q5_K" :
                        (ggml_nelements(node->src[1]) == 1 &&
                         context->device_context->get_rows_f32_nr1_provider.kind ==
                             ggml_backend_hrx_provider_kind::direct_executable ? "f32_nr1" : "f32"),
                    ggml_get_name(node),
                    node->src[0] ? ggml_get_name(node->src[0]) : "null",
            ...
            case GGML_OP_FLASH_ATTN_EXT:
                ...
                if (ggml_backend_hrx_supports_flash_attn_ext_f32_f16_prefill_gfx11_direct(context->device_context, node)) {
                    ggml_backend_hrx_trace_provider(
                        context->device_context,
                ...
                } else if (ggml_backend_hrx_supports_flash_attn_ext_f32_f16_prefill_wmma(context->device_context, node)) {
                    ggml_backend_hrx_trace_provider(
                        context->device_context,
                        ...
                        node->src[0]->ne[0], node->src[1]->ne[1], node->src[0]->ne[1],
                        node->src[0]->ne[2], node->src[1]->ne[2]);
                } else if (ggml_backend_hrx_supports_flash_attn_ext_f32_f16_prefill_tile(context->device_context, node)) {
                    ggml_backend_hrx_trace_provider(
                        context->device_context,
                        "claim FLASH_ATTN_EXT provider=pure_hip_f32_k_f16_v_f16_prefill_tile8 D=%" PRId64
                        " KV=%" PRId64 " N=%" PRId64 " H=%" PRId64 " H_KV=%" PRId64 "\n",
                        node->src[0]->ne[0], node->src[1]->ne[1], node->src[0]->ne[1],
                        node->src[0]->ne[2], node->src[1]->ne[2]);
                } else {
                ...
                if (ggml_backend_hrx_dispatch_flash_attn_ext_f32_f16_decode(context, node) != GGML_STATUS_SUCCESS) {
                    return GGML_STATUS_FAILED;
                }
                break;
            ...
            case GGML_OP_ROPE:
                ...
                break;
            case GGML_OP_UNARY: {
                int next_gdn_idx = i + 1;
                while (next_gdn_idx < cgraph->n_nodes &&
                       (cgraph->nodes[next_gdn_idx]->op == GGML_OP_NONE ||
                        cgraph->nodes[next_gdn_idx]->op == GGML_OP_RESHAPE ||
                        cgraph->nodes[next_gdn_idx]->op == GGML_OP_VIEW ||
                        cgraph->nodes[next_gdn_idx]->op == GGML_OP_PERMUTE ||
                        cgraph->nodes[next_gdn_idx]->op == GGML_OP_TRANSPOSE)) {
                    next_gdn_idx++;
                }
                if (!context->device_context->policy.disable_fusion &&
                    context->device_context->policy.enable_gated_delta_net_beta_sigmoid_fusion &&
                    next_gdn_idx < cgraph->n_nodes &&
                    ggml_backend_hrx_supports_gated_delta_net_beta_sigmoid(
                        context->device_context, node, cgraph->nodes[next_gdn_idx])) {
                    const ggml_tensor * gdn = cgraph->nodes[next_gdn_idx];
                    const ggml_tensor * state_update =
                        ggml_backend_hrx_find_gated_delta_net_state_update(
                            cgraph, next_gdn_idx, context->device_context);
                    const int state_update_idx = state_update ?
                        ggml_backend_hrx_find_node_index(cgraph, state_update, next_gdn_idx + 1, cgraph->n_nodes) :
                        -1;
                    int fusion_idxs[3] = { i, next_gdn_idx, state_update_idx };
                    ggml_op fusion_ops[3] = { GGML_OP_UNARY, GGML_OP_GATED_DELTA_NET, GGML_OP_CPY };
                    int fusion_outputs[2] = { next_gdn_idx, state_update_idx };
                    const int fusion_count = state_update ? 3 : 2;
                    const int fusion_output_count = state_update ? 2 : 1;
                    if ((!state_update || state_update_idx >= 0) &&
                        ...
                        ggml_backend_hrx_trace_provider(
                            context->device_context,
                            "claim SIGMOID_BETA_GATED_DELTA_NET_STATE_UPDATE "
                            "provider=pure_hip_f32_s128_h32_qk16_tok1_nokda n=%" PRId64
                            " dst=%s\n",
                            ggml_nelements(node),
                            ggml_get_name(state_update));
                        if (ggml_backend_hrx_dispatch_gated_delta_net(
                                context, gdn, state_update, true) != GGML_STATUS_SUCCESS) {
                            return GGML_STATUS_FAILED;
                        }
                        ...
                        ggml_backend_hrx_trace_provider(
                            context->device_context,
                            "claim SIGMOID_BETA_GATED_DELTA_NET provider=pure_hip_f32_s128_h32_qk16_tok1_nokda n=%" PRId64
                            "\n",
                            ggml_nelements(node));
                        if (ggml_backend_hrx_dispatch_gated_delta_net(
                                context, gdn, nullptr, true) != GGML_STATUS_SUCCESS) {
                            return GGML_STATUS_FAILED;
                        }
                    } else {
                        ...
                        ggml_backend_hrx_trace_provider(
                            context->device_context, "claim %s provider=pure_hip_f32 node=%s src=%s next=%s n=%" PRId64 "\n",
                            ggml_op_desc(node),
                            ggml_get_name(node),
                            node->src[0] ? ggml_get_name(node->src[0]) : "null",
                            next_gdn_idx < cgraph->n_nodes ? ggml_op_name(cgraph->nodes[next_gdn_idx]->op) : "end",
                            ggml_nelements(node));
                        if (ggml_backend_hrx_dispatch_unary_f32(
            ...
            case GGML_OP_L2_NORM:
            {
                ...
                if (!context->device_context->policy.disable_fusion &&
                    context->device_context->policy.enable_l2_norm_pair_fusion &&
                    next_l2_idx < cgraph->n_nodes &&
                    ...
                    const ggml_tensor * second = cgraph->nodes[next_l2_idx];
                    ggml_backend_hrx_trace_provider(
                        context->device_context,
                        "claim L2_NORM_PAIR provider=pure_hip_f32_wg128 ncols0=%" PRId64
                        " nrows0=%" PRId64 " ncols1=%" PRId64 " nrows1=%" PRId64 "\n",
                        node->src[0]->ne[0], ggml_nrows(node->src[0]),
                        second->src[0]->ne[0], ggml_nrows(second->src[0]));
                    if (ggml_backend_hrx_dispatch_l2_norm_pair_wg128(context, node, second) != GGML_STATUS_SUCCESS) {
                        return GGML_STATUS_FAILED;
                    }
                    i = next_l2_idx;
                    break;
            ...
            case GGML_OP_GATED_DELTA_NET:
                ...
                if (const ggml_tensor * state_update =
                    ...
                    ggml_backend_hrx_trace_provider(
                        ...
                        node->src[2]->ne[0] == 128 &&
                            context->device_context->gated_delta_net_s128_cluster8_provider.kind ==
                                ggml_backend_hrx_provider_kind::direct_executable ? "_s128_cluster8" : "",
                        ...
                        node->src[3]->ne[0],
                        ggml_get_name(state_update));
                    if (ggml_backend_hrx_dispatch_gated_delta_net(context, node, state_update) != GGML_STATUS_SUCCESS) {
                        return GGML_STATUS_FAILED;
                    }
                    fused_gated_delta_net_state_updates.push_back(state_update);
                    break;
            ...
            case GGML_OP_MUL_MAT:
                ...
                ggml_backend_hrx_trace_provider(
                    ...
                    ggml_backend_hrx_mul_mat_vec_trace_suffix(context->device_context, node),
                    node->src[0]->ne[0], node->src[0]->ne[1], node->src[1]->ne[1], node->ne[2]);
                if (ggml_backend_hrx_dispatch_mul_mat_vec_f16(context, node) != GGML_STATUS_SUCCESS) {
                    return GGML_STATUS_FAILED;
                }
                break;
            case GGML_OP_MUL_MAT_ID: {
                ...
                ggml_backend_hrx_trace_provider(
                    ...
                    " rows=%" PRId64 " ids=%" PRId64 " tokens=%" PRId64 "\n",
                    ggml_backend_hrx_supports_mul_mat_id_q4_k_q8_1(context->device_context, node) ? "_q8_1" :
                        ggml_backend_hrx_mul_mat_id_q4_k_trace_suffix(
                            context->device_context, node->src[0]->ne[0], node->src[0]->ne[1],
                            node->src[2]->ne[0], node->src[2]->ne[1]),
                    node->src[0]->ne[0], node->src[0]->ne[1], node->src[2]->ne[0], node->src[2]->ne[1]);
                const ggml_status status =
                    ggml_backend_hrx_supports_mul_mat_id_q4_k_q8_1(context->device_context, node) ?
                    ggml_backend_hrx_dispatch_mul_mat_id_q4_k_q8_1(context, node) :
                    ggml_backend_hrx_dispatch_mul_mat_id_q4_k(context, node);
                if (status != GGML_STATUS_SUCCESS) {
                    return GGML_STATUS_FAILED;
                }
                break;
...
static bool ggml_backend_hrx_device_supports_op(ggml_backend_dev_t dev, const ggml_tensor * op) {
    ...
    switch (op->op) {
        ...
        case GGML_OP_TRANSPOSE:
            ...
            break;
        case GGML_OP_RMS_NORM:
            supported = ggml_backend_hrx_supports_rms_norm(context, op);
            break;
        case GGML_OP_ADD:
            supported = ggml_backend_hrx_supports_add(context, op);
            break;
        case GGML_OP_MUL:
            supported = ggml_backend_hrx_supports_mul(context, op);
            break;
        case GGML_OP_DIV:
            supported = ggml_backend_hrx_supports_div_broadcast(context, op);
            break;
        case GGML_OP_SCALE:
            supported = ggml_backend_hrx_supports_scale(context, op);
            break;
        case GGML_OP_CPY:
            supported = ggml_backend_hrx_supports_cpy(context, op);
            break;
        case GGML_OP_CONT:
            supported = ggml_backend_hrx_supports_cont(op);
            break;
        case GGML_OP_SET_ROWS:
            supported = ggml_backend_hrx_supports_set_rows(context, op);
            break;
        case GGML_OP_GET_ROWS:
            supported = ggml_backend_hrx_supports_get_rows_f32(context, op);
            break;
        case GGML_OP_CONCAT:
            supported = ggml_backend_hrx_supports_concat_f32(context, op);
            break;
        case GGML_OP_SOFT_MAX:
            supported = ggml_backend_hrx_supports_soft_max_f32(context, op);
            break;
        case GGML_OP_FLASH_ATTN_EXT:
            supported = ggml_backend_hrx_supports_flash_attn_ext_f32_decode(context, op);
            break;
        case GGML_OP_ARGSORT:
            supported = ggml_backend_hrx_supports_argsort_f32(context, op);
            break;
        case GGML_OP_ROPE:
            supported = ggml_backend_hrx_supports_rope_f32(context, op);
            break;
        case GGML_OP_UNARY:
            supported = ggml_backend_hrx_supports_unary_f32(context, op);
            break;
        case GGML_OP_GLU:
            supported = ggml_backend_hrx_supports_swiglu_f32(context, op);
            break;
        case GGML_OP_SUM_ROWS:
            supported = ggml_backend_hrx_supports_sum_rows(context, op);
            break;
        case GGML_OP_L2_NORM:
            supported = ggml_backend_hrx_supports_l2_norm(context, op);
            break;
        case GGML_OP_CLAMP:
            supported = ggml_backend_hrx_supports_clamp(context, op);
            break;
        case GGML_OP_SSM_CONV:
            supported = ggml_backend_hrx_supports_ssm_conv(context, op);
            break;
        case GGML_OP_GATED_DELTA_NET:
            supported = ggml_backend_hrx_supports_gated_delta_net(context, op);
            break;
        case GGML_OP_MUL_MAT:
            supported = ggml_backend_hrx_supports_mul_mat_vec(context, op);
            break;
        case GGML_OP_MUL_MAT_ID:
            supported = ggml_backend_hrx_supports_mul_mat_id_q4_k(context, op);
            break;
        default:
            supported = false;
            break;
    ...
    if (context->policy.trace_providers && !supported && op->op != GGML_OP_NONE) {
        if (op->op == GGML_OP_MUL_MAT && context->mul_mat_fallback_trace_count < GGML_HRX_TRACE_MUL_MAT_DETAIL_LIMIT) {
            context->mul_mat_fallback_trace_count++;
            ggml_backend_hrx_trace_provider(
                context,
                "fallback MUL_MAT reason=%s\n",
                ggml_backend_hrx_mul_mat_vec_unsupported_reason(context, op));
            ggml_backend_hrx_trace_tensor(context, "  src0", op->src[0]);
            ggml_backend_hrx_trace_tensor(context, "  src1", op->src[1]);
            ggml_backend_hrx_trace_tensor(context, "  dst", op);
        } else if (op->op == GGML_OP_MUL_MAT_ID &&
                   context->mul_mat_id_fallback_trace_count < GGML_HRX_TRACE_MUL_MAT_DETAIL_LIMIT) {
            context->mul_mat_id_fallback_trace_count++;
            ggml_backend_hrx_trace_provider(context, "fallback MUL_MAT_ID\n");
            ggml_backend_hrx_trace_tensor(context, "  src0", op->src[0]);
            ggml_backend_hrx_trace_tensor(context, "  src1", op->src[1]);
            ...
            context->fallback_trace_count++;
            ggml_backend_hrx_trace_provider(context, "fallback %s\n", ggml_op_desc(op));
            ggml_backend_hrx_trace_tensor(context, "  src0", op->src[0]);
            ggml_backend_hrx_trace_tensor(context, "  src1", op->src[1]);
            ggml_backend_hrx_trace_tensor(context, "  src2", op->src[2]);
            ggml_backend_hrx_trace_tensor(context, "  src3", op->src[3]);
            ggml_backend_hrx_trace_tensor(context, "  src4", op->src[4]);
            ggml_backend_hrx_trace_tensor(context, "  dst", op);
            if (context->fallback_trace_count == GGML_HRX_TRACE_FALLBACK_LIMIT) {
                ggml_backend_hrx_trace_provider(
                    context,
...
static std::unique_ptr<ggml_backend_hrx_reg_context> ggml_backend_hrx_create_reg_context() {
    ...
    for (int i = 0; i < device_count; ++i) {
        ...
        device_context->policy = ggml_backend_hrx_provider_policy_from_env();
        if (device_context->policy.trace_providers) {
            GGML_LOG_INFO(
                "%s: providers kernel=%s rms_norm=%s elementwise=%s mul_mat_vec=%s mul_mat_id=%s\n",
                device_context->name.c_str(),
                ggml_backend_hrx_kernel_provider_mode_name(device_context->policy.kernel_provider),
                device_context->policy.disable_rms_norm ? "disabled" : "enabled",
                device_context->policy.kernel_provider == ggml_backend_hrx_kernel_provider_mode::pure_hip ? "enabled" : "disabled",
                device_context->policy.disable_mul_mat_vec ? "disabled" : "enabled",
                device_context->policy.disable_mul_mat_id ? "disabled" : "enabled");
        }
        if (device_context->policy.kernel_provider == ggml_backend_hrx_kernel_provider_mode::pure_hip &&
            !device_context->policy.disable_rms_norm) {
            (void) ggml_backend_hrx_load_rms_norm_provider(device_context.get());
            (void) ggml_backend_hrx_load_rms_norm_mul_provider(device_context.get());
        ...
        if (device_context->policy.kernel_provider == ggml_backend_hrx_kernel_provider_mode::pure_hip) {
            ...
            (void) ggml_backend_hrx_load_flash_attn_ext_f32_f16_decode_provider(device_context.get());
            (void) ggml_backend_hrx_load_flash_attn_ext_f32_f16_prefill_wmma_provider(device_context.get());
            (void) ggml_backend_hrx_load_flash_attn_ext_f32_f16_prefill_gfx11_direct_provider(device_context.get());
            (void) ggml_backend_hrx_load_flash_attn_ext_f32_f16_prefill_tile_provider(device_context.get());
            (void) ggml_backend_hrx_load_flash_attn_ext_f32_bf16_decode_provider(device_context.get());
            (void) ggml_backend_hrx_load_flash_attn_ext_f32_f32_decode_provider(device_context.get());
            (void) ggml_backend_hrx_load_flash_attn_ext_f32_q4_0_decode_provider(device_context.get());
            (void) ggml_backend_hrx_load_flash_attn_ext_f32_q8_0_decode_provider(device_context.get());
            (void) ggml_backend_hrx_load_flash_attn_ext_f32_q8_0_q4_0_decode_provider(device_context.get());
            ...
            (void) ggml_backend_hrx_load_rms_norm_mul_rope_f32_provider(device_context.get());
            (void) ggml_backend_hrx_load_rms_norm_mul_rope_set_rows_f32_f16_provider(device_context.get());
            (void) ggml_backend_hrx_load_topk_moe_f32_provider(device_context.get());
            (void) ggml_backend_hrx_load_topk_moe_f32_shared4_provider(device_context.get());
            (void) ggml_backend_hrx_load_topk_moe_f32_wave32_provider(device_context.get());
        ...
        if (device_context->policy.kernel_provider == ggml_backend_hrx_kernel_provider_mode::pure_hip &&
            !device_context->policy.disable_mul_mat_vec) {
            (void) ggml_backend_hrx_load_mul_mat_vec_bf16_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_bf16_swiglu_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_bf16_set_rows_f16_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_f16_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_f16_batched_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_f32_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_f32_batched_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_wg128_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_wg64_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_row4_wg64_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_row8_wg64_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_grouped_row4_wg64_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_grouped_row2_route8_wg64_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_grouped_q8_1_x4_mmq64x64_wg64_provider(
                device_context.get());
            (void) ggml_backend_hrx_load_clear_u32_provider(device_context.get());
            (void) ggml_backend_hrx_load_compact_moe_routes_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_q8_1_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_mul_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_mul_wg128_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_mul_wg64_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_mul_packed_wg64_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_mul_rows2_x16_wg32_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_mul_rows2_x16_wg16_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_mul_packed_2row_wg64_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_wg128_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_wg64_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_row2_wg64_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_row4_wg64_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_grouped_row4_wg64_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_grouped_row2_route4_wg64_provider(
                device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_grouped_row2_route8_wg64_provider(
                device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_grouped_q8_1_x4_mmq32x64_wg64_provider(
                device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_packed_wg64_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_swiglu_rows2_x16_wg32_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_id_q4_k_mul_q8_1_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q4_k_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q4_k_wg128_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q4_k_wg64_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q4_k_packed_wg64_provider(device_context.get());
            (void) ggml_backend_hrx_load_quantize_q8_1_provider(device_context.get());
            (void) ggml_backend_hrx_load_quantize_q8_1_x4_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q4_k_q8_1_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q5_k_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q5_k_wg128_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q5_k_wg64_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q5_k_q8_1_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q5_k_q8_1_mmq32x32_wg128_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q5_k_q8_1_x4_mmq32x32_wg128_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q5_k_q8_1_x4_mmql128x128_wg256_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q5_k_q8_1_x4_mmq64x64_wg256_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q6_k_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q6_k_wg128_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q6_k_wg64_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q6_k_rows2_cols1_wg32_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q6_k_rows2_cols8_wg128_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q6_k_q8_1_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q6_k_q8_1_x4_mmql128x64_wg256_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q6_k_q8_1_x4_mmq32x32_wg128_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q8_0_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q8_0_cols8_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q8_0_q8_1_x4_mmq128x32_wg256_provider(
                device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q8_0_add_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q8_0_add_cols8_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q8_0_add_rows4_cols4_provider(device_context.get());
            (void) ggml_backend_hrx_load_mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_wg256_provider(
                device_context.get());
        }
