...
struct hrx_block_q8_1_id {
    unsigned short d;
    unsigned short s;
    int8_t qs[32];
};

struct hrx_mul_mat_id_q4_k_q8_1_constants {
    long long k;
    long long rows;
    long long n_ids;
    long long n_tokens;
...
extern "C" __global__ void hrx_mul_mat_id_q4_k_q8_1_f32(
        const hrx_block_q4_K_id * src0, const hrx_block_q8_1_id * src1, const int * ids, float * dst,
        hrx_mul_mat_id_q4_k_q8_1_constants c) {
    ...
    const hrx_block_q8_1_id * src1_col = src1 + src1_col_idx * (c.k / 32);
    float sum = 0.0f;
    ...
    for (long long block_idx = block_slot; block_idx < blocks_per_row; block_idx += 4) {
        ...
        const hrx_block_q8_1_id * rhs = src1_col + block_idx * 8 + group;
