...
extern "C" __global__ void hrx_mul_mat_id_q4_k_mul_wg128_f32(
        const hrx_block_q4_K_id_mul * src0,
        const float * src1,
        const int * ids,
        const float * scale,
...
extern "C" __global__ void hrx_mul_mat_id_q4_k_mul_rows2_x16_wg16_f32(
        const hrx_block_q4_K_id_mul * src0,
        const float * src1,
        const int * ids,
        const float * scale,
...
extern "C" __global__ void hrx_mul_mat_id_q4_k_mul_packed_2row_wg64_f32(
        const hrx_block_q4_K_id_mul * src0,
        const float * src1,
        const int * ids,
        const float * scale,
