...
extern "C" __global__ void hrx_mul_mat_id_q4_k_swiglu_wg128_f32(
        const hrx_block_q4_K_id_swiglu * gate,
        const hrx_block_q4_K_id_swiglu * up,
        const float * src1,
        const int * ids,
...
extern "C" __global__ void hrx_mul_mat_id_q4_k_swiglu_grouped_row4_wg64_f32(
        const hrx_block_q4_K_id_swiglu * gate,
        const hrx_block_q4_K_id_swiglu * up,
        const float * src1,
...
extern "C" __global__ void hrx_mul_mat_id_q4_k_swiglu_rows2_x16_wg32_f32(
        const hrx_block_q4_K_id_swiglu * gate,
        const hrx_block_q4_K_id_swiglu * up,
        const float * src1,
        const int * ids,
