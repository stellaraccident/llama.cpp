...
static __device__ __forceinline__ float pyre_reduce_256_bf16_swiglu(float sum, float * shared) {
...
extern "C" __global__ void pyre_mul_mat_vec_bf16_swiglu_f32(
    ...
    gate_sum = pyre_reduce_256_bf16_swiglu(gate_sum, gate_sumsh);
    up_sum = pyre_reduce_256_bf16_swiglu(up_sum, up_sumsh);
