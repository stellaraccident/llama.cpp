...
KERNELS = [
    ...
    {
        "name": "pyre_mul_mat_vec_bf16_rows2_cols1_f32",
        "source": "mul_mat_vec_bf16.hip.cpp",
        "format": "FPIH",
        "binding_count": 3,
        "constants_size": 24,
    ...
    {
        "name": "pyre_mul_mat_vec_bf16_rows2_cols1_wg32_f32",
        "source": "mul_mat_vec_bf16.hip.cpp",
        "format": "FPIH",
        "binding_count": 3,
        "constants_size": 24,
    ...
    {
        "name": "pyre_mul_mat_vec_bf16_rows4_k512_cols1_lds_wg256_f32",
        "source": "mul_mat_vec_bf16.hip.cpp",
        "format": "FPIH",
        "binding_count": 3,
        "constants_size": 24,
    ...
    {
        "name": "pyre_mul_mat_vec_bf16_rows4_k2048_cols1_lds_wg256_f32",
        "source": "mul_mat_vec_bf16.hip.cpp",
        "format": "FPIH",
        "binding_count": 3,
        "constants_size": 24,
    ...
    {
        "name": "pyre_mul_mat_vec_bf16_swiglu_rows2_cols1_f32",
        "source": "mul_mat_vec_bf16_swiglu.hip.cpp",
        "format": "FPIH",
        "binding_count": 4,
        "constants_size": 24,
    ...
    {
        "name": "pyre_mul_mat_vec_bf16_swiglu_rows4_k2048_cols1_lds_wg256_f32",
        "source": "mul_mat_vec_bf16_swiglu.hip.cpp",
        "format": "FPIH",
        "binding_count": 4,
        "constants_size": 24,
    ...
    {
        "name": "pyre_mul_mat_id_q4_k_mul_rows2_x16_wg32_f32",
        "source": "mul_mat_id_q4_k_mul.hip.cpp",
        "format": "FPIH",
        "binding_count": 5,
        "constants_size": 112,
    ...
    {
        "name": "pyre_mul_mat_id_q4_k_mul_rows2_x16_wg16_f32",
        "source": "mul_mat_id_q4_k_mul.hip.cpp",
        "format": "FPIH",
        "binding_count": 5,
        "constants_size": 112,
    ...
    {
        "name": "pyre_mul_mat_id_q4_k_swiglu_rows2_x16_wg32_f32",
        "source": "mul_mat_id_q4_k_swiglu.hip.cpp",
        "format": "FPIH",
        "binding_count": 5,
        "constants_size": 120,
