...
KERNELS = [
    ...
    {
        "name": "pyre_rms_norm_mul_wg128_f32",
        "source": "rms_norm_mul_f32.hip.cpp",
        "format": "FPIH",
        "binding_count": 3,
        "constants_size": 144,
    ...
    {
        "name": "pyre_mul_add_add_f32_broadcast",
    ...
    {
        "name": "pyre_flash_attn_ext_f32_f16_prefill_gfx11_direct",
    ...
    {
        "name": "pyre_topk_moe_f32_shared4",
        "source": "topk_moe_f32_shared.hip.cpp",
        "format": "FPIH",
        "binding_count": 3,
        "constants_size": 80,
    ...
    {
        "name": "pyre_gated_delta_net_s128_cluster8_nokda_f32",
        "source": "gated_delta_net_f32.hip.cpp",
        "format": "FPIH",
        "binding_count": 8,
        "constants_size": 208,
    ...
    {
        "name": "pyre_mul_mat_vec_f16_batched_cols16_f32",
        "source": "mul_mat_vec_f16_batched.hip.cpp",
        "format": "FPIH",
        "binding_count": 3,
        "constants_size": 128,
    ...
    {
        "name": "pyre_mul_mat_vec_bf16_cols8_f32",
        "source": "mul_mat_vec_bf16.hip.cpp",
        "format": "FPIH",
        "binding_count": 3,
        "constants_size": 24,
    ...
    {
        "name": "pyre_mul_mat_vec_bf16_cols16_f32",
        "source": "mul_mat_vec_bf16.hip.cpp",
        "format": "FPIH",
        "binding_count": 3,
        "constants_size": 24,
    ...
    {
        "name": "pyre_mul_mat_vec_bf16_cols32_f32",
        "source": "mul_mat_vec_bf16.hip.cpp",
        "format": "FPIH",
        "binding_count": 3,
        "constants_size": 24,
    ...
    {
        "name": "pyre_mul_mat_vec_bf16_rows2_cols16_f32",
        "source": "mul_mat_vec_bf16.hip.cpp",
        "format": "FPIH",
        "binding_count": 3,
        "constants_size": 24,
    ...
    {
        "name": "pyre_mul_mat_vec_bf16_swiglu_wmma16x16_f32",
        "source": "mul_mat_vec_bf16_swiglu.hip.cpp",
        "format": "FPIH",
        "binding_count": 4,
        "constants_size": 24,
    ...
    {
        "name": "pyre_mul_mat_vec_bf16_swiglu_cols8_f32",
        "source": "mul_mat_vec_bf16_swiglu.hip.cpp",
        "format": "FPIH",
        "binding_count": 4,
        "constants_size": 24,
    ...
    {
        "name": "pyre_mul_mat_vec_bf16_swiglu_cols16_f32",
        "source": "mul_mat_vec_bf16_swiglu.hip.cpp",
        "format": "FPIH",
        "binding_count": 4,
        "constants_size": 24,
    ...
    {
        "name": "pyre_mul_mat_vec_bf16_swiglu_rows2_cols8_f32",
        "source": "mul_mat_vec_bf16_swiglu.hip.cpp",
        "format": "FPIH",
        "binding_count": 4,
        "constants_size": 24,
    ...
    {
        "name": "pyre_mul_mat_vec_f32_batched_cols16_f32",
        "source": "mul_mat_vec_f32_batched.hip.cpp",
        "format": "FPIH",
        "binding_count": 3,
        "constants_size": 128,
    ...
    {
        "name": "pyre_mul_mat_vec_f32_batched_rows2_cols8_f32",
        "source": "mul_mat_vec_f32_batched.hip.cpp",
        "format": "FPIH",
        "binding_count": 3,
        "constants_size": 128,
    ...
    {
        "name": "pyre_mul_mat_vec_q5_k_q8_1_x4_mmql128x128_wg256_f32",
        "source": "mul_mat_vec_q5_k_q8_1.hip.cpp",
        "format": "FPIH",
        "binding_count": 3,
        "constants_size": 24,
    ...
    {
        "name": "pyre_mul_mat_vec_q6_k_q8_1_x4_mmql128x64_wg256_f32",
        "source": "mul_mat_vec_q6_k_q8_1.hip.cpp",
        "format": "FPIH",
        "binding_count": 3,
        "constants_size": 24,
    ...
    {
        "name": "pyre_mul_mat_vec_q8_0_cols8_f32",
        "source": "mul_mat_vec_q8_0.hip.cpp",
        "format": "FPIH",
        "binding_count": 3,
        "constants_size": 24,
    ...
    {
        "name": "pyre_mul_mat_vec_q8_0_add_cols8_f32",
        "source": "mul_mat_vec_q8_0.hip.cpp",
        "format": "FPIH",
        "binding_count": 4,
        "constants_size": 24,
    ...
    {
        "name": "pyre_mul_mat_vec_q8_0_add_rows4_cols4_f32",
        "source": "mul_mat_vec_q8_0.hip.cpp",
        "format": "FPIH",
        "binding_count": 4,
        "constants_size": 24,
    ...
    {
        "name": "pyre_mul_mat_vec_q8_0_q8_1_x4_mmq128x32_wg256_f32",
        "source": "mul_mat_vec_q8_0.hip.cpp",
        "format": "FPIH",
        "binding_count": 3,
        "constants_size": 24,
    ...
    {
        "name": "pyre_mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_wg256_f32",
        "source": "mul_mat_vec_q8_0.hip.cpp",
        "format": "FPIH",
        "binding_count": 4,
        "constants_size": 24,
...
def main():
    ...
    parser.add_argument("--hsaco-dir", default="")
    ...
    if not args.hsaco_dir:
        write_catalog(output, [], "Pyre pure-HIP kernel catalog disabled: no hsaco directory configured.")
        return 0
    if not args.arch:
        write_catalog(output, [], "Pyre pure-HIP kernel catalog disabled: no AMDGPU architecture configured.")
        return 0

    hsaco_dir = pathlib.Path(args.hsaco_dir)
    hsaco_cache = {}
    entries = []
    for kernel in KERNELS:
        source = kernel["source"]
        if source not in hsaco_cache:
            hsaco = hsaco_dir / hsaco_name_for_source(source)
            if not hsaco.exists():
                sys.stderr.write(f"error: expected compiled Pyre kernel object not found: {hsaco}\n")
                return 1
            hsaco_cache[source] = {
                "symbol": f"k_pyre_kernel_{len(hsaco_cache)}",
                "data": hsaco.read_bytes(),
            }

        entry = dict(kernel)
        entry["data_symbol"] = hsaco_cache[source]["symbol"]
        entry["data"] = hsaco_cache[source]["data"]
