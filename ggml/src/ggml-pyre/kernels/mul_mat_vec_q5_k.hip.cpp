...
static __device__ __forceinline__ void pyre_q5_k_dot4_cols8(
        const pyre_block_q5_K * block,
        const float * src0,
        const float * src1,
        const float * src2,
    ...
    for (int j = 0; j < 4; ++j) {
        ...
        sum2 += q * src2[rhs_offset];
        sum3 += q * src3[rhs_offset];
        sum4 += q * src4[rhs_offset];
        sum5 += q * src5[rhs_offset];
        sum6 += q * src6[rhs_offset];
        sum7 += q * src7[rhs_offset];
    }
}
...
extern "C" __global__ void pyre_mul_mat_vec_q5_k_cols8_wg128_f32(
        const pyre_block_q5_K * src0, const float * src1, float * dst,
        long long k, long long rows, long long cols) {
    const long long row = __builtin_amdgcn_workgroup_id_x();
    ...
    for (long long block_idx = block_slot; block_idx < blocks_per_row; block_idx += 8) {
        ...
        pyre_q5_k_dot4_cols8(
            block, src1_col0 + src_base, src1_col1 + src_base,
            src1_col2 + src_base, src1_col3 + src_base,
            src1_col4 + src_base, src1_col5 + src_base,
            src1_col6 + src_base, src1_col7 + src_base, group0, lane,
            qs0, qh, false, sum0, sum1, sum2, sum3, sum4, sum5, sum6, sum7);
        pyre_q5_k_dot4_cols8(
            block, src1_col0 + src_base, src1_col1 + src_base,
            src1_col2 + src_base, src1_col3 + src_base,
            src1_col4 + src_base, src1_col5 + src_base,
            src1_col6 + src_base, src1_col7 + src_base, group0 + 1, lane,
            qs0, qh, true, sum0, sum1, sum2, sum3, sum4, sum5, sum6, sum7);
        pyre_q5_k_dot4_cols8(
            block, src1_col0 + src_base, src1_col1 + src_base,
            src1_col2 + src_base, src1_col3 + src_base,
            src1_col4 + src_base, src1_col5 + src_base,
            src1_col6 + src_base, src1_col7 + src_base, group4, lane,
            qs4, qh, false, sum0, sum1, sum2, sum3, sum4, sum5, sum6, sum7);
        pyre_q5_k_dot4_cols8(
            block, src1_col0 + src_base, src1_col1 + src_base,
            src1_col2 + src_base, src1_col3 + src_base,
            src1_col4 + src_base, src1_col5 + src_base,
            src1_col6 + src_base, src1_col7 + src_base, group4 + 1, lane,
