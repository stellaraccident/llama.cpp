...
extern "C" __global__ void pyre_set_rows_f32_q8_0(
        const float * src0, const long long * idxs, pyre_block_q8_0 * dst,
    ...
    pyre_block_q8_0 * block = reinterpret_cast<pyre_block_q8_0 *>(
        reinterpret_cast<char *>(dst) + ib0 * static_cast<long long>(sizeof(pyre_block_q8_0)) +
