...
struct pyre_soft_max_f32_constants {
    long long ncols;
    long long nrows;
    long long ne01;
    long long ne02;
...
extern "C" __global__ void pyre_soft_max_f32(
        const float * src, float * dst,
        pyre_soft_max_f32_constants c) {
    pyre_soft_max_f32_row(src, nullptr, dst, c);
}

extern "C" __global__ void pyre_soft_max_f32_mask(
        const float * src, const float * mask, float * dst,
        pyre_soft_max_f32_constants c) {
    pyre_soft_max_f32_row(src, mask, dst, c);
}
