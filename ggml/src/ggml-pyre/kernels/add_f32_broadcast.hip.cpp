...
struct pyre_add_f32_broadcast_constants {
    long long ne0;
    long long nrows;
    long long ne1;
    long long ne2;
...
extern "C" __global__ void pyre_add_f32_broadcast(
        const float * src0, const float * src1, float * dst,
        pyre_add_f32_broadcast_constants c) {
    ...
    const char * src0_row = reinterpret_cast<const char *>(src0) + i1 * c.src0_nb1 + i2 * c.src0_nb2 + i3 * c.src0_nb3;
