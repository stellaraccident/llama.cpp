...
struct pyre_get_rows_q5_k_constants {
    long long nc;
    long long nr;
    long long src0_nb1;
    long long src0_nb2;
...
extern "C" __global__ void pyre_get_rows_q5_k_f32(
        const pyre_block_q5_K * src0, const int * idx, float * dst,
        pyre_get_rows_q5_k_constants c) {
    ...
    const pyre_block_q5_K * block = reinterpret_cast<const pyre_block_q5_K *>(src_row) + block_idx;
