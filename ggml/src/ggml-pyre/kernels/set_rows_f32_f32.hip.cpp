...
extern "C" __global__ void pyre_set_rows_f32_f32(
        const float * src0, const long long * idxs, float * dst,
    ...
    *reinterpret_cast<float *>(
        reinterpret_cast<char *>(dst) + i0 * sizeof(float) + row * c.dst_nb1 + i2 * c.dst_nb2 + i3 * c.dst_nb3) = value;
}
