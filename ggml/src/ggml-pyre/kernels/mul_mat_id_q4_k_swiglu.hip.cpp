...
struct pyre_mul_mat_id_q4_k_swiglu_grouped_constants {
    long long k;
    long long rows;
    long long n_ids;
    long long n_tokens;
...
template <int I>
static __device__ __forceinline__ float pyre_q4_k_swiglu_q_from_pack(unsigned long long pack, bool high) {
...
template <int WG_SIZE>
static __device__ __forceinline__ void pyre_reduce_wg4_swiglu(
        float & sum0,
        float & sum1,
        float & sum2,
        float & sum3,
...
extern "C" __global__ void pyre_mul_mat_id_q4_k_swiglu_row4_wg64_f32(
        const pyre_block_q4_K_id_swiglu * gate,
        const pyre_block_q4_K_id_swiglu * up,
        const float * src1,
        const int * ids,
    ...
    for (long long block_idx = 0; block_idx < blocks_per_row; ++block_idx) {
        ...
        const pyre_block_q4_K_id_swiglu * gate_block1 = reinterpret_cast<const pyre_block_q4_K_id_swiglu *>(
            gate_row1_base + block_idx * sizeof(pyre_block_q4_K_id_swiglu));
        const pyre_block_q4_K_id_swiglu * gate_block2 = reinterpret_cast<const pyre_block_q4_K_id_swiglu *>(
            gate_row2_base + block_idx * sizeof(pyre_block_q4_K_id_swiglu));
        const pyre_block_q4_K_id_swiglu * gate_block3 = reinterpret_cast<const pyre_block_q4_K_id_swiglu *>(
            gate_row3_base + block_idx * sizeof(pyre_block_q4_K_id_swiglu));
        const pyre_block_q4_K_id_swiglu * up_block0 = reinterpret_cast<const pyre_block_q4_K_id_swiglu *>(
            up_row0_base + block_idx * sizeof(pyre_block_q4_K_id_swiglu));
        const pyre_block_q4_K_id_swiglu * up_block1 = reinterpret_cast<const pyre_block_q4_K_id_swiglu *>(
            up_row1_base + block_idx * sizeof(pyre_block_q4_K_id_swiglu));
        const pyre_block_q4_K_id_swiglu * up_block2 = reinterpret_cast<const pyre_block_q4_K_id_swiglu *>(
            up_row2_base + block_idx * sizeof(pyre_block_q4_K_id_swiglu));
        const pyre_block_q4_K_id_swiglu * up_block3 = reinterpret_cast<const pyre_block_q4_K_id_swiglu *>(
            up_row3_base + block_idx * sizeof(pyre_block_q4_K_id_swiglu));
        ...
        pyre_get_scale_min_k4_id_swiglu(group, gate_block0->scales, &gate_sc0, &gate_m0);
        pyre_get_scale_min_k4_id_swiglu(group, gate_block1->scales, &gate_sc1, &gate_m1);
        pyre_get_scale_min_k4_id_swiglu(group, gate_block2->scales, &gate_sc2, &gate_m2);
        pyre_get_scale_min_k4_id_swiglu(group, gate_block3->scales, &gate_sc3, &gate_m3);
        pyre_get_scale_min_k4_id_swiglu(group, up_block0->scales, &up_sc0, &up_m0);
        pyre_get_scale_min_k4_id_swiglu(group, up_block1->scales, &up_sc1, &up_m1);
        pyre_get_scale_min_k4_id_swiglu(group, up_block2->scales, &up_sc2, &up_m2);
        pyre_get_scale_min_k4_id_swiglu(group, up_block3->scales, &up_sc3, &up_m3);
        ...
        for (int j = 0; j < 4; ++j) {
            const float b = *reinterpret_cast<const float *>(src1_col + (src_base + j) * sizeof(float));
#define PYRE_Q4K_SWIGLU_ROW4_ACC(N) \
            do { \
            ...
            PYRE_Q4K_SWIGLU_ROW4_ACC(0);
            PYRE_Q4K_SWIGLU_ROW4_ACC(1);
            PYRE_Q4K_SWIGLU_ROW4_ACC(2);
            PYRE_Q4K_SWIGLU_ROW4_ACC(3);
#undef PYRE_Q4K_SWIGLU_ROW4_ACC
        }
    }

    gate_sum0 = pyre_reduce_wg_swiglu<64>(gate_sum0, gate_sumsh0);
    up_sum0 = pyre_reduce_wg_swiglu<64>(up_sum0, up_sumsh0);
    gate_sum1 = pyre_reduce_wg_swiglu<64>(gate_sum1, gate_sumsh1);
    up_sum1 = pyre_reduce_wg_swiglu<64>(up_sum1, up_sumsh1);
    gate_sum2 = pyre_reduce_wg_swiglu<64>(gate_sum2, gate_sumsh2);
    up_sum2 = pyre_reduce_wg_swiglu<64>(up_sum2, up_sumsh2);
    gate_sum3 = pyre_reduce_wg_swiglu<64>(gate_sum3, gate_sumsh3);
    up_sum3 = pyre_reduce_wg_swiglu<64>(up_sum3, up_sumsh3);
...
extern "C" __global__ void pyre_mul_mat_id_q4_k_swiglu_grouped_row4_wg64_f32(
        const pyre_block_q4_K_id_swiglu * gate,
        const pyre_block_q4_K_id_swiglu * up,
        const float * src1,
...
#define PYRE_Q4K_SWIGLU_GROUPED_ROW4_ACC(N) \
                do { \
                    const uint8_t gate_packed = gate_block##N->qs[qs_base + j]; \
                    const uint8_t up_packed = up_block##N->qs[qs_base + j]; \
                    const float gate_q = (group & 1) ? static_cast<float>(gate_packed >> 4) : static_cast<float>(gate_packed & 0x0F); \
                ...
                PYRE_Q4K_SWIGLU_GROUPED_ROW4_ACC(0);
                PYRE_Q4K_SWIGLU_GROUPED_ROW4_ACC(1);
                PYRE_Q4K_SWIGLU_GROUPED_ROW4_ACC(2);
                PYRE_Q4K_SWIGLU_GROUPED_ROW4_ACC(3);
#undef PYRE_Q4K_SWIGLU_GROUPED_ROW4_ACC
            }
        }

        gate_sum0a = pyre_reduce_wg_swiglu<64>(gate_sum0a, gate_sumsh0);
        up_sum0a = pyre_reduce_wg_swiglu<64>(up_sum0a, up_sumsh0);
        gate_sum1a = pyre_reduce_wg_swiglu<64>(gate_sum1a, gate_sumsh1);
        up_sum1a = pyre_reduce_wg_swiglu<64>(up_sum1a, up_sumsh1);
        gate_sum2a = pyre_reduce_wg_swiglu<64>(gate_sum2a, gate_sumsh2);
        up_sum2a = pyre_reduce_wg_swiglu<64>(up_sum2a, up_sumsh2);
        gate_sum3a = pyre_reduce_wg_swiglu<64>(gate_sum3a, gate_sumsh3);
        up_sum3a = pyre_reduce_wg_swiglu<64>(up_sum3a, up_sumsh3);
        ...
        if (has_route1) {
            gate_sum0b = pyre_reduce_wg_swiglu<64>(gate_sum0b, gate_sumsh0);
            up_sum0b = pyre_reduce_wg_swiglu<64>(up_sum0b, up_sumsh0);
            gate_sum1b = pyre_reduce_wg_swiglu<64>(gate_sum1b, gate_sumsh1);
            up_sum1b = pyre_reduce_wg_swiglu<64>(up_sum1b, up_sumsh1);
            gate_sum2b = pyre_reduce_wg_swiglu<64>(gate_sum2b, gate_sumsh2);
            up_sum2b = pyre_reduce_wg_swiglu<64>(up_sum2b, up_sumsh2);
            gate_sum3b = pyre_reduce_wg_swiglu<64>(gate_sum3b, gate_sumsh3);
            up_sum3b = pyre_reduce_wg_swiglu<64>(up_sum3b, up_sumsh3);
...
extern "C" __global__ void pyre_mul_mat_id_q4_k_swiglu_grouped_row2_route4_wg64_f32(
        const pyre_block_q4_K_id_swiglu * gate,
        const pyre_block_q4_K_id_swiglu * up,
        const float * src1,
        const uint32_t * counts,
...
#define PYRE_Q4K_SWIGLU_GROUPED_ROW2_ROUTE4_ACC(N) \
                do { \
                    const uint8_t gate_packed = gate_block##N->qs[qs_base + j]; \
                    const uint8_t up_packed = up_block##N->qs[qs_base + j]; \
                    const float gate_q = (group & 1) ? static_cast<float>(gate_packed >> 4) : static_cast<float>(gate_packed & 0x0F); \
                ...
                PYRE_Q4K_SWIGLU_GROUPED_ROW2_ROUTE4_ACC(0);
                PYRE_Q4K_SWIGLU_GROUPED_ROW2_ROUTE4_ACC(1);
#undef PYRE_Q4K_SWIGLU_GROUPED_ROW2_ROUTE4_ACC
            }
        }

#define PYRE_Q4K_SWIGLU_GROUPED_ROW2_ROUTE4_STORE(S, ID, TOK) \
        do { \
        ...
        PYRE_Q4K_SWIGLU_GROUPED_ROW2_ROUTE4_STORE(a, id_a, tok_a);
        if (has_b) {
            PYRE_Q4K_SWIGLU_GROUPED_ROW2_ROUTE4_STORE(b, id_b, tok_b);
        }
        if (has_c) {
            PYRE_Q4K_SWIGLU_GROUPED_ROW2_ROUTE4_STORE(c, id_c, tok_c);
        }
        if (has_d) {
            PYRE_Q4K_SWIGLU_GROUPED_ROW2_ROUTE4_STORE(d, id_d, tok_d);
        }
#undef PYRE_Q4K_SWIGLU_GROUPED_ROW2_ROUTE4_STORE
    }
}

extern "C" __global__ void pyre_mul_mat_id_q4_k_swiglu_grouped_row2_route8_wg64_f32(
        const pyre_block_q4_K_id_swiglu * gate,
        const pyre_block_q4_K_id_swiglu * up,
        const float * src1,
        const uint32_t * counts,
...
#define PYRE_Q4K_SWIGLU_ROW2_ROUTE8_COL(S) \
        ...
        PYRE_Q4K_SWIGLU_ROW2_ROUTE8_COL(c);
        PYRE_Q4K_SWIGLU_ROW2_ROUTE8_COL(d);
        PYRE_Q4K_SWIGLU_ROW2_ROUTE8_COL(e);
        PYRE_Q4K_SWIGLU_ROW2_ROUTE8_COL(f);
        PYRE_Q4K_SWIGLU_ROW2_ROUTE8_COL(g);
        PYRE_Q4K_SWIGLU_ROW2_ROUTE8_COL(h);
#undef PYRE_Q4K_SWIGLU_ROW2_ROUTE8_COL
...
#define PYRE_Q4K_SWIGLU_ROW2_ROUTE8_STORE(S, ID, TOK) \
        ...
        if (has_c) { PYRE_Q4K_SWIGLU_ROW2_ROUTE8_STORE(c, id_c, tok_c); }
        if (has_d) { PYRE_Q4K_SWIGLU_ROW2_ROUTE8_STORE(d, id_d, tok_d); }
        if (has_e) { PYRE_Q4K_SWIGLU_ROW2_ROUTE8_STORE(e, id_e, tok_e); }
        if (has_f) { PYRE_Q4K_SWIGLU_ROW2_ROUTE8_STORE(f, id_f, tok_f); }
...
extern "C" __global__ void pyre_mul_mat_id_q4_k_swiglu_packed_wg64_f32(
    ...
    for (int block_iter = 0; block_iter < 2; ++block_iter) {
        ...
        gate_sum += (gate_d0 * pyre_q4_k_swiglu_q_from_pack<0>(gate_q01, false) - gate_min0) * y0.x;
        gate_sum += (gate_d0 * pyre_q4_k_swiglu_q_from_pack<1>(gate_q01, false) - gate_min0) * y0.y;
        gate_sum += (gate_d0 * pyre_q4_k_swiglu_q_from_pack<2>(gate_q01, false) - gate_min0) * y0.z;
        gate_sum += (gate_d0 * pyre_q4_k_swiglu_q_from_pack<3>(gate_q01, false) - gate_min0) * y0.w;
        gate_sum += (gate_d1 * pyre_q4_k_swiglu_q_from_pack<0>(gate_q01, true) - gate_min1) * y1.x;
        gate_sum += (gate_d1 * pyre_q4_k_swiglu_q_from_pack<1>(gate_q01, true) - gate_min1) * y1.y;
        gate_sum += (gate_d1 * pyre_q4_k_swiglu_q_from_pack<2>(gate_q01, true) - gate_min1) * y1.z;
        gate_sum += (gate_d1 * pyre_q4_k_swiglu_q_from_pack<3>(gate_q01, true) - gate_min1) * y1.w;
        gate_sum += (gate_d2 * pyre_q4_k_swiglu_q_from_pack<0>(gate_q23, false) - gate_min2) * y2.x;
        gate_sum += (gate_d2 * pyre_q4_k_swiglu_q_from_pack<1>(gate_q23, false) - gate_min2) * y2.y;
        gate_sum += (gate_d2 * pyre_q4_k_swiglu_q_from_pack<2>(gate_q23, false) - gate_min2) * y2.z;
        gate_sum += (gate_d2 * pyre_q4_k_swiglu_q_from_pack<3>(gate_q23, false) - gate_min2) * y2.w;
        gate_sum += (gate_d3 * pyre_q4_k_swiglu_q_from_pack<0>(gate_q23, true) - gate_min3) * y3.x;
        gate_sum += (gate_d3 * pyre_q4_k_swiglu_q_from_pack<1>(gate_q23, true) - gate_min3) * y3.y;
        gate_sum += (gate_d3 * pyre_q4_k_swiglu_q_from_pack<2>(gate_q23, true) - gate_min3) * y3.z;
        gate_sum += (gate_d3 * pyre_q4_k_swiglu_q_from_pack<3>(gate_q23, true) - gate_min3) * y3.w;

        up_sum += (up_d0 * pyre_q4_k_swiglu_q_from_pack<0>(up_q01, false) - up_min0) * y0.x;
        up_sum += (up_d0 * pyre_q4_k_swiglu_q_from_pack<1>(up_q01, false) - up_min0) * y0.y;
        up_sum += (up_d0 * pyre_q4_k_swiglu_q_from_pack<2>(up_q01, false) - up_min0) * y0.z;
        up_sum += (up_d0 * pyre_q4_k_swiglu_q_from_pack<3>(up_q01, false) - up_min0) * y0.w;
        up_sum += (up_d1 * pyre_q4_k_swiglu_q_from_pack<0>(up_q01, true) - up_min1) * y1.x;
        up_sum += (up_d1 * pyre_q4_k_swiglu_q_from_pack<1>(up_q01, true) - up_min1) * y1.y;
        up_sum += (up_d1 * pyre_q4_k_swiglu_q_from_pack<2>(up_q01, true) - up_min1) * y1.z;
        up_sum += (up_d1 * pyre_q4_k_swiglu_q_from_pack<3>(up_q01, true) - up_min1) * y1.w;
        up_sum += (up_d2 * pyre_q4_k_swiglu_q_from_pack<0>(up_q23, false) - up_min2) * y2.x;
        up_sum += (up_d2 * pyre_q4_k_swiglu_q_from_pack<1>(up_q23, false) - up_min2) * y2.y;
        up_sum += (up_d2 * pyre_q4_k_swiglu_q_from_pack<2>(up_q23, false) - up_min2) * y2.z;
        up_sum += (up_d2 * pyre_q4_k_swiglu_q_from_pack<3>(up_q23, false) - up_min2) * y2.w;
        up_sum += (up_d3 * pyre_q4_k_swiglu_q_from_pack<0>(up_q23, true) - up_min3) * y3.x;
        up_sum += (up_d3 * pyre_q4_k_swiglu_q_from_pack<1>(up_q23, true) - up_min3) * y3.y;
        up_sum += (up_d3 * pyre_q4_k_swiglu_q_from_pack<2>(up_q23, true) - up_min3) * y3.z;
        up_sum += (up_d3 * pyre_q4_k_swiglu_q_from_pack<3>(up_q23, true) - up_min3) * y3.w;
    }
...
extern "C" __global__ void pyre_mul_mat_id_q4_k_swiglu_rows2_x16_wg32_f32(
        const pyre_block_q4_K_id_swiglu * gate,
        const pyre_block_q4_K_id_swiglu * up,
        const float * src1,
        const int * ids,
    ...
    for (int iter = 0; iter < 16; ++iter) {
        ...
        gate_sum += (gate_d * pyre_q4_k_swiglu_q_from_pack<0>(gate_qpack, high) - gate_min) * b0.x;
        gate_sum += (gate_d * pyre_q4_k_swiglu_q_from_pack<1>(gate_qpack, high) - gate_min) * b0.y;
        gate_sum += (gate_d * pyre_q4_k_swiglu_q_from_pack<2>(gate_qpack, high) - gate_min) * b0.z;
        gate_sum += (gate_d * pyre_q4_k_swiglu_q_from_pack<3>(gate_qpack, high) - gate_min) * b0.w;
        gate_sum += (gate_d * pyre_q4_k_swiglu_q_from_pack<4>(gate_qpack, high) - gate_min) * b1.x;
        gate_sum += (gate_d * pyre_q4_k_swiglu_q_from_pack<5>(gate_qpack, high) - gate_min) * b1.y;
        gate_sum += (gate_d * pyre_q4_k_swiglu_q_from_pack<6>(gate_qpack, high) - gate_min) * b1.z;
        gate_sum += (gate_d * pyre_q4_k_swiglu_q_from_pack<7>(gate_qpack, high) - gate_min) * b1.w;

        up_sum += (up_d * pyre_q4_k_swiglu_q_from_pack<0>(up_qpack, high) - up_min) * b0.x;
        up_sum += (up_d * pyre_q4_k_swiglu_q_from_pack<1>(up_qpack, high) - up_min) * b0.y;
        up_sum += (up_d * pyre_q4_k_swiglu_q_from_pack<2>(up_qpack, high) - up_min) * b0.z;
        up_sum += (up_d * pyre_q4_k_swiglu_q_from_pack<3>(up_qpack, high) - up_min) * b0.w;
        up_sum += (up_d * pyre_q4_k_swiglu_q_from_pack<4>(up_qpack, high) - up_min) * b1.x;
        up_sum += (up_d * pyre_q4_k_swiglu_q_from_pack<5>(up_qpack, high) - up_min) * b1.y;
        up_sum += (up_d * pyre_q4_k_swiglu_q_from_pack<6>(up_qpack, high) - up_min) * b1.z;
        up_sum += (up_d * pyre_q4_k_swiglu_q_from_pack<7>(up_qpack, high) - up_min) * b1.w;
    }
