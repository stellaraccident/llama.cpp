...
enum class ggml_backend_pyre_topk_moe_variant {
    auto_select,
    baseline,
    shared4,
    wave32,
...
struct ggml_backend_pyre_provider_policy {
    ...
    ggml_backend_pyre_topk_moe_variant topk_moe_variant =
        ggml_backend_pyre_topk_moe_variant::auto_select;
...
struct ggml_backend_pyre_device_context {
    ...
    ggml_backend_pyre_op_provider rms_norm_mul_wg128_provider;
    ...
    ggml_backend_pyre_op_provider mul_add_add_broadcast_provider;
    ...
    ggml_backend_pyre_op_provider topk_moe_f32_shared4_provider;
    ggml_backend_pyre_op_provider topk_moe_f32_wave32_provider;
    ...
    ggml_backend_pyre_op_provider mul_mat_vec_bf16_cols32_provider;
    ggml_backend_pyre_op_provider mul_mat_vec_bf16_rows2_cols16_provider;
    ggml_backend_pyre_op_provider mul_mat_vec_bf16_wmma16_provider;
    ...
    ggml_backend_pyre_op_provider mul_mat_vec_bf16_swiglu_rows2_cols8_provider;
    ggml_backend_pyre_op_provider mul_mat_vec_bf16_swiglu_wmma16_provider;
    ...
    ggml_backend_pyre_op_provider mul_mat_vec_f16_batched_cols16_provider;
    ...
    ggml_backend_pyre_op_provider mul_mat_id_q4_k_grouped_q8_1_x4_mmq64x64_wg64_provider;
    ...
    ggml_backend_pyre_op_provider mul_mat_id_q4_k_mul_rows2_x16_wg32_provider;
    ggml_backend_pyre_op_provider mul_mat_id_q4_k_mul_rows2_x16_wg16_provider;
    ...
    ggml_backend_pyre_op_provider mul_mat_id_q4_k_swiglu_grouped_q8_1_x4_mmq32x64_wg64_provider;
    ggml_backend_pyre_op_provider mul_mat_id_q4_k_swiglu_packed_wg64_provider;
    ggml_backend_pyre_op_provider mul_mat_id_q4_k_swiglu_rows2_x16_wg32_provider;
    ...
    ggml_backend_pyre_op_provider quantize_q8_1_x4_provider;
    ...
    ggml_backend_pyre_op_provider mul_mat_vec_q5_k_q8_1_mmq32x32_wg128_provider;
    ggml_backend_pyre_op_provider mul_mat_vec_q5_k_q8_1_x4_mmq32x32_wg128_provider;
    ggml_backend_pyre_op_provider mul_mat_vec_q5_k_q8_1_x4_mmql128x128_wg256_provider;
    ggml_backend_pyre_op_provider mul_mat_vec_q5_k_q8_1_x4_mmq64x64_wg256_provider;
    ...
    ggml_backend_pyre_op_provider mul_mat_vec_q6_k_rows2_cols1_wg32_provider;
    ggml_backend_pyre_op_provider mul_mat_vec_q6_k_rows2_cols8_wg128_provider;
    ggml_backend_pyre_op_provider mul_mat_vec_q6_k_q8_1_provider;
    ggml_backend_pyre_op_provider mul_mat_vec_q6_k_q8_1_x4_mmql128x64_wg256_provider;
    ...
    ggml_backend_pyre_op_provider mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_wg256_provider;
...
static ggml_backend_pyre_topk_moe_variant ggml_backend_pyre_topk_moe_variant_from_env() {
    const char * value = std::getenv("GGML_PYRE_TOPK_MOE_VARIANT");
    if (!value || value[0] == '\0' || std::strcmp(value, "auto") == 0) {
        return ggml_backend_pyre_topk_moe_variant::auto_select;
    }
    if (std::strcmp(value, "baseline") == 0 || std::strcmp(value, "shared1") == 0) {
        return ggml_backend_pyre_topk_moe_variant::baseline;
    }
    if (std::strcmp(value, "shared4") == 0 || std::strcmp(value, "shared") == 0) {
        return ggml_backend_pyre_topk_moe_variant::shared4;
    }
    if (std::strcmp(value, "wave32") == 0) {
        return ggml_backend_pyre_topk_moe_variant::wave32;
    }
    GGML_LOG_WARN("%s: unknown GGML_PYRE_TOPK_MOE_VARIANT=%s, using auto\n", __func__, value);
    return ggml_backend_pyre_topk_moe_variant::auto_select;
}

static const char * ggml_backend_pyre_topk_moe_variant_name(
        ggml_backend_pyre_topk_moe_variant variant) {
    switch (variant) {
        case ggml_backend_pyre_topk_moe_variant::auto_select: return "auto";
        case ggml_backend_pyre_topk_moe_variant::baseline: return "baseline";
        case ggml_backend_pyre_topk_moe_variant::shared4: return "shared4";
        case ggml_backend_pyre_topk_moe_variant::wave32: return "wave32";
    }
    return "unknown";
}
...
static ggml_backend_pyre_provider_policy ggml_backend_pyre_provider_policy_from_env() {
    return {
        ...
        /* .topk_moe_variant = */ ggml_backend_pyre_topk_moe_variant_from_env(),
        ...
        /* .enable_q4_k_swiglu_rows2_x16_decode = */ ggml_backend_pyre_env_enabled(
            "GGML_PYRE_ENABLE_Q4_K_SWIGLU_ROWS2_X16_DECODE"),
        /* .enable_q4_k_swiglu_row2_decode = */ ggml_backend_pyre_env_enabled(
            "GGML_PYRE_ENABLE_Q4_K_SWIGLU_ROW2_DECODE"),
        /* .enable_q4_k_swiglu_row4_decode = */ ggml_backend_pyre_env_enabled(
            "GGML_PYRE_ENABLE_Q4_K_SWIGLU_ROW4_DECODE"),
        /* .enable_packed_q4_k_mul = */ !ggml_backend_pyre_env_enabled("GGML_PYRE_DISABLE_PACKED_Q4_K_MUL"),
        /* .enable_packed_q4_k_mul_rows2_x16 = */ !ggml_backend_pyre_env_enabled(
            "GGML_PYRE_DISABLE_PACKED_Q4_K_MUL_ROWS2_X16"),
        /* .enable_packed_q4_k_mul_rows2_x16_wg16 = */ ggml_backend_pyre_env_enabled(
            "GGML_PYRE_ENABLE_PACKED_Q4_K_MUL_ROWS2_X16_WG16"),
        ...
        /* .enable_f16_batched_cols16_prompt = */ !ggml_backend_pyre_env_enabled("GGML_PYRE_DISABLE_F16_BATCHED_COLS16_PROMPT"),
        /* .enable_f32_batched_cols8_prompt = */ !ggml_backend_pyre_env_enabled("GGML_PYRE_DISABLE_F32_BATCHED_COLS8_PROMPT"),
        /* .enable_f32_batched_cols16_prompt = */ !ggml_backend_pyre_env_enabled("GGML_PYRE_DISABLE_F32_BATCHED_COLS16_PROMPT"),
        /* .enable_f32_batched_rows2_cols8_prompt = */ !ggml_backend_pyre_env_enabled(
            "GGML_PYRE_DISABLE_F32_BATCHED_ROWS2_COLS8_PROMPT"),
        /* .enable_bf16_cols4_prompt = */ !ggml_backend_pyre_env_enabled("GGML_PYRE_DISABLE_BF16_COLS4_PROMPT"),
        /* .enable_bf16_cols8_prompt = */ !ggml_backend_pyre_env_enabled("GGML_PYRE_DISABLE_BF16_COLS8_PROMPT"),
        /* .enable_bf16_cols16_prompt = */ !ggml_backend_pyre_env_enabled("GGML_PYRE_DISABLE_BF16_COLS16_PROMPT"),
        /* .enable_bf16_cols32_prompt = */ !ggml_backend_pyre_env_enabled("GGML_PYRE_DISABLE_BF16_COLS32_PROMPT"),
        /* .enable_bf16_rows2_cols1_decode = */ !ggml_backend_pyre_env_enabled(
            "GGML_PYRE_DISABLE_BF16_ROWS2_COLS1_DECODE"),
        /* .enable_bf16_rows2_cols1_wg32_decode = */ ggml_backend_pyre_env_enabled(
        ...
        /* .enable_bf16_wmma16_prompt = */ !ggml_backend_pyre_env_enabled("GGML_PYRE_DISABLE_FAST_APPROX_PROMPT") &&
            !ggml_backend_pyre_env_enabled("GGML_PYRE_DISABLE_BF16_WMMA16_PROMPT"),
        ...
        /* .enable_q8_0_add_q8_1_x4_mmq128x32_prompt = */ !ggml_backend_pyre_env_enabled(
            "GGML_PYRE_DISABLE_FAST_APPROX_PROMPT") &&
            !ggml_backend_pyre_env_enabled("GGML_PYRE_DISABLE_Q8_0_ADD_Q8_1_X4_MMQ128X32_PROMPT"),
...
static bool ggml_backend_pyre_load_rms_norm_mul_provider(
    ...
    ok = ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_rms_norm_mul_wg128_f32"),
...
static bool ggml_backend_pyre_load_mul_add_add_broadcast_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_add_add_f32_broadcast"),
...
static bool ggml_backend_pyre_load_flash_attn_ext_f32_f16_prefill_wmma_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
...
static bool ggml_backend_pyre_load_flash_attn_ext_f32_f16_prefill_tile_provider(
    ...
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_flash_attn_ext_f32_f16_prefill_tile8"),
...
static bool ggml_backend_pyre_load_topk_moe_f32_shared4_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_topk_moe_f32_shared4"),
        &device_context->topk_moe_f32_shared4_provider);
}

static bool ggml_backend_pyre_load_topk_moe_f32_wave32_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_topk_moe_f32_wave32"),
...
static bool ggml_backend_pyre_load_mul_mat_vec_f16_batched_provider(
    ...
    ok = ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_f16_batched_cols16_f32"),
...
static bool ggml_backend_pyre_load_mul_mat_vec_bf16_provider(
    ...
    ok = ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_bf16_rows2_cols1_f32"),
        &device_context->mul_mat_vec_bf16_rows2_cols1_provider) || ok;
    ok = ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_bf16_rows2_cols1_wg32_f32"),
        &device_context->mul_mat_vec_bf16_rows2_cols1_wg32_provider) || ok;
    ok = ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_bf16_rows4_k512_cols1_lds_wg256_f32"),
    ...
    ok = ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_bf16_cols8_f32"),
        &device_context->mul_mat_vec_bf16_cols8_provider) || ok;
    ok = ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_bf16_cols16_f32"),
        &device_context->mul_mat_vec_bf16_cols16_provider) || ok;
    ok = ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_bf16_cols32_f32"),
        &device_context->mul_mat_vec_bf16_cols32_provider) || ok;
    ok = ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_bf16_rows2_cols16_f32"),
        &device_context->mul_mat_vec_bf16_rows2_cols16_provider) || ok;
    ok = ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_bf16_wmma16x16_f32"),
...
static bool ggml_backend_pyre_load_mul_mat_vec_bf16_swiglu_provider(
    ...
    ok = ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_bf16_swiglu_cols8_f32"),
        &device_context->mul_mat_vec_bf16_swiglu_cols8_provider) || ok;
    ok = ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_bf16_swiglu_cols16_f32"),
        &device_context->mul_mat_vec_bf16_swiglu_cols16_provider) || ok;
    ok = ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_bf16_swiglu_rows2_cols8_f32"),
        &device_context->mul_mat_vec_bf16_swiglu_rows2_cols8_provider) || ok;
    ok = ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_bf16_swiglu_wmma16x16_f32"),
...
static bool ggml_backend_pyre_load_mul_mat_vec_f32_batched_provider(
    ...
    ok = ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_f32_batched_cols16_f32"),
        &device_context->mul_mat_vec_f32_batched_cols16_provider) || ok;
    ok = ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_f32_batched_rows2_cols8_f32"),
...
static bool ggml_backend_pyre_load_mul_mat_id_q4_k_grouped_q8_1_x4_mmq64x64_wg64_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_id_q4_k_grouped_q8_1_x4_mmq64x64_wg64_f32"),
...
static bool ggml_backend_pyre_load_mul_mat_id_q4_k_mul_rows2_x16_wg32_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_id_q4_k_mul_rows2_x16_wg32_f32"),
        &device_context->mul_mat_id_q4_k_mul_rows2_x16_wg32_provider);
}

static bool ggml_backend_pyre_load_mul_mat_id_q4_k_mul_rows2_x16_wg16_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_id_q4_k_mul_rows2_x16_wg16_f32"),
...
static bool ggml_backend_pyre_load_mul_mat_id_q4_k_swiglu_grouped_q8_1_x4_mmq32x64_wg64_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_id_q4_k_swiglu_grouped_q8_1_x4_mmq32x64_wg64_f32"),
...
static bool ggml_backend_pyre_load_mul_mat_id_q4_k_swiglu_rows2_x16_wg32_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_id_q4_k_swiglu_rows2_x16_wg32_f32"),
...
static bool ggml_backend_pyre_load_quantize_q8_1_x4_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_quantize_q8_1_x4_f32"),
...
static bool ggml_backend_pyre_load_mul_mat_vec_q5_k_q8_1_mmq32x32_wg128_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_q5_k_q8_1_mmq32x32_wg128_f32"),
        &device_context->mul_mat_vec_q5_k_q8_1_mmq32x32_wg128_provider);
}

static bool ggml_backend_pyre_load_mul_mat_vec_q5_k_q8_1_x4_mmq32x32_wg128_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_q5_k_q8_1_x4_mmq32x32_wg128_f32"),
        &device_context->mul_mat_vec_q5_k_q8_1_x4_mmq32x32_wg128_provider);
}

static bool ggml_backend_pyre_load_mul_mat_vec_q5_k_q8_1_x4_mmql128x128_wg256_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_q5_k_q8_1_x4_mmql128x128_wg256_f32"),
        &device_context->mul_mat_vec_q5_k_q8_1_x4_mmql128x128_wg256_provider);
}

static bool ggml_backend_pyre_load_mul_mat_vec_q5_k_q8_1_x4_mmq64x64_wg256_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_q5_k_q8_1_x4_mmq64x64_wg256_f32"),
...
static bool ggml_backend_pyre_load_mul_mat_vec_q6_k_rows2_cols8_wg128_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_q6_k_rows2_cols8_wg128_f32"),
        &device_context->mul_mat_vec_q6_k_rows2_cols8_wg128_provider);
}

static bool ggml_backend_pyre_load_mul_mat_vec_q6_k_rows2_cols1_wg32_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_q6_k_rows2_cols1_wg32_f32"),
...
static bool ggml_backend_pyre_load_mul_mat_vec_q6_k_q8_1_x4_mmql128x64_wg256_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_q6_k_q8_1_x4_mmql128x64_wg256_f32"),
        &device_context->mul_mat_vec_q6_k_q8_1_x4_mmql128x64_wg256_provider);
}

static bool ggml_backend_pyre_load_mul_mat_vec_q6_k_q8_1_x4_mmq32x32_wg128_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_q6_k_q8_1_x4_mmq32x32_wg128_f32"),
...
static bool ggml_backend_pyre_load_mul_mat_vec_q8_0_cols8_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
...
static bool ggml_backend_pyre_load_mul_mat_vec_q8_0_add_cols8_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_q8_0_add_cols8_f32"),
        &device_context->mul_mat_vec_q8_0_add_cols8_provider);
}

static bool ggml_backend_pyre_load_mul_mat_vec_q8_0_add_rows4_cols4_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_q8_0_add_rows4_cols4_f32"),
        &device_context->mul_mat_vec_q8_0_add_rows4_cols4_provider);
}

static bool ggml_backend_pyre_load_mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_wg256_provider(
        ggml_backend_pyre_device_context * device_context) {
    return ggml_backend_pyre_load_catalog_provider(
        device_context,
        ggml_backend_pyre_find_catalog_entry("pyre_mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_wg256_f32"),
...
static bool ggml_backend_pyre_supports_broadcast_operand_f32(
...
static bool ggml_backend_pyre_supports_mul_add_add_broadcast(
        const ggml_backend_pyre_device_context * device_context,
        const ggml_tensor * mul,
    ...
    if (device_context->mul_add_add_broadcast_provider.kind !=
                ggml_backend_pyre_provider_kind::direct_executable ||
        !ggml_backend_pyre_supports_mul_broadcast(device_context, mul) ||
        !first_add ||
    ...
    if (!ggml_backend_pyre_supports_broadcast_operand_f32(other0, mul) ||
        !ggml_backend_pyre_supports_broadcast_operand_f32(other1, mul)) {
        return false;
    }
...
static bool ggml_backend_pyre_supports_flash_attn_ext_f32_f16_prefill_tile(
        const ggml_backend_pyre_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * q = op->src[0];
    const ggml_tensor * k = op->src[1];
...
static bool ggml_backend_pyre_supports_flash_attn_ext_f32_f16_prefill_wmma(
        const ggml_backend_pyre_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * q = op->src[0];
    const ggml_tensor * k = op->src[1];
...
static int64_t ggml_backend_pyre_topk_moe_k_stride(
        const ggml_tensor * tensor,
        int64_t n_expert_used) {
    if (tensor->ne[0] == n_expert_used) {
...
struct ggml_backend_pyre_mul_add_add_broadcast_constants {
    int64_t ne0;
    int64_t nrows;
    int64_t ne1;
    int64_t ne2;
...
static const ggml_backend_pyre_op_provider & ggml_backend_pyre_select_topk_moe_f32_provider(
        const ggml_backend_pyre_device_context * device_context,
        int64_t n_rows,
        const char ** provider_label) {
    auto provider_available = [](const ggml_backend_pyre_op_provider & provider) {
        return provider.kind == ggml_backend_pyre_provider_kind::direct_executable;
    };
    auto select_if_available = [&](const ggml_backend_pyre_op_provider & provider, const char * label)
            -> const ggml_backend_pyre_op_provider * {
    ...
    *provider_label = "pure_hip_f32_shared1";
    ...
    switch (device_context->policy.topk_moe_variant) {
        case ggml_backend_pyre_topk_moe_variant::baseline:
            return baseline;
        case ggml_backend_pyre_topk_moe_variant::shared4:
            if (const auto * provider = select_if_available(
                    device_context->topk_moe_f32_shared4_provider, "pure_hip_f32_shared4")) {
                return *provider;
            }
            break;
        case ggml_backend_pyre_topk_moe_variant::wave32:
            if (const auto * provider = select_if_available(
                    device_context->topk_moe_f32_wave32_provider, "pure_hip_f32_wave32")) {
                return *provider;
            }
            break;
        case ggml_backend_pyre_topk_moe_variant::auto_select:
            if (n_rows == 1) {
                if (const auto * provider = select_if_available(
                        device_context->topk_moe_f32_wave32_provider, "pure_hip_f32_wave32")) {
                    return *provider;
...
static ggml_status ggml_backend_pyre_dispatch_mul_add_add_broadcast_f32(
        ggml_backend_pyre_context * context,
        const ggml_tensor * mul,
        const ggml_tensor * second_add,
        const ggml_tensor * add_src0,
    ...
    if (!ggml_backend_pyre_tensor_buffer_ref(src0, &bindings[0]) ||
        !ggml_backend_pyre_tensor_buffer_ref(src1, &bindings[1]) ||
        !ggml_backend_pyre_tensor_buffer_ref(add_src0, &bindings[2]) ||
        !ggml_backend_pyre_tensor_buffer_ref(add_src1, &bindings[3]) ||
        !ggml_backend_pyre_tensor_buffer_ref(second_add, &bindings[4])) {
        GGML_LOG_ERROR("%s: fused MUL_ADD_ADD tensor is not backed by a PYRE buffer\n", __func__);
        return GGML_STATUS_FAILED;
    }

    ggml_backend_pyre_mul_add_add_broadcast_constants constants = {
        /* .ne0      = */ second_add->ne[0],
...
static ggml_status ggml_backend_pyre_dispatch_topk_moe_f32(
    ...
    ggml_backend_pyre_topk_moe_f32_constants constants = {
        ...
        /* .weights_nb_k  = */ ggml_backend_pyre_topk_moe_k_stride(
            weights, ggml_nelements(weights) / ggml_nrows(logits)),
        /* .ids_nb1       = */ ggml_backend_pyre_topk_moe_row_stride(
            ids, ggml_nelements(ids) / ggml_nrows(logits)),
        /* .ids_nb_k      = */ ggml_backend_pyre_topk_moe_k_stride(
            ids, ggml_nelements(ids) / ggml_nrows(logits)),
        /* .scale         = */ scale,
        /* .clamp_min     = */ clamp_min,
        /* .clamp_max     = */ clamp_max,
    ...
    const auto & provider = ggml_backend_pyre_select_topk_moe_f32_provider(
...
static bool ggml_backend_pyre_supports_mul_mat_vec_q5_k_q8_1_mmq_prompt(
        const ggml_backend_pyre_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * src1 = op->src[1];
    return device_context->policy.enable_q5_k_q8_1_mmq_prompt &&
           ...
           src1->ne[1] == 512 &&
           (src1->ne[1] % 16) == 0 &&
           ggml_backend_pyre_q8_1_mmvq_auto_shape(op, GGML_TYPE_Q5_K) &&
           device_context->quantize_q8_1_provider.kind ==
               ggml_backend_pyre_provider_kind::direct_executable &&
           ggml_backend_pyre_supports_mul_mat_vec_k_quant(
               device_context, op, GGML_TYPE_Q5_K,
...
static bool ggml_backend_pyre_supports_mul_mat_vec_q5_k_q8_1_x4_mmq32_prompt(
        const ggml_backend_pyre_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * src1 = op->src[1];
...
static bool ggml_backend_pyre_supports_mul_mat_vec_q5_k_q8_1_x4_mmql128_prompt(
        const ggml_backend_pyre_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * src1 = op->src[1];
...
static bool ggml_backend_pyre_supports_mul_mat_vec_q5_k_q8_1_x4_mmq64_prompt(
        const ggml_backend_pyre_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * src1 = op->src[1];
...
static bool ggml_backend_pyre_supports_mul_mat_vec_q6_k_q8_1_x4_mmql128_prompt(
        const ggml_backend_pyre_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * src1 = op->src[1];
...
static bool ggml_backend_pyre_supports_mul_mat_vec_q6_k_q8_1_x4_mmq32_prompt(
        const ggml_backend_pyre_device_context * device_context,
        const ggml_tensor * op) {
    const ggml_tensor * src1 = op->src[1];
...
static bool ggml_backend_pyre_supports_mul_mat_vec_q8_0_cols8_prompt(
        const ggml_backend_pyre_device_context * device_context,
        const ggml_tensor * op) {
...
static bool ggml_backend_pyre_supports_mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_prompt(
    ...
    return device_context->policy.enable_q8_0_add_q8_1_x4_mmq128x32_prompt &&
           ...
           src1->ne[1] == 512 &&
           (src1->ne[1] % 32) == 0 &&
           ggml_backend_pyre_q8_1_mmvq_auto_shape(mm, GGML_TYPE_Q8_0) &&
           device_context->quantize_q8_1_x4_provider.kind ==
               ggml_backend_pyre_provider_kind::direct_executable &&
           ggml_backend_pyre_supports_mul_mat_vec_k_quant(
...
static bool ggml_backend_pyre_supports_mul_mat_vec_q8_0_add(
    ...
    const bool has_q8_1_x4_mmq128x32_provider =
        ggml_backend_pyre_supports_mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_prompt(device_context, mm);
...
static bool ggml_backend_pyre_supports_mul_mat_vec(
    ...
    return ggml_backend_pyre_supports_mul_mat_vec_f16(device_context, op) ||
           ...
           ggml_backend_pyre_supports_mul_mat_vec_q5_k_q8_1_x4_mmq64_prompt(device_context, op) ||
           ggml_backend_pyre_supports_mul_mat_vec_q5_k_q8_1_x4_mmql128_prompt(device_context, op) ||
           ggml_backend_pyre_supports_mul_mat_vec_q5_k_q8_1_x4_mmq32_prompt(device_context, op) ||
           ggml_backend_pyre_supports_mul_mat_vec_q5_k_q8_1_mmq_prompt(device_context, op) ||
           ...
           ggml_backend_pyre_supports_mul_mat_vec_q6_k_q8_1_x4_mmql128_prompt(device_context, op) ||
           ggml_backend_pyre_supports_mul_mat_vec_q6_k_q8_1_x4_mmq32_prompt(device_context, op) ||
...
static const char * ggml_backend_pyre_mul_mat_vec_trace_suffix(
    ...
    if (ggml_backend_pyre_supports_mul_mat_vec_q5_k_q8_1_x4_mmq64_prompt(device_context, op)) {
        return "_q8_1_x4_mmq64x64_wg256";
    }
    if (ggml_backend_pyre_supports_mul_mat_vec_q5_k_q8_1_x4_mmql128_prompt(device_context, op)) {
        return "_q8_1_x4_mmql128x128_wg256";
    }
    if (ggml_backend_pyre_supports_mul_mat_vec_q5_k_q8_1_x4_mmq32_prompt(device_context, op)) {
        return "_q8_1_x4_mmq32x32_wg128";
    }
    if (ggml_backend_pyre_supports_mul_mat_vec_q5_k_q8_1_mmq_prompt(device_context, op)) {
    ...
    if (op->src[0]->type == GGML_TYPE_Q8_0 &&
        ggml_backend_pyre_supports_mul_mat_vec_q8_0_cols8_prompt(device_context, op)) {
        return "_cols8";
    }
    if ((op->src[0]->type == GGML_TYPE_Q4_K ||
...
static ggml_status ggml_backend_pyre_dispatch_mul_mat_vec_k_q8_1(
    ...
    const bool use_q5_x4_mmq64 = src0->type == GGML_TYPE_Q5_K &&
        ggml_backend_pyre_supports_mul_mat_vec_q5_k_q8_1_x4_mmq64_prompt(context->device_context, dst);
    const bool use_q5_x4_mmql128 = src0->type == GGML_TYPE_Q5_K &&
        ggml_backend_pyre_supports_mul_mat_vec_q5_k_q8_1_x4_mmql128_prompt(context->device_context, dst);
    const bool use_q5_x4_mmq32 = src0->type == GGML_TYPE_Q5_K &&
        ggml_backend_pyre_supports_mul_mat_vec_q5_k_q8_1_x4_mmq32_prompt(context->device_context, dst);
    ...
    switch (src0->type) {
        ...
        case GGML_TYPE_Q5_K:
            ...
            } else if (ggml_backend_pyre_supports_mul_mat_vec_q5_k_q8_1_mmq_prompt(
...
static ggml_status ggml_backend_pyre_dispatch_mul_mat_vec_f16(
    ...
    switch (src0->type) {
        ...
        case GGML_TYPE_Q6_K:
            ...
            break;
        case GGML_TYPE_Q8_0:
            provider = ggml_backend_pyre_supports_mul_mat_vec_q8_0_cols8_prompt(
                context->device_context, dst) ?
...
static ggml_status ggml_backend_pyre_dispatch_mul_mat_vec_q8_0_add(
    ...
    const bool use_q8_1_x4_mmq128x32 =
        ggml_backend_pyre_supports_mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_prompt(
    ...
    if (use_q8_1_x4_mmq128x32) {
        ...
        pyre_buffer_ref_t quant_bindings[2] = { bindings[1], q8_1_ref };
        ggml_backend_pyre_quantize_q8_1_constants quant_constants = {
            /* .ne00 = */ src1->ne[0],
            /* .s01  = */ static_cast<int64_t>(src1->nb[1] / sizeof(float)),
            /* .s02  = */ static_cast<int64_t>(src1->nb[2] / sizeof(float)),
...
static ggml_status ggml_backend_pyre_dispatch_mul_mat_id_q4_k(
    ...
    if (provider == &context->device_context->mul_mat_id_q4_k_grouped_row4_wg64_provider ||
        ...
        pyre_buffer_ref_t src1_compute_ref = bindings[1];
        if (use_q8_1_x4_mmq) {
            const int64_t q8_1_blocks = constants.n_tokens * constants.n_ids * (constants.k / 32);
            const size_t q8_1_size = static_cast<size_t>(((q8_1_blocks + 3) / 4) * 144);
            if (!ggml_backend_pyre_ensure_q8_1_scratch(context, q8_1_size, &src1_compute_ref)) {
                return GGML_STATUS_FAILED;
            }
            ...
            const auto & quant_provider = context->device_context->quantize_q8_1_x4_provider;
            pyre_buffer_ref_t quant_bindings[2] = { bindings[1], src1_compute_ref };
            pyre_dispatch_config_t quant_config = {
                /* .workgroup_count = */ {
                    static_cast<uint32_t>((quant_constants.ne0 + 127) / 128),
                    static_cast<uint32_t>(quant_constants.ne1),
        ...
        pyre_buffer_ref_t grouped_bindings[5] = { bindings[0], src1_compute_ref, counts_ref, routes_ref, bindings[3] };
...
static ggml_status ggml_backend_pyre_dispatch_mul_mat_id_q4_k_swiglu(
    ...
    if (provider == &context->device_context->mul_mat_id_q4_k_swiglu_grouped_row4_wg64_provider ||
        ...
        pyre_buffer_ref_t src1_compute_ref = bindings[2];
        if (use_q8_1_x4_mmq) {
            const int64_t q8_1_blocks = constants.n_tokens * constants.n_ids * (constants.k / 32);
            const size_t q8_1_size = static_cast<size_t>(((q8_1_blocks + 3) / 4) * 144);
            if (!ggml_backend_pyre_ensure_q8_1_scratch(context, q8_1_size, &src1_compute_ref)) {
            ...
            const auto & quant_provider = context->device_context->quantize_q8_1_x4_provider;
            pyre_buffer_ref_t quant_bindings[2] = { bindings[2], src1_compute_ref };
            pyre_dispatch_config_t quant_config = {
                /* .workgroup_count = */ {
                    static_cast<uint32_t>((quant_constants.ne0 + 127) / 128),
                    static_cast<uint32_t>(quant_constants.ne1),
...
static ggml_status ggml_backend_pyre_graph_compute(ggml_backend_t backend, ggml_cgraph * cgraph) {
    ...
    for (int i = 0; i < cgraph->n_nodes; ++i) {
        ...
        if (!context->device_context->policy.disable_fusion &&
            ...
            const char * provider_label = nullptr;
            (void) ggml_backend_pyre_select_topk_moe_f32_provider(
            ...
            ggml_backend_pyre_trace_provider(
                ...
                provider_label,
                ggml_backend_pyre_topk_moe_variant_name(context->device_context->policy.topk_moe_variant),
                ...
                ggml_backend_pyre_trace_provider(
                    ...
                    (up->src[1]->ne[1] == 1 &&
                        ...
                        context->device_context->mul_mat_vec_bf16_swiglu_rows2_cols1_provider.kind ==
                            ggml_backend_pyre_provider_kind::direct_executable ? "_rows2_cols1" :
                    (up->src[1]->ne[1] == 1 &&
                        ...
                        (up->src[1]->ne[1] == 512 &&
                         ...
                         context->device_context->mul_mat_vec_bf16_swiglu_wmma16_provider.kind ==
                            ggml_backend_pyre_provider_kind::direct_executable ? "_wmma16x16" :
                        (up->src[1]->ne[1] == 512 &&
                         (up->src[0]->ne[1] % 2) == 0 &&
                         ...
                         context->device_context->mul_mat_vec_bf16_swiglu_rows2_cols8_provider.kind ==
                            ggml_backend_pyre_provider_kind::direct_executable ? "_rows2_cols8" :
                        (up->src[1]->ne[1] == 512 &&
                         ...
                         context->device_context->mul_mat_vec_bf16_swiglu_cols16_provider.kind ==
                            ggml_backend_pyre_provider_kind::direct_executable ? "_cols16" :
                        (up->src[1]->ne[1] == 512 &&
                         ...
                         context->device_context->mul_mat_vec_bf16_swiglu_cols8_provider.kind ==
                            ggml_backend_pyre_provider_kind::direct_executable ? "_cols8" :
                        (up->src[1]->ne[1] == 512 &&
        ...
        if (node->op == GGML_OP_MUL &&
            ...
            if (ggml_backend_pyre_supports_mul_add_add_broadcast(
                ...
                if (ggml_backend_pyre_dispatch_mul_add_add_broadcast_f32(
            ...
            case GGML_OP_FLASH_ATTN_EXT:
                ...
                if (ggml_backend_pyre_supports_flash_attn_ext_f32_f16_prefill_gfx11_direct(context->device_context, node)) {
                    ...
                    ggml_backend_pyre_trace_provider(
                        ...
                        node->src[0]->ne[0], node->src[1]->ne[1], node->src[0]->ne[1],
                        node->src[0]->ne[2], node->src[1]->ne[2]);
                } else if (ggml_backend_pyre_supports_flash_attn_ext_f32_f16_prefill_tile(context->device_context, node)) {
                    ggml_backend_pyre_trace_provider(
                        context->device_context,
...
static std::unique_ptr<ggml_backend_pyre_reg_context> ggml_backend_pyre_create_reg_context() {
    ...
    for (int i = 0; i < device_count; ++i) {
        ...
        if (device_context->policy.kernel_provider == ggml_backend_pyre_kernel_provider_mode::pure_hip) {
            ...
            (void) ggml_backend_pyre_load_mul_add_add_broadcast_provider(device_context.get());
            ...
            (void) ggml_backend_pyre_load_topk_moe_f32_shared4_provider(device_context.get());
            (void) ggml_backend_pyre_load_topk_moe_f32_wave32_provider(device_context.get());
        ...
        if (device_context->policy.kernel_provider == ggml_backend_pyre_kernel_provider_mode::pure_hip &&
            ...
            (void) ggml_backend_pyre_load_mul_mat_id_q4_k_grouped_q8_1_x4_mmq64x64_wg64_provider(
                device_context.get());
            ...
            (void) ggml_backend_pyre_load_mul_mat_id_q4_k_mul_rows2_x16_wg32_provider(device_context.get());
            (void) ggml_backend_pyre_load_mul_mat_id_q4_k_mul_rows2_x16_wg16_provider(device_context.get());
            ...
            (void) ggml_backend_pyre_load_mul_mat_id_q4_k_swiglu_grouped_row2_route8_wg64_provider(
                device_context.get());
            (void) ggml_backend_pyre_load_mul_mat_id_q4_k_swiglu_grouped_q8_1_x4_mmq32x64_wg64_provider(
                device_context.get());
            (void) ggml_backend_pyre_load_mul_mat_id_q4_k_swiglu_packed_wg64_provider(device_context.get());
            (void) ggml_backend_pyre_load_mul_mat_id_q4_k_swiglu_rows2_x16_wg32_provider(device_context.get());
            ...
            (void) ggml_backend_pyre_load_quantize_q8_1_x4_provider(device_context.get());
            ...
            (void) ggml_backend_pyre_load_mul_mat_vec_q5_k_q8_1_mmq32x32_wg128_provider(device_context.get());
            (void) ggml_backend_pyre_load_mul_mat_vec_q5_k_q8_1_x4_mmq32x32_wg128_provider(device_context.get());
            (void) ggml_backend_pyre_load_mul_mat_vec_q5_k_q8_1_x4_mmql128x128_wg256_provider(device_context.get());
            (void) ggml_backend_pyre_load_mul_mat_vec_q5_k_q8_1_x4_mmq64x64_wg256_provider(device_context.get());
            ...
            (void) ggml_backend_pyre_load_mul_mat_vec_q6_k_rows2_cols1_wg32_provider(device_context.get());
            (void) ggml_backend_pyre_load_mul_mat_vec_q6_k_rows2_cols8_wg128_provider(device_context.get());
            (void) ggml_backend_pyre_load_mul_mat_vec_q6_k_q8_1_provider(device_context.get());
            (void) ggml_backend_pyre_load_mul_mat_vec_q6_k_q8_1_x4_mmql128x64_wg256_provider(device_context.get());
            ...
            (void) ggml_backend_pyre_load_mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_wg256_provider(
                device_context.get());
        }
